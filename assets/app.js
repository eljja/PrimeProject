...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 112,
    claim_language_scanned_lines: 42658,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket168-fixedcore-leastrealizer-phase-paritymain.json", "data/open-problem/ticket167-cofinal-residue-besov-parity.json", "docs/fixedcore-leastrealizer-phase-paritymain.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET168 proves four exact intermediate or target-correction theorems, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires cofinal interval-LDL certificates on a fixed pole-neutral Guinand-Weil core, uniform least-realizer descent for every first-crossing Collatz word, target-dependent binary-Goldbach phase cancellation below the anchor margin, and a positive linear odd-von-Mangoldt finest-parity pairing." },
      ],
    },
    latest_changes: [
