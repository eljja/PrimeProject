  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket225-arithmetic-remainder-localization.json", "docs/arithmetic-remainder-localization.md", "docs/arithmetic-remainder-localization.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-225 proves four exact arithmetic-localization or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an explicit-formula transfer from cofinal prime-band margins to Weil positivity, uniform cyclic-intercept or aperiodic Collatz descent, and uniform rough-semiprime contamination bounds that leave positive Goldbach and Twin prime-prime terms." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-225: actual prime-band tails, Collatz cyclic residual invariance, and exact cube-root rough-semiprime contamination decompositions, while preserving TICKET-224 and the full ledger.", metric: "4 current cards / 225 tickets" },
