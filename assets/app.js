...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 246,
    claim_language_scanned_lines: 84395,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket236-contraction-order-phase-degree2.json", "docs/contraction-order-phase-degree2.md", "docs/contraction-order-phase-degree2.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-236 proves four exact partial, reduction, or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires arithmetic Weil normalized contraction, fresh order-separated Collatz primes beyond every finite palette, target-coupled dyadic Goldbach cross-phase gain, and prime-weighted degree-two CRT overlap-energy decay before the separate parity and principal-mass gaps." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-236: normalized contractions, Collatz order witnesses, Goldbach phase defects, and degree-two CRT reduction, while preserving TICKET-235 and the full ledger.", metric: "4 current cards / 236 tickets" },
