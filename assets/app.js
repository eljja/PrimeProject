...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 82,
      claim_language_scanned_lines: 26243,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 88, status: "open", artifacts: ["data/open-problem/ticket138-correlation-periodicity-and-scale-closure.json", "data/open-problem/ticket137-cancellation-entropy-and-information-budget.json", "docs/correlation-periodicity-and-scale-closure.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET138 proves four exact intermediate or no-go theorems, closes the subcritical periodic Collatz and near-full Goldbach-wheel escapes, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires a projected Weil cross-Gram budget below the positive tail gap, well-foundedness for affine-capped natural Collatz codes, a pointwise signed binary Goldbach K56 residual estimate, and regular aperiodic Type II Twin cancellation with positive mass." },
      ],
    },
    latest_changes: [
