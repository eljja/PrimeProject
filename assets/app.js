...
const bundledEvidencePack = {
  ...
  publication_gates: [
    ...
    { code: "reproducibility_gate", passed: true, severity: "medium" },
    {
      ...
      passed: true,
      severity: "high",
      evidence: { quality_gate_status: "pass", fail_count: 0, scanned_file_count: 91 },
    },
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 144, scanned_line_count: 53603, claim_language_triggered_count: 125, claim_language_guarded_count: 125, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 144,
    claim_language_scanned_lines: 53603,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket209-normalized-fourone-covering-factorial.json", "docs/normalized-fourone-covering-factorial.md", "docs/normalized-fourone-covering-factorial.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET209 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires gamma-normalized central top-edge nonvanishing on cofinal heights, uniform exclusion of Collatz necklaces with exactly five valuation-one entries, a Goldbach tail exceptional count below one beyond the covering-congruence floor, and an independent bilinear Omega-phase lower bound on infinitely many dyadic intervals." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-209: gamma-normalized Riemann boundary correction, complete four-one Collatz exclusion, a superlogarithmic Goldbach least-witness sequence, factorial Twin cancellation no-go, proof DAGs, and remaining infinite premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 209 tickets" },
