...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 92,
      claim_language_scanned_lines: 31732,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 98, status: "open", artifacts: ["data/open-problem/ticket148-multiscale-renewal-sharpness-matching.json", "data/open-problem/ticket147-fiber-compensation-phase-graph.json", "docs/multiscale-renewal-sharpness-matching.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET148 proves four exact intermediate theorems, rejects finite-prefix positivity promotion, fixed Collatz renewal horizons, generic sub-E/M phase quantization, and cubic-rough long-path geometry, records one historical correction and three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires a smooth Weil wavelet tail-positivity theorem, adaptive escape from minus-five 2-adic shadows, von Mangoldt-specific endpoint sector cancellation, and an actual cubic-rough Liouville matching-coupling Type II bound." },
      ],
    },
    latest_changes: [
