  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket207-dihedral-twoone-logwitness-abel.json", "docs/dihedral-twoone-logwitness-abel.md", "docs/dihedral-twoone-logwitness-abel.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET207 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires rigorous completed-xi interval bounds on cofinal reduced boundaries, uniform exclusion of Collatz necklaces with at least three valuation-one entries, a Goldbach tail exceptional count below one beyond the logarithmic witness floor, and a signed Twin majorant with an independent main term." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-207: completed-xi dihedral boundary reduction, complete two-one Collatz exclusion, logarithmic Goldbach witness lower bounds, the Abel-Omega finite reconstruction and positivity no-go, proof DAGs, and remaining infinite premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 207 tickets" },
