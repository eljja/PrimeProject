...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 83,
      claim_language_scanned_lines: 26674,
    claim_language_triggered_mentions: 120,
    claim_language_guarded_mentions: 120,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 89, status: "open", artifacts: ["data/open-problem/ticket139-uniformity-diophantine-complexity.json", "data/open-problem/ticket138-correlation-periodicity-and-scale-closure.json", "docs/uniformity-diophantine-and-complexity.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET139 proves four exact intermediate or no-go theorems, excludes 19,999 of the first 20,000 Collatz period windows under the verified floor, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires a signed projected-Weil spectral-radius bound, all-period supercritical Collatz exclusion plus aperiodic well-foundedness, a localized K56 Goldbach residual estimate on powers of two, and uniform-Sobolev aperiodic Type II Twin cancellation with positive mass." },
      ],
    },
    latest_changes: [
