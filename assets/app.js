...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_lines: 80072,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket229-band-frame-semilinear-character-barriers.json", "docs/band-frame-semilinear-character-barriers.md", "docs/band-frame-semilinear-character-barriers.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-229 proves four exact partial or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a subexponential Weil-core frame loss, order-sensitive Collatz nondivisibility plus aperiodic descent, fixed-target prime-weighted Goldbach cancellation, and cancellation of the modulo-5 Twin quadratic mode." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-229: a finite-band condition bound, a semilinear Collatz cover no-go, and exact Goldbach/Twin character barriers, while preserving TICKET-228 and the full ledger.", metric: "4 current cards / 229 tickets" },
