  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket248-unweighted-wieferich-jet-active.json", "docs/unweighted-wieferich-jet-active.md", "docs/unweighted-wieferich-jet-active.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-248 proves three partial theorems and one exact route no-go result, records four acyclic proof DAGs with zero machine failures, checks eight unweighted Legendre certificates, scans 78,495 primes through one million, audits 282 Goldbach denominator cases with 36 selected rows, and checks seven twin active-contamination scales while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires arithmetic off-diagonal Weil coercivity, existence or exclusion of a separated generalized-Wieferich prime, uniform reduced-numerator centered first-jet saving, and a scale-local Type-II lower bound beyond active prime-power contamination." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-248: unweighted moment escape, generalized-Wieferich separation, centered first jets, and active prime-power contamination, while preserving TICKET-247 and the full ledger.", metric: "4 current cards / 248 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-248 exact no-go: explicit normalized even Legendre modes have unweighted moment energy Q0(f_n)<11/n. / 명시적 정규화 even Legendre 모드의 비가중 모멘트 에너지는 Q0(f_n)<11/n입니다.",
        artifact: "next: ArithmeticOffDiagonalWeilCoercivityOnAdmissibleClosure",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-248 partial: actual first-level failure is exactly a separated generalized-Wieferich prime for 32/27 against 2/3. / 실제 첫 단계 실패는 32/27 대 2/3의 separated generalized-Wieferich 소수와 정확히 동치입니다.",
        artifact: "next: ExistenceOfSeparatedGeneralizedWieferichPrimeFor32Over27Against2Over3",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-248 partial: the centered residual and first-moment jet have exact aggregate energy q(D0+t²D1). / 중심 잔차와 1차 모멘트 jet의 합산 에너지는 정확히 q(D0+t²D1)입니다.",
        artifact: "next: UniformReducedNumeratorCenteredFirstJetSavingOnQuarterTorus",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-248 partial: exact contamination is A2−π2=L+R−B and only active shift-two neighbors contribute. / 정확한 오염은 A2−π2=L+R−B이며 활성 shift-two 이웃만 기여합니다.",
        artifact: "next: ScaleLocalTypeIILowerBoundBeyondActivePrimePowerContamination",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
