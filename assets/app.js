...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 238,
    claim_language_scanned_lines: 81867,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket232-effective-dimension-binary-defect-rational-shell-crt-sparsity.json", "docs/effective-dimension-binary-defect-rational-shell-crt-sparsity.md", "docs/effective-dimension-binary-defect-rational-shell-crt-sparsity.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-232 proves four exact structural or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a logarithmically dense adaptive Weil frame with tail dominance, binary four-one Collatz nondivisibility, actual-prime growing-denominator autocorrelation saving, and an entropy-matched signed CRT large sieve plus a positive Twin principal lower bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-232: adaptive effective-dimension necessity, binary Collatz defect exclusion, actual-prime rational-shell identities, and CRT chi-square sparsity, while preserving TICKET-231 and the full ledger.", metric: "4 current cards / 232 tickets" },
