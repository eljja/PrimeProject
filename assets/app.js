...
const bundledEvidencePack = {
  ...
  publication_gates: [
    ...
    { code: "reproducibility_gate", passed: true, severity: "medium" },
    {
      ...
      passed: true,
      severity: "high",
      evidence: { quality_gate_status: "pass", fail_count: 0, scanned_file_count: 88 },
    },
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 89, scanned_line_count: 29845, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 89,
      claim_language_scanned_lines: 29845,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 95, status: "open", artifacts: ["data/open-problem/ticket145-normalization-affine-endpoint-separable-no-go.json", "data/open-problem/ticket144-schur-rank-equivalence-variation-adverse-walsh.json", "docs/normalization-affine-endpoint-separable-no-go.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET145 proves four exact structural no-go theorems, rejects four overstrong or circular TICKET144 targets, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an actual normalized Weil Schur-sign recurrence, a nonlinear lift-closed Collatz rank beyond finite residue-affine forms, independently summable arithmetic Goldbach scale envelopes below K56, and an independent joint cubic-rough Walsh Type II bound." },
      ],
    },
    latest_changes: [
