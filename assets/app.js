...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 136,
    claim_language_scanned_lines: 50562,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket181-regularized-localization-quantized-slack.json", "data/open-problem/ticket180-finite-information-localization.json", "docs/regularized-localization-quantized-slack.md", "docs/regularized-localization-quantized-slack.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET181 proves four exact conditional bridges or no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an arithmetic RH symbol modulus, positive Collatz slack quanta outside equality, an every-target Goldbach residual modulus, and summable dyadic path oscillation for actual prime-pair blocks." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-181, exact conditional bridges, discarded routes, proof DAGs, and remaining arithmetic premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 181 tickets" },
