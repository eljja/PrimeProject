  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket258-variation-character-convergent.json", "docs/variation-character-convergent.md", "docs/variation-character-convergent.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-258 proves two exact no-gos and two partial theorems, records four acyclic proof DAGs with zero machine failures, checks 12 RH BV rows, 166 Collatz phase rows, 6 Goldbach modulus rows, and 128 Twin convergents through a 62-digit denominator boundary while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires actual-Weil packet margin versus scaled variation, sublinear canonical Fermat-quotient phase sums, nonzero odd character moments for every compatible Goldbach prefix, and exclusion of unit coefficients on every Twin root convergent." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-258: bounded variation, rational independence, character completeness, and the exponent-17 root-convergent reduction, while preserving TICKET-257 and the full ledger.", metric: "4 current cards / 258 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-258 exact no-go: finite total variation still need not bound packet lag partial sums below. / 유한 총변동도 packet lag 부분합 하한을 강제하지 못합니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-258 exact no-go: nontrivial distinct odd-prime phases are rationally independent. / 비자명한 서로 다른 홀수 소수 위상은 유리 선형독립입니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-258 partial theorem: one primitive odd character is complete exactly when q-1 is a power of two. / primitive odd character 하나는 q-1이 2의 거듭제곱일 때 정확히 완전합니다.",
        artifact: "next: EveryCompatibleEvenQDivisiblePrimePrefixHasNonzeroOddCharacterMoment",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-258 partial theorem: every exponent-17 unit solution is a continued-fraction convergent. / 모든 지수 17 단위계수 해는 연분수 수렴분수입니다.",
