  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket212-even-defect-ghost-bonferroni-gapchannel.json", "docs/even-defect-ghost-bonferroni-gapchannel.md", "docs/even-defect-ghost-bonferroni-gapchannel.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET212 proves four exact intermediate or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a uniform all-height critical-line defect below two, ordinary Collatz odd-divisor nondivisibility, a full-witness Goldbach product resummation below one, and positivity of the gap-two dyadic channel on infinitely many blocks." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-212: the sharp sub-two Riemann defect certificate, universal 2-adic Collatz ghosts, the exact full-witness Goldbach product and fixed-Bonferroni no-go, and exact isolation of the Twin gap-two dyadic channel, while preserving TICKET-211 and the full ledger.", metric: "4 current cards / 212 tickets" },
