  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket169-kkt-childlift-autocorrelation-primepower.json", "data/open-problem/ticket168-fixedcore-leastrealizer-phase-paritymain.json", "docs/kkt-childlift-autocorrelation-primepower.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET169 proves four exact bridge or no-go theorems, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires cofinal interval-KKT inertia on a fixed pole-neutral Guinand-Weil core, a positive least-realizer slack invariant under unbounded-precision Collatz child lifts, a uniform binary-Goldbach spectral-autocorrelation budget below the anchor margin, and a prime-producing Type-II decay theorem with explicit constants." },
      ],
    },
    latest_changes: [
