  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket222-lossless-coupling-biased-parity.json", "docs/lossless-coupling-biased-parity.md", "docs/lossless-coupling-biased-parity.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-222 proves four exact partial or route-correction theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an actual-zeta cofinal dyadic enclosure with a vanishing unbounded tail, exclusion of every nontrivial primitive Collatz code plus aperiodic descent, a cofinal positive Goldbach-count lower bound, and a scale-growing Type II Twin estimate that dominates the biased remainder." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-222: compact Riemann profile injectivity, lossless Collatz word coding, Goldbach count-parity limits, and biased finite-wheel Twin parity, while preserving TICKET-221 and the full ledger.", metric: "4 current cards / 222 tickets" },
