...
const bundledEvidencePack = {
  ...
  publication_gates: [
    ...
    { code: "reproducibility_gate", passed: true, severity: "medium" },
    {
      ...
      passed: true,
      severity: "high",
      evidence: { quality_gate_status: "pass", fail_count: 0, scanned_file_count: 202 },
    },
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 282, scanned_line_count: 97733, claim_language_triggered_count: 133, claim_language_guarded_count: 133, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 302,
    claim_language_scanned_lines: 102971,
    claim_language_triggered_mentions: 134,
    claim_language_guarded_mentions: 134,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      release_trail: [
        ...
        { marker: "21", title: "Pre-replay separator", state: "open", measure: "mod 16 first joint separator / top 6 bits also closes", proof: "TICKET-61 replaces replay-derived failure_offset with low40 + high_extension mod 16 on the selected mixed-cylinder population" },
        { marker: "22", title: "Mod16 lift survival", state: "open", measure: "52/56-bit lifts / 0 mod16 collisions / 0 full periods", proof: "TICKET-62 tests higher lifts and finds low40 + base mod16 still deterministic on surviving start-template lifts" },
        { marker: "23", title: "Mod16 automaton table", state: "open", measure: "60-bit chain / 209 survivors / 0 collisions", proof: "TICKET-63 extracts a deterministic automaton table and reduces the 60-bit quotient to low40 mod 2^20 + base_mod16" },
        { marker: "24", title: "Symbolic gate obstruction", state: "open", measure: "64-bit gate / 42 starts / 0->0 refuted", proof: "TICKET-64 rejects direct symbolic promotion and replaces it with a gate-plus-offset transition target" },
        { marker: "25", title: "Start-template chain extinction", state: "open", measure: "56->80 bits / 824->0 survivors", proof: "TICKET-65 closes the tracked start-template chain by 80 bits while showing compact gate separators collapse to row-unique states" },
        { marker: "26", title: "Complement frontier isolated", state: "open", measure: "17,134 open instances / 491 families", proof: "TICKET-66 refutes the already-covered complement shortcut and turns the next target into a rank theorem or compatible infinite lift" },
        { marker: "27", title: "Rank cycle frontier", state: "open", measure: "429-node SCC / 96,433 nondecreasing edges", proof: "TICKET-67 refutes one-step split and simple rank closure while isolating the cyclic quotient that must be refined next" },
        { marker: "28", title: "Refined DAG frontier", state: "open", measure: "9,616 states / 0 refined cycles", proof: "TICKET-68 breaks the observed 429-node quotient cycle under prefix/consumed refinement; tail/residue-only refinement still leaves 26 cyclic nodes and transition-completeness remains open" },
        { marker: "29", title: "Rank frontier audit", state: "open", measure: "89,222 descents / 6,649 frontier states", proof: "TICKET-69 validates observed prefix/consumed rank descent and isolates the unexpanded rank-0 frontier that blocks a proof" },
        { marker: "30", title: "Frontier closure refuted", state: "open", measure: "792,064 branches / 155,321 nondecreasing re-entries", proof: "TICKET-70 expands the rank-0 frontier and refutes the shortcut that those states are automatically terminal sinks" },
        { marker: "31", title: "Bounded separator tradeoff", state: "open", measure: "0 mixed full-word keys / 22,219 compact mixed keys", proof: "TICKET-71 finds a bounded full-word separator but shows the compact coordinate still needs an infinite lift-closure theorem" },
        { marker: "32", title: "Persistent lift-chain pressure", state: "open", measure: "4,142 second-lift / 6,448 third-probe re-entries", proof: "TICKET-72 separates rank descent from open pressure and shows compact mixed-key pressure re-enters under lift" },
        { marker: "33", title: "Strict re-entry tree exhausted", state: "bounded", measure: "4,142 roots / 12,911 -> 2,873 -> 0", proof: "TICKET-73 exactly exhausts the selected strict re-entry predicate at the fifth lift; the all-trajectory coverage theorem remains open" },
        { marker: "34", title: "Coverage leakage exposed", state: "open", measure: "8 / 20,752 keys / 15,696 escapes / 78,315 sixth pressure", proof: "TICKET-74 refutes promotion of strict-tree extinction to coverage: fifth-lift pressure leaves the old cover and persists through a sixth lift" },
        { marker: "35", title: "Finite-coordinate closure blocked", state: "open", measure: "8 coordinates / 0 pass / 11-to-77,998 novel rows", proof: "TICKET-75 quantifies the Collatz compression-versus-state-growth obstruction: coarse coordinates retain cycles and mixed outcomes, while rich coordinates leak into unseen classes" },
        { marker: "36", title: "Boundary recurrence isolated", state: "bounded", measure: "297,104 transitions / 0 formula failures / 5 fixed precisions refuted", proof: "TICKET-76 derives the exact four-bit boundary quotient recurrence and shows that unresolved normalization exposes four new bits at each lift" },
        { marker: "37", title: "Fixed-prefix ghost classified", state: "bounded", measure: "18,569 equality boundaries / max 15 strict steps / 0 failures", proof: "Corrected TICKET-77 classifies the inverse-16 orbit modulo 3^(m+1), rolls equality valuations back, and identifies each all-depth fixed-prefix completion as a non-natural 2-adic preimage of -1/3" },
        { marker: "38", title: "Finite 2-adic separator blocked", state: "bounded", measure: "65,535 words / 262,140 positive replays / 0 failures", proof: "TICKET-78 proves every finite accelerated valuation cylinder contains infinitely many positive integers, so a fixed finite 2-adic state cannot certify natural admissibility" },
        { marker: "39", title: "Bounded coupled one-step rank blocked", state: "bounded", measure: "131,584 expansion replays / 128 contractions / 0 failures", proof: "TICKET-79 uses exact natural expansion and nonterminal contraction families to refute alpha*log(n) plus any bounded finite-state correction as a universal one-step Collatz rank" },
        { marker: "40", title: "Finite least-counterexample compactness blocked", state: "bounded", measure: "2,560 witnesses / 656,640 steps / 0 failures", proof: "TICKET-80 proves every finite non-descent prefix system has arbitrarily large natural witnesses while its nested all-ones cylinders converge 2-adically to the nonpositive fixed point -1" },
        { marker: "41", title: "Single Mersenne compensation blocked", state: "bounded", measure: "1,023 starts / 523,776 steps / 3 descent exceptions", proof: "TICKET-81 exactly classifies the first compensation after a stabilized Mersenne expansion block: only k=2,4,8 descend, while infinite odd and even families do not" },
        { marker: "42", title: "Every fixed Mersenne window blocked", state: "bounded", measure: "129 horizons / 8,385 states / 8,256 transitions", proof: "TICKET-82 constructs explicit exponent progressions with arbitrarily long post-expansion non-descent prefixes, proving unbounded Mersenne stopping delay without claiming divergence" },
        { marker: "43", title: "Sub-half-log Mersenne windows blocked", state: "bounded", measure: "255 horizons / 33,150 symbolic states / 0 failures", proof: "TICKET-83 proves D(k_H)>H>(1/2)log2(k_H)-2 on an explicit infinite exponent sequence, ruling out every o(log k) and coefficient-below-1/2 descent window" },
        { marker: "44", title: "Two-thirds log window blocked", state: "bounded", measure: "384 Hensel precisions / 386 bits / 33,150 states", proof: "TICKET-84 lifts finite prefixes of the accessible -7/-5 two-adic valuation cycle to positive exponents and proves D(k_H)>H>(2/3)log2(k_H)-1 without treating the ghost as natural" },
        { marker: "45", title: "Accessible cycle coefficient supremum solved", state: "bounded", measure: "32,895 lifts / 259 bits / supremum 1 unattained", proof: "TICKET-85 proves the accessible periodic-word reciprocal-mean supremum is one, constructs D(k_H)>log2(k_H)-2, and excludes attainment via the all-ones mod-8 obstruction" },
        { marker: "46", title: "Coefficient-one zero-additive boundary crossed", state: "bounded", measure: "1,023 prefixes / 499 top-bit heights / 1,027 bits / 0 failures", proof: "TICKET-86 reduces the target to 3^(r_H+1)=-7 modulo 2^(H+3), proves infinitely many top-bit heights by non-stabilization, and obtains D(r_H)>log2(r_H) on an infinite Mersenne subsequence" },
        { marker: "47", title: "Additive-one Mersenne boundary crossed", state: "bounded", measure: "262,143 bits / 65,368 positive runs / max run 16 / 0 failures", proof: "TICKET-87 proves both lift digits recur infinitely, converts infinitely many one-to-zero transitions into D(k)>log2(k)+1, and keeps the observed length-16 run as finite evidence only" },
        { marker: "48", title: "Run-length-two shortcut rejected", state: "bounded", measure: "4,096-bit countermodel / 32,753 finite runs / complement mean 2", proof: "TICKET-88 gives an aperiodic no-00 countermodel and proves the natural complement exponent enters valuation cycle (1,3), isolating FixedLogGoldenMeanExclusion as the missing arithmetic bridge" },
        { marker: "49", title: "Golden-mean target reduced to valuation excess", state: "bounded", measure: "32,727 jump pairs / 8,159 excess-five events / 0 failures", proof: "TICKET-89 proves 100 recurrence is exactly recurrence of v2(3^(k+1)+7)-floor(log2(k))>=5 and rules out transcendence or positive-entropy counting as standalone bridges" },
        { marker: "50", title: "Fixed-precision error automata blocked", state: "bounded", measure: "254 transitions / 63 precision lassos / 0 failures", proof: "TICKET-90 derives the normalized-error recurrence and proves the limiting odd beta fixed point survives in every fixed modular precision" },
        { marker: "51", title: "Single ghost replaced by full invariant set", state: "bounded", measure: "255 horizons / 4,096 conjugacy states / 377 no-00 words / 0 failures", proof: "TICKET-91 proves growing-precision error-tail conjugacy, identifies beta with the all-one tail, and replaces single-point separation by escape from the full golden-mean invariant set" },
        { marker: "52", title: "Target scales corrected before promotion", state: "bounded", measure: "131,306 Collatz jumps / 17 Twin gap promotions removed / 0 failures", proof: "TICKET-92 preserves Collatz's constant additive digit defect and corrects TP-TICKET-14: Maynard's criterion uses ceil(theta M_k/2), so legacy 2/k surrogate scores certify neither M_k nor gap 2" },
        { marker: "53", title: "Twin target moved to exact correlation excess", state: "bounded", measure: "2M exact correlation / 14,871 twins / 4 surrogate countermodels / 0 failures", proof: "TICKET-93 proves that unbounded Lambda shift-two correlation excess over explicit prime-power contamination implies twin infinitude, and refutes positive truncated-divisor correlation as an uncertified lower bound" },
        { marker: "54", title: "Signed remainder budget exposed", state: "bounded", measure: "4 Twin norm bounds blocked / 4 Goldbach checkpoints / 0 failures", proof: "TICKET-94 proves the exact Twin residual identity, shows norm-only lower bounds stay negative, and gives a per-even Goldbach correlation-excess bridge after prime-power contamination" },
        { marker: "55", title: "Equivalent target downgraded, contamination sharpened", state: "bounded", measure: "1M Goldbach screen / 10 small criterion exceptions / 4 Twin equivalence checks / 0 failures", proof: "TICKET-95 replaces exponent-count contamination by weighted proper-prime-power mass, proves the TICKET-94 Twin residual target is an equivalent reformulation rather than a reduction, and keeps the million-scale FFT result explicitly numerical" },
        { marker: "56", title: "Fourier phase information isolated", state: "bounded", measure: "2 scales / 36 masks each / 0 sparse energy certificates / 0 replay failures", proof: "TICKET-96 reconstructs Goldbach and shift-two correlations as exact finite DFT coefficients, then blocks phase-blind minor-energy routes with explicit information countermodels" },
        { marker: "57", title: "Fixed-modulus arithmetic information exhausted", state: "bounded", measure: "2 scales / 5 optimal moduli / 0 correlation certificates / 0 contract failures", proof: "TICKET-97 uses the L2-optimal residue-periodic projection through modulus 2,310 and proves by an explicit zero-residue-mean countermodel that fixed-modulus one-point information does not determine binary correlation signs" },
        { marker: "58", title: "Growing-modulus data leakage isolated", state: "bounded", measure: "3 scales / 8 primorial moduli / 0 pre-leak certificates / 0 contract failures", proof: "TICKET-98 proves that W at least the dataset length makes the fitted periodic projection identical to the observations, and finds every first Goldbach/Twin norm certificate exactly at this row-unique replay boundary" },
        { marker: "59", title: "Target-independent local model established", state: "bounded", measure: "120 cross-fit configurations / 0 norm certificates / 1M residual holdout / 0 contract failures", proof: "TICKET-99 separates training from evaluation, proves a CRT lower bound for the external coprime local main, and promotes only the still-open signed residual decay theorem while keeping K=1.6 as finite evidence" },
        { marker: "60", title: "Joint Vaughan cancellation isolated", state: "bounded", measure: "6M Goldbach / 10M Twin / Type II counterexample K=7.91 / 0 contract failures", proof: "TICKET-100 extends the K=1.6 falsification screen, replays Vaughan's identity exactly, and refutes separate Goldbach Type II envelope bounds at N=930,930 while retaining the joint signed cancellation target" },
        { marker: "61", title: "Cutoff frontier splits the two prime routes", state: "bounded", measure: "39 cutoff pairs / 0 balanced Goldbach survivors / 4 balanced Twin survivors / 0 energy failures", proof: "TICKET-101 rejects near-square-root decomposition collapse, retains a joint balanced Goldbach target, and identifies the noncollapsed Twin U=100,V=84 separated-budget candidate while classifying energy rewrites as equivalent" },
        { marker: "62", title: "Twin threshold corrected on a fresh dyadic holdout", state: "bounded", measure: "1M registered-budget failures at 2M / 4M fresh points at 8M / 0 rescue failures", proof: "TICKET-102 refutes the selected K_S=1.40 envelope, proves that any fixed finite K/log constant would be sufficient, and preserves K_S=4,K_II=1 only as fresh finite evidence" },
        { marker: "63", title: "Twin cumulative masking removed", state: "bounded", measure: "7 local blocks through 8M / Type II sign counterexample at X=1000 / 0 contract failures", proof: "TICKET-103 recomputes exact correlations on (X/2,X], refutes universal local Type II nonnegativity, and retains only an eventual fixed-finite-budget theorem" },
        { marker: "64", title: "Twin Type II reduced to weighted Möbius cancellation", state: "bounded", measure: "4 exact anatomy rows / Abel K up to 1088 / 0 identity failures", proof: "TICKET-104 derives T_X=sum mu(d)A_X(d) with nonnegative shifted-prime weights and rejects negative-mass and Abel-triangle templates that discard the decisive weight-sign correlation" },
        { marker: "65", title: "Twin progression main centered out", state: "bounded", measure: "4 centered rows / negative-mass K down to 5.41 at 2M / 0 identity failures", proof: "TICKET-105 subtracts the independent coprime progression mean, sharply reduces termwise envelopes, and isolates the Möbius-weighted prime-progression discrepancy requiring dispersion" },
        { marker: "66", title: "Sparse-modulus Twin leakage isolated", state: "bounded", measure: "72.31% one-sample support at 2M / 96% centered mass / 0 identity failures", proof: "TICKET-106 groups actual moduli before norms and shows the positive centered signal is dominated by row-unique sparse progression cells, forcing dense dispersion and sparse-tail control to separate" },
        { marker: "67", title: "Twin sparse tail recombined at integer level", state: "bounded", measure: "8M / 1.59M q to 1.10M n / 69.53% L1 retained / 0 contract failures", proof: "TICKET-107 combines occupancy-one moduli at their actual n values, verifies the vector against an independent Vaughan decomposition, and shows that structured, sparse, and dense signed compensation must survive the final estimate" },
        ...
        { marker: "86", title: "Route correction closes one premise and sharpens three proof frontiers", state: "bounded", measure: "3 exact intermediate theorems / Collatz 28-bit unresolved mass 3.0004% / Goldbach B=2.094918 / Twin 32M residual 0.145873 / 0 conjecture resolutions", proof: "TICKET-126 discards the RH full-space density shortcut, characterizes natural Collatz paths subject to the TICKET-127 n=1 correction, proves the Goldbach proper-prime-power bound, and records one preregistered Twin finite holdout without promoting it to a tail theorem" },
        { marker: "87", title: "Base exception repaired and finite evidence linked to effective proof contracts", state: "bounded", measure: "4 exact intermediate theorems / 1 public correction / Collatz 4,027,109 nontrivial unresolved / Goldbach A=1 / Twin raw transport identity / 0 conjecture resolutions", proof: "TICKET-127 repairs the Collatz n=1 exception, proves a conditional RH counterexample semidecision, closes the binary Goldbach singular-series coefficient, and rewrites Twin contraction as an exact raw Vaughan budget transport contract" },
        { marker: "88", title: "Finite cores and prefixes now expose sharper infinite obligations", state: "bounded", measure: "RH 78,734 finite prime-power terms / Collatz 4,027,109 direct closures and 0 survivors / Goldbach A>1.31917 and K=55 sufficient / Twin 0.92c+delta<1 / 0 conjecture resolutions", proof: "TICKET-128 removes the compact-support prime tail, separates Collatz lift cylinders from integer candidates, strengthens the Goldbach endpoint budget by an exact rational tail, and refutes endpoint-only Twin interpolation before proving its all-scale repair contract" },
        { marker: "89", title: "Enumerable cores and exact necessary conditions replace range extension", state: "bounded", measure: "RH countable autocorrelation core / Collatz valuation cap through 2^29 steps / Goldbach K=56 sufficient with 0.0107568 margin / Twin increment target limsup D(2^j)<0.08 / 0 conjecture resolutions", proof: "TICKET-129 proves relative density only inside the Weil autocorrelation image, derives a least-counterexample Collatz valuation cap from the exact 2^28 lower bound, certifies the Goldbach endpoint entirely with rational inequalities, and isolates the signed Vaughan increment defect while refuting monotone endpoint interpolation" },
        { marker: "90", title: "Computability and route-optimality audit correct the next proof targets", state: "bounded", measure: "RH strict-negative semidecision / Collatz all-depth survivor plus rho=0.946620 density bound / Goldbach fixed-route K=56 optimum / Twin relative threshold 2/23 / 0 conjecture resolutions", proof: "TICKET-130 makes every rational-bump Weil-core value computable, retires finite Collatz cap-language extinction with an exact survivor, proves fixed-endpoint Goldbach route optimality, and factors the Twin block defect into a dimensionless relative increment target" },
        { marker: "91", title: "Proof-viability audit corrects two overextended targets", state: "bounded", measure: "RH finite-positivity no-go / Collatz exact residue-stabilization criterion and strict-cap scope correction / Goldbach K57 through p=103 / Twin ratio reparameterization / 0 conjecture resolutions", proof: "TICKET-131 proves finite Gram positivity cannot imply universal Weil positivity alone, replaces the insufficient infinite Collatz strict-cap target with an exact natural-residue stabilization contract, stratifies Goldbach residual budgets by odd prime divisors, and returns Twin Prime to signed Vaughan transport plus parity" },
        { marker: "92", title: "Admissibility and pointwise-boundary audit repairs four proof routes", state: "bounded", measure: "RH 2-moment projected core / Collatz dense-null natural codes / Goldbach power-of-two hard stratum / Twin finite-level CRT lifts / 0 conjecture resolutions", proof: "TICKET-132 repairs exact admissibility and separates pointwise obligations from topology, density, finite stratification, and local sieve data" },
        { marker: "93", title: "Exact quantifier-promotion reductions replace average and finite-state shortcuts", state: "bounded", measure: "RH countable Gram family / Collatz finite cylinder exceptions / Goldbach finite-Lp spike / Twin all-class CRT lifts / 0 conjecture resolutions", proof: "TICKET-133 states exact reduction contracts and replayable inference countermodels without promoting them to conjecture proofs" },
        { marker: "94", title: "Uniformity thresholds expose the scale every remaining proof must cross", state: "bounded", measure: "RH rational interval signs / Collatz no bounded-depth cover / Goldbach logarithmic moment threshold / Twin growing primorial lifts / 0 conjecture resolutions", proof: "TICKET-134 identifies strict or scale-uniform information that the four proof routes still require" },
        { marker: "95", title: "Conditional bridges are separated from exceptional sets and missing arithmetic inputs", state: "bounded", measure: "RH sharp Schur threshold / Collatz depth-64 exact survival DP / Goldbach O(log log X) hard-stratum bridge / Twin 111 transcript lifts / 0 conjecture resolutions", proof: "TICKET-135 proves four exact bridge or no-go theorems while leaving every problem-specific infinite premise open" },
        { marker: "96", title: "Dimension, affine correction, density, and hidden periodicity sharpen four proof frontiers", state: "bounded", measure: "RH 7 entrywise counterfamily scales / Collatz exact affine identity through 5,000 starts / Goldbach 20 fixed-wheel scales / Twin rational-Fourier composite lifts / 0 conjecture resolutions", proof: "TICKET-136 replaces entrywise Weil decay by Schur row/column targets, derives the exact least-counterexample Collatz affine cap, blocks powers-of-two moment scaling on linear rough strata, and proves finite rational Fourier algebras remain congruence transcripts" },
        { marker: "97", title: "Cancellation, entropy, and information budgets expose four sharper boundaries", state: "bounded", measure: "RH 6 Hadamard scales / Collatz 16 mass rows and 4 cylinders / Goldbach 5 subpower wheels / Twin 108 Fourier collisions / 0 conjecture resolutions", proof: "TICKET-137 proves absolute Schur sums can lose unbounded cancellation, quantifies exponentially small affine-capped Collatz mass without confusing nullity with emptiness, extends the Goldbach logarithmic moment barrier to every subpower squarefree wheel, and gives rational Fourier separators an explicit denominator-information lower bound" },
        { marker: "98", title: "Correlation, periodicity, and scale closure sharpen four proof frontiers", state: "bounded", measure: "RH 12 cross-Gram rows / Collatz 9,840 periodic words / Goldbach 20 all-scale wheel rows / Twin 12 Pell rows / 0 conjecture resolutions", proof: "TICKET-138 replaces signed means by a cross-Gram correlation certificate, excludes every subcritical periodic Collatz valuation code from positive natural embedding, extends the Goldbach moment barrier to all complete-block odd squarefree wheel scales, and proves bare irrational-feature injectivity is a tautological Twin classifier no-go" },
        { marker: "99", title: "Uniformity, Diophantine windows, and complexity budgets sharpen four proof frontiers", state: "bounded", measure: "RH 4 tight-frame rows / Collatz 20,000 periods and 19,999 exclusions / Goldbach 10 annihilator orders / Twin 9 rotation rows / 0 conjecture resolutions", proof: "TICKET-139 proves an unbounded absolute cross-Gram overestimate on tight frames, derives and audits the positive Collatz cycle Diophantine window, constructs exact power-of-two moment annihilators, and proves that scale-dependent Lipschitz budgets retain arbitrary finite irrational-orbit lookup" },
        { marker: "100", title: "Spectral moments, fixed-floor limits, duality, and rotation sharpen four proof frontiers", state: "bounded", measure: "RH 6 trace-moment rows / Collatz 6 fixed-floor rows and K=563,714,459 / Goldbach 10 dual orders / Twin 5 Sobolev rows / 0 conjecture resolutions", proof: "TICKET-140 proves an even-trace spectral certificate with a logarithmic-order barrier, proves every fixed Collatz cycle-minimum window eventually becomes non-excluding, characterizes finite-measurement pointwise control by exact row-space duality, and proves sample-length-uniform Sobolev cancellation for unweighted sqrt(2) rotations" },
        { marker: "101", title: "One-sided spectra, moving floors, robust duals, and large sieve sharpen four proof frontiers", state: "bounded", measure: "RH 6 shifted rows / Collatz 6 moving-floor rows and slope 1/(3 log 2) / Goldbach 8 conditioning orders and exponent 1540 / Twin 5 bilinear rows / 0 conjecture resolutions", proof: "TICKET-141 proves a shifted one-sided spectral certificate and sign-blindness no-go, a linear-growth barrier for period-dependent Collatz floors, a quadratic-exponential raw-moment dual conditioning no-go, and fixed-phase arbitrary-coefficient bilinear large-sieve cancellation" },
        { marker: "102", title: "Effective rank, cycle direction, Haar duals, and Liouville parity correct four proof targets", state: "bounded", measure: "RH 8 effective-rank rows / Collatz 8 period rows and 4,340,106 minimum candidates / Goldbach 5 Haar-dual rows and budget 23 / Twin 4 Liouville ledger rows / 0 conjecture resolutions", proof: "TICKET-142 proves a sharp effective-rank shifted-moment identity, corrects the Collatz product-window direction and strengthens its upper bound, turns the Goldbach K56 target into a typed Haar coefficient ledger, and derives an exact cubic-rough Liouville twin projector" },
        { marker: "103", title: "Form-core topology, published period floors, martingale normalization, and Walsh inversion remove four hidden proof equivalences", state: "bounded", measure: "RH 8 form-core rows and 1 negative witness / Collatz 7,069-digit raw word space and imported K>7.2e10 floor / Goldbach 5 martingale rows / Twin 4 Walsh rows / 0 conjecture resolutions", proof: "TICKET-143 proves the exact form-core promotion theorem and a Hilbert-density no-go, retires Collatz period 15,601 under a cited published floor, normalizes the Goldbach Haar route into root means and dyadic path variation, and proves the old Twin one-sided gap is exactly four times the twin count" },
        { marker: "104", title: "Schur certificates, rank equivalence, variation no-go, and adverse Walsh control sharpen four targets", state: "bounded", measure: "RH 15 exact Schur rows / Collatz 50,000 bounded starts and max rank 129 / Goldbach 9 variation rows with K56 crossing at depth 113 / Twin 4 adverse rows and 1 L1 no-go witness / 0 conjecture resolutions", proof: "TICKET-144 reduces nested Gram positivity to exact Schur pivots, proves unrestricted Collatz rank is equivalent to termination, refutes generic bounded-signal absolute path variation, and replaces full Walsh L1 balance by the weaker adverse-part contraction target" },
        { marker: "105", title: "Normalization, affine-rank, endpoint, and separability audits reject four false proof targets", state: "bounded", measure: "RH 20 exact normalization rows / Collatz 48 same-residue expansion rows / Goldbach 9 exact zero-mean spike rows / Twin 4,913 majorant triples plus 1 nonnecessity witness / 0 conjecture resolutions", proof: "TICKET-145 proves absolute Schur pivots are basis-scale dependent and uniform normalized margins unnecessary, excludes every lower-bounded finite-modulus piecewise-affine Collatz one-step rank, exposes signed Goldbach endpoint cancellation as circular and aggregate cancellation as insufficient, and proves the adverse Walsh quantity is the minimal separable majorant but not a necessary twin condition" },
        { marker: "106", title: "Toeplitz reflection, polynomial-rank, Fourier-phase, and Frechet audits isolate four joint-information barriers", state: "bounded", measure: "RH 6 exact reflection orders plus 12 fixed-lag no-go rows / Collatz 30 polynomial-rank rows / Goldbach 6 exact phase counterexamples / Twin 2 same-marginal countertables plus 4 finite rough rows / 0 conjecture resolutions", proof: "TICKET-146 reduces an involution-compatible shift-generated Weil convolution core to exact Toeplitz-Levinson reflection coefficients, gives a fixed-lag no-go only over unrestricted Hermitian Toeplitz moments, excludes every lower-bounded finite-modulus piecewise-polynomial Collatz one-step rank, proves Fourier power data cannot determine a pointwise binary convolution, and derives sharp Frechet bounds showing marginal Liouville cancellation cannot replace joint parity control" },
        { marker: "107", title: "Fiber completeness, compensation cover, phase resolution, and path cuts expose the next four arithmetic obligations", state: "bounded", measure: "RH 8 exact fiber-rank witnesses / Collatz exact 2/3 Haar cover plus 100,000 bounded starts and 12 residual cylinders / Goldbach 12 phase rows and 10 scale rows / Twin 16 path counterpairs plus 4 finite rough rows / 0 conjecture resolutions", proof: "TICKET-147 proves finite fixed-lattice generator families are incomplete in L2(R), gives pointwise Collatz descent on an exact two-thirds run-compensation cover, derives a phase-quantization energy bound and fixed-resolution Parseval no-go for Goldbach K56, and turns the Twin joint Liouville term into a path-cut statistic with an infinite same-marginal counterfamily" },
        { marker: "108", title: "Multiscale completeness, renewal shadows, phase sharpness, and matching coupling correct four proof routes", state: "bounded", measure: "RH 8 exact Haar levels through dimension 256 / Collatz 16 exact expanding renewal cylinders / Goldbach 6 nonnegative sharpness rows / Twin 5 matching audits, 16 coupling counterpairs, and 4 exact cell inversions / 1 historical correction / 0 conjecture resolutions", proof: "TICKET-148 closes Haar L2 multiscale completeness while refuting finite-prefix positivity promotion, constructs an expanding positive Collatz cylinder for every fixed renewal horizon, proves the endpoint phase error is generically sharp at order E/M, and corrects the actual cubic-rough support to a matching whose endpoint coupling still requires arithmetic Type II control" },
        { marker: "109", title: "Smooth cores, exact shadow escape, wheel transfer, and semiprime cover replace four overstrong proof targets", state: "bounded", measure: "RH 16 exact compact-tail operators / Collatz 48 exact shadow orders plus 100,000 bounded odd starts / Goldbach 4 exact squarefree wheels / Twin 4 exact cover scales plus 3 factor-window audits / 0 conjecture resolutions", proof: "TICKET-149 proves smooth Meyer completeness still needs relative tail coercivity, exactly classifies finite escape from the Collatz minus-five shadow while refuting escape-to-descent, isolates the positive Goldbach wheel main term and its residual transfer barrier, and reduces the Twin route to positive rough-edge mass plus a uniform semiprime endpoint-cover deficit" },
        { marker: "110", title: "Relative form thresholds, arbitrary Collatz delay, sharp endpoint holes, and parity equivalence correct four proof bridges", state: "bounded", measure: "RH 96 relative-threshold rows plus 16 compact-floor witnesses / Collatz 3,000 local exits plus 42 CRT delays / Goldbach 4 exact wheels plus 13 primorial radii / Twin 4 source rows plus 4 separation tables / 0 conjecture resolutions", proof: "TICKET-150 proves the sharp abstract relative-form threshold while retiring compact ambient coercivity, isolates the Collatz r=2 exit as an arbitrary finite-delay obstruction, computes the sharp nonnegative Goldbach endpoint-hole radius and its vanishing relative primorial limit, and proves the Twin cover deficit is exactly the parity-sensitive twin-minus-double-semiprime bias" },
        { marker: "111", title: "Negative spectra, affine thresholds, reflection transversals, and log-two selection sharpen four proof targets", state: "bounded", measure: "RH 48 harmless-positive rows plus 16 negative-threshold failures / Collatz 32 positive-surplus non-descents plus 35 forced expanding words / Goldbach 16 moment counterpairs plus 4 finite radius scales / Twin 4 log-two population scales, 4 selection countermodels, and 4 shifted audits / 0 conjecture resolutions", proof: "TICKET-151 proves positivity depends exactly on the negative relative spectrum rather than the full norm, inserts the missing Collatz affine C/D threshold and a natural surplus-only counterexample, generalizes Goldbach endpoint-hole geometry to weighted reflection orbits while refuting global-moment transfer, and separates the cubic-rough one-variable log-two bias from the still-open gap-two shifted-selection theorem" },
        { marker: "128", title: "Fixed neutral cores, least-realizer descent, phase-blind minimax, and Twin parity main terms correct four proof targets", state: "bounded", measure: "RH 5 exact fixed-moment projections plus 6 cutoff-varying countermodels / Collatz 7,553,085 candidate words through length 20 with 0 bad realizers plus 5 modular-shadow lifts / Goldbach 5 failing phase-blind minimax rows plus 6 exact aligned-magnitude witnesses / Twin 6 exact all-odd identities plus 6 prime-indicator splits through 65,536 / 0 conjecture resolutions", proof: "TICKET-168 proves that a fixed bounded corrector preserves a nested dense neutral RH core while cutoff-varying constraints can miss a fixed negative direction, reduces all natural realizers of one Collatz word to the least representative while rejecting modular-shadow-only descent over unrestricted affine data without a realizability premise, proves spectral l1 is the optimal phase-blind Goldbach bound, and corrects the Twin target by proving the finest parity scale contains exactly half of the desired odd gap-two correlation rather than an error to cancel" },
        { marker: "129", title: "KKT inertia, exact child lifts, spectral autocorrelation, and prime-power removal sharpen four proof contracts", state: "bounded", measure: "RH 5 exact KKT inertia rows plus fixed-penalty no-go / Collatz 8 exact child lifts plus 15 fixed-residue-memory counterpairs / Goldbach 5 subunit phase-sensitive autocorrelation bounds plus 4 exact diagonal-energy counterpairs / Twin 6 prime-power decompositions through 65,536 with 860 twin pairs and 41 contaminated pairs / 0 conjecture resolutions", proof: "TICKET-169 converts constrained RH positivity to KKT inertia, proves the exact Collatz child-lift recurrence while rejecting every fixed residue width, derives a phase-sensitive Goldbach pointwise certificate, and shows by explicit o(x) prime-power removal that a positive linear Twin finest-pairing bound is already an endgame theorem rather than an easier parity workaround" },
        { marker: "130", title: "Gap-relative intervals, Collatz tail closure, autocorrelation shells, and multiscale Type II expose resolution completeness", state: "bounded", measure: "RH 6 exact interval-gap rows plus vanishing-entrywise-radius no-go / Collatz 8 prefix tail closures plus 7 all-one global immediate-descent-threshold rows / Goldbach 5 subunit shell bounds plus 6 fixed-window counterpairs / Twin 4 finite sign-bilinear rows plus 4 exact invisible refinements / 0 conjecture resolutions", proof: "TICKET-170 replaces entrywise RH intervals by gap-relative operator control, analytically closes the large-valuation Collatz child tail at every prefix while refuting one global immediate-descent threshold for this argument, converts Goldbach autocorrelation to dyadic shell budgets while rejecting every fixed lag window, and proves fixed coarse Type-II partitions can hide nonzero fine dependence" },
        { marker: "131", title: "Relative KKT geometry, a Collatz 2-adic ghost ray, signed phase, and Haar resolution correct four proof targets", state: "bounded", measure: "RH 6 exact anisotropic relative-KKT rows / Collatz 7 exact all-one ghost prefixes with 2-adic limit -1 / Goldbach 5 exact positive phase-ambiguity pairs / Twin 4 finite Haar transforms plus 5 fixed-depth countermodels / 0 conjecture resolutions", proof: "TICKET-171 replaces a globally pessimistic RH absolute-gap requirement by an exact sign-normalized relative certificate, refutes well-foundedness of the full Collatz residual tree with a non-natural 2-adic ghost ray, proves that Goldbach autocorrelation shell energies lose signed pointwise phase even for nonnegative squared signals, and makes Twin Type-II resolution completeness exact in Haar coordinates while refuting every fixed depth" },
        { marker: "132", title: "Structured KKT blocks, Collatz bridge equivalence, Fourier L1 sharpness, and dyadic mixed variation localize four proof gaps", state: "bounded", measure: "RH 6 structured interval certificates plus 6 whole-relative-norm no-go rows / Collatz 7 exact finite-prefix bifurcations plus 49,999 finite first-descent checks / Goldbach 5 exact L1 sharpness pairs plus 4 finite prime spectra / Twin 4 exact T161 mixed-variation identities plus 6 checkerboard marginal no-go rows / 0 conjecture resolutions", proof: "TICKET-172 reduces RH saddle-point inertia to primal positivity and constraint full rank, proves the previous Collatz natural-ray target equivalent to Collatz itself, proves the sharp Fourier L1 Goldbach positivity gate, and identifies Twin fine/fine Haar energy with dyadic mixed variation while refuting marginal-only control" },
        { marker: "133", title: "Vanishing finite-section defects, Collatz cylinder stabilization, target phase, and tensor-Haar pairs correct four limiting coordinates", state: "bounded", measure: "RH 7 vanishing-defect rows plus 7 rank rows / Collatz 5,460 word residues plus 8 stabilization examples and 7 exponential no-go rows / Goldbach 987 prime targets plus one exact Z/8 no-go / Twin 4 all-scale-pair decompositions plus 5 unequal-scale rank-one no-go rows / 0 conjecture resolutions", proof: "TICKET-173 replaces uniform RH coercivity by vanishing lower defect, characterizes Collatz natural support by cylinder stabilization, retains Goldbach target-aligned positive and negative mass, and corrects Twin same-scale variation to all tensor-Haar scale pairs" },
        ...
        { marker: "138", title: "Comparison majorants, the Collatz six-wheel, Sobolev positivity, and signed cross-Gram data retain the next decisive structures", state: "bounded", measure: "RH 4 comparison rows / Collatz 49,999 starts and coefficient ratio 2/3 / Goldbach 5 failed raw scales plus 4 counterexamples / Twin 3 norm-summary counterfamilies and 4 rows missing cross-Gram / 0 conjecture resolutions", proof: "TICKET-177 proves four exact refinement or no-go results while keeping every conjecture open" },
        { marker: "139", title: "Summability thresholds, adaptive low-bit occupancy, frequency splits, and signed zero modes expose the remaining uniformity gaps", state: "bounded", measure: "RH 4 decay profiles across 5 dimensions / Collatz 49,999 starts with 44,537 low-bit crossings plus 4 Mersenne no-go rows / Goldbach 5 split scales with 1 finite pass plus 4 positive global-budget counterexamples / Twin 4 phase-erasure sizes / 0 conjecture resolutions", proof: "TICKET-178 proves four exact threshold or no-go results while keeping every conjecture open" },
        { marker: "140", title: "Signed symbols, adaptive valuation layers, discrete targets, and centered energy remove four representation mismatches", state: "bounded", measure: "RH 6 bounded-symbol sections with nonsummable absolute rows / Collatz 4 fixed-depth cylinder counterfamilies / Goldbach 4 interpolation no-go grids plus exact counts through 1,024 / Twin 4 centering families across 3 geometries / 0 conjecture resolutions", proof: "TICKET-179 proves four exact representation or no-go results while keeping every conjecture open" },
        { marker: "141", title: "Hidden frequencies, ordered prefixes, exceptional spikes, and bad blocks expose four localization gaps", state: "bounded", measure: "RH 5 hidden-frequency witnesses / Collatz 7 natural permutation counterpairs / Goldbach 5 exceptional spikes plus exact counts through 10,000 / Twin 5 global-to-block counterfamilies / 0 conjecture resolutions", proof: "TICKET-180 proves four exact localization no-go theorems while keeping every conjecture open" },
        { marker: "142", title: "Regularity budgets, Collatz slack quanta, target moduli, and path variation turn four no-go results into conditional bridges", state: "bounded", measure: "RH 6 Fejer certificates plus a sampled-regularity counterfamily / Collatz 87,380 finite words plus the fixed-point equality boundary / Goldbach 5 discrete Fejer cases plus exact search through 100,000 / Twin 5 sharp dyadic path counterfamilies / 0 conjecture resolutions", proof: "TICKET-181 proves four exact localization bridges or no-go results while leaving each problem-specific arithmetic premise open" },
        { marker: "143", title: "Sobolev energy, affine divisibility, translation moduli, and sibling contrasts align four proof obligations with their representations", state: "bounded", measure: "RH 7 H1 Fejer cases plus raw prime proxies through 100,000 / Collatz 488,280 words and 8 trivial divisibility hits / Goldbach 5 translation certificates plus prime-indicator data through 20,000 / Twin 5 spike trees plus 2,298 actual twin pairs / 0 conjecture resolutions", proof: "TICKET-182 proves four exact refinements and four no-go boundaries while leaving each problem-specific infinite arithmetic premise open" },
        { marker: "144", title: "Abel transfer, primitive words, Fourier margins, and Haar paths isolate four missing uniformity bridges", state: "bounded", measure: "RH 4 high-frequency counterexamples plus Abel prime proxies through 100,000 / Collatz 488,280 classified words with 87,380 monotone-stratum exclusions / Goldbach 4 sparse Parseval no-go rows plus exact search through 50,000 / Twin 4 global-energy counterfamilies plus 2,298 actual twin pairs / 0 conjecture resolutions", proof: "TICKET-183 proves four exact transfer reductions and four sharp no-go results while leaving each problem-specific infinite arithmetic premise open" },
        { marker: "145", title: "Information sufficiency separates finite proxies from decisive arithmetic and corrects two overstrong proof targets", state: "bounded", measure: "RH 12 exact finite-moment counterexamples / Collatz first descent through 1,000,000 plus 5,036 prefix-barrier no-go words / Goldbach exact wheels through Q=1,155 plus 480 composite impostors / Twin 4 sharp Cantelli families plus 2,298 actual pairs / 0 conjecture resolutions", proof: "TICKET-184 proves four exact information boundaries, corrects the Collatz cycle-only and Twin every-leaf routes, and leaves all four infinite arithmetic lemmas open" },
        { marker: "146", title: "Spectral escape, an infinite Collatz cycle exclusion, exact factor horizons, and integer granularity sharpen four proof fronts", state: "bounded", measure: "RH 4 neutral-autocorrelation spectral-escape replays / Collatz one-one-rest-two cycle stratum excluded for every h>=3 with replay through h=128 / Goldbach 6 exact target factor horizons through N=50,000 / Twin 7 block widths with 4,975 positive-but-symmetric-certificate failures / 0 conjecture resolutions", proof: "TICKET-185 proves four exact boundaries, corrects the Collatz-equivalent universal-descent target and two decision/certificate overclaims, and leaves all four decisive infinite arithmetic lemmas open" },
        { marker: "147", title: "Cofinal equality, seven-one exclusion, exponential selection, and cardinal-sine projection isolate the current infinite arithmetic gaps", state: "bounded", measure: "RH cofinal exact-equality equivalence / Collatz 4,349,349 exact seven-one words / Goldbach 5 dyadic selector audits / Twin 11 polynomial and 4 prime-gap audits / 0 conjecture resolutions", proof: "TICKET-214 proves four exact partial or no-go results while leaving certified actual-zeta equality, all-k Collatz divisibility, a Goldbach subunit bound, and a Twin arithmetic lower bound open" },
        { marker: "148", title: "Defect lattices, single-mountain near-collisions, exact exception counts, and Abel boundaries sharpen the current obligations", state: "bounded", measure: "RH 4 exact interval fixtures plus a sharp defect-two model / Collatz unique-candidate theorem and exact audit through k=4,096 / Goldbach 5 finite blocks plus a sharp temperature boundary / Twin 5 prime audits and 4 finite-radius indistinguishability fixtures / 0 conjecture resolutions", proof: "TICKET-215 proves four exact partial, reduction, or no-go results while leaving an actual-zeta cofinal defect bound below two, an all-k Collatz near-collision exclusion, an all-block Goldbach arithmetic bound, and a parity-breaking Twin Abel lower bound open" },
        { marker: "149", title: "Laplace atoms, cross-power GCDs, radix histograms, and Tauberian tails expose four discrete thresholds", state: "bounded", measure: "RH 6 first-atom threshold fixtures and 4 delayed-atom no-go rows / Collatz exact cross-power gcd necessity with 0 equalities through k=4,096 / Goldbach 5 full dyadic histogram decodes / Twin 4 quantitative Abel-count transfers and 4 tail-scale rows / 0 conjecture resolutions", proof: "TICKET-216 proves four exact partial, reduction, or no-go results while leaving an actual-zeta cofinal transform bound, an all-k strict Collatz gcd gap, an independent Goldbach zero-digit interval, and a parity-breaking Twin Abel lower bound above the adaptive tail open" },
        { marker: "150", title: "Relative thresholds, convergent compression, moment support, and critical Abel tails replace absolute proxies with event-scale tests", state: "bounded", measure: "RH 6 normalized certificate rows and 3 delayed-atom no-go families / Collatz 7 exact upper-convergent audits with k<71,356,888 excluded / Goldbach 5 exact blocks and 5 failed sharp moment certificates / Twin 12 critical-tail rows / 0 conjecture resolutions", proof: "TICKET-217 proves four exact partial, reduction, or no-go results while leaving a cofinal actual-zeta relative enclosure, all-convergent and multi-run Collatz control, a pointwise Goldbach lower-tail theorem, and an actual Twin Abel surplus above the critical tail open" },
        { marker: "151", title: "Adaptive radii, exponential denominator spikes, residual moments, and strict Abel surplus isolate four promotion margins", state: "bounded", measure: "RH 8 adaptive signal rows plus 12 phase rows / Collatz 100 certified coefficients and 49 excluded upper convergents / Goldbach 5 exact p=8 block certificates / Twin 4 finite surplus diagnostics and one sharp transfer theorem / 0 conjecture resolutions", proof: "TICKET-218 proves four exact partial, reduction, or no-go results while leaving an actual-zeta adaptive envelope, future exponential Collatz partial-quotient spikes and multi-run control, a cofinal Goldbach eighth-residual estimate, and an actual Twin Abel liminf above one half open" },
        { marker: "152", title: "Band-pass localization, Matveev range glue, cross-fitting, and qualitative Abel growth correct theorem strength", state: "bounded", measure: "RH 7 synthetic band-pass replays / Collatz exact p=27,456,680,737 threshold plus 49-prefix closure and one infinite word family closed / Goldbach 10 exact held-out p=8 certificates / Twin 4 finite and sparse Abel diagnostics / 0 conjecture resolutions", proof: "TICKET-219 proves four exact partial or no-go results, closes every positive single-mountain Collatz cycle, and leaves the RH prime-side enclosure, all Collatz valuation words and divergence, the cofinal Goldbach cross-fitted eighth moment, and actual Twin Abel unboundedness open" },
        { marker: "153", title: "Dyadic completeness, primitive-root reduction, cross-fit refinement, and CRT no-go expose irreducible proof gaps", state: "bounded", measure: "RH 5 telescoping windows plus 2 hidden-atom witnesses / Collatz exact affine-power closure and binary words through length 16 / Goldbach 150 direct p=8 folds plus 140 refinement bridges / Twin 5 fixed-wheel CRT witnesses / 0 conjecture resolutions", proof: "TICKET-220 proves four exact partial or no-go results and leaves a summable actual-zeta envelope, primitive multi-run Collatz control plus divergence, representation-free cofinal Goldbach refinement margins, and parity-sensitive Twin lower bounds open" },
        { marker: "154", title: "Sharp obstruction certificates identify the coupled arithmetic information missing from four proof routes", state: "bounded", measure: "RH exact per-scale supremum 1/4 and divergent universal envelope / Collatz cyclically inequivalent fixed-point witnesses 133/943 and 995/943 at the same h,S / Goldbach exact Lp positivity radius plus finite-prefix extension no-go / Twin Walsh parity orthogonality for Boolean dimensions 2 through 12 / 4 exact obstruction or sharpness theorems / 0 conjecture resolutions", proof: "TICKET-221 rejects four insufficient target formulations and leaves an arithmetic-coupled RH tail budget, order-sensitive Collatz divisibility or descent, a uniform cofinal Goldbach Lp margin from prime distribution, and a parity-breaking Type II Twin lower bound open" },
        { marker: "155", title: "Lossless coupling and biased-parity corrections separate recoverable information from the infinite arithmetic gap", state: "bounded", measure: "RH compact full-profile injectivity / Collatz 488,280 finite words with zero code collisions or decode failures / Goldbach 49,998 even targets with zero parity-identity failures / Twin 16 exact CRT subset correlations / 4 exact partial or route-correction theorems / 0 conjecture resolutions", proof: "TICKET-222 proves four exact narrower theorems and leaves an actual-zeta unbounded-tail enclosure, exclusion of all nontrivial Collatz codes plus aperiodic descent, a cofinal positive Goldbach-count lower bound, and a scale-growing parity-breaking Type II Twin estimate open" },
        { marker: "156", title: "Exponential tails, fixed-sieve no-go constructions, and local Goldbach-Twin duality isolate the global arithmetic gaps", state: "bounded", measure: "RH 6 cofinal exponential-tail rows / Collatz 66 fixed moduli plus 3 finite-family witnesses / Goldbach all 1,155 wheel residues and exact floor 693/1024 / Twin 13 fixed-wheel composite-pair progressions / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-223 extends dyadic injectivity to exponentially tight unbounded defects, defeats every fixed Collatz modular sieve whose moduli are coprime to six, proves a uniform Goldbach local margin, and defeats fixed-wheel twin certificates while leaving actual-zeta equivalence, code-adaptive descent, and global prime-weighted remainders open" },
        { marker: "157", title: "Sharp completeness thresholds separate exact finite decisions from the remaining infinite arithmetic", state: "bounded", measure: "RH optimal quarter-tail envelope with 9 equality rows / Collatz 1,360 words, 5 radical false positives, and 0 prime-power criterion mismatches / Goldbach 4 square-root exact horizons plus 6 false diagonals / Twin 6 CRT countermodels / 4 exact threshold or no-go theorems / 0 conjecture resolutions", proof: "TICKET-224 proves the optimal RH band-tail constant, refutes radical-only Collatz divisibility, and identifies square-root completeness for bounded Goldbach and Twin filters while leaving actual-zeta margins, universal descent, and sub-square-root prime-correlation estimates open" },
        { marker: "158", title: "Arithmetic remainder localization moves finite thresholds onto actual prime bands, cyclic residuals, and rough-semiprime errors", state: "bounded", measure: "RH 13 negative actual-prime bands plus 6 finite-family kernels / Collatz 97,016 positive primitive words and 655,188 cyclic transitions / Goldbach 3 exact PP+PS+SP+SS decompositions / Twin 3 exact pair-type decompositions and 3 SS countermodels / 4 exact localization or no-go theorems / 0 conjecture resolutions", proof: "TICKET-225 proves an actual von Mangoldt tail bound and finite-band no-go, Collatz cyclic gcd-residual invariance, and exact cube-root rough-semiprime decompositions while leaving Weil transfer, universal descent, and uniform contamination control open" },
        { marker: "159", title: "Signal-transfer and same-order obstructions reject three tempting continuation routes", state: "bounded", measure: "RH 11 balanced Chebyshev-band identities and exact -1/4,+1/4 kernel masses / Collatz infinite primitive family with all cyclic intercepts above D / Goldbach contamination-to-PP ratios 1.063, 1.119, 1.377 / Twin ratios 0.922, 1.102, 1.363 / 4 exact transfer or no-go theorems / 0 conjecture resolutions", proof: "TICKET-226 proves that one prime-band sign is not direct positivity, refutes universal minimum-intercept Collatz descent with an infinite noncycle family, and proves cube-root rough semiprimes have the same marginal order as primes while leaving Weil-core transfer, exact D-divisibility exclusion, signed Goldbach minor control, and shifted Twin Type-II power saving open" },
        { marker: "160", title: "Mellin, block-suffix, and Buchstab lifts expose the exact unresolved arithmetic cells", state: "bounded", measure: "RH 5 Mellin alias rows with dual-ratio mode separation / Collatz 1,425 exact suffix certificates and one all-r primitive noncycle family / Goldbach and Twin 3 exact factor-cell horizons each / 0 conjecture resolutions", proof: "TICKET-227 proves that ratios 2 and 3 remove common nonconstant Mellin aliases, proves the infinite family (1,1,3)^r,(4,2,1) by a fractional-linear interval argument, and lifts Goldbach/Twin rough errors to exact factor cells while leaving quantitative Weil frames, universal Collatz divisibility exclusion, moving-residue estimates, and shifted bilinear power savings open" },
        { marker: "161", title: "Near aliases, branching affine languages, and residue spectra expose the stability and character-mode barriers", state: "bounded", measure: "RH 14 explicit near-alias convergents through tau 97.7M / Collatz 2,046 exact words through depth 10 plus an all-depth 2^r cone theorem / Goldbach 279 exact residue-operator cases / Twin 13 exact cross Gram checks and mod-3 joint-survival no-go / 0 conjecture resolutions", proof: "TICKET-228 refutes a finite-dilation full-line uniform frame bound, proves an exponentially branching Collatz primitive-noncycle language, diagonalizes the Goldbach moving-residue operator, and proves the Twin shift-two cross Gram and modulo-3 coupling no-go while leaving corrected bandlimited, cofinal-cover, and uniform character-cancellation lemmas open" },
        { marker: "162", title: "Finite-band bounds, semilinear cover no-go, and explicit character obstructions isolate the next weighted estimates", state: "bounded", measure: "RH 8 explicit finite-band bounds plus 7 phase checks / Collatz one infinite outside family against every finite equal-slope cover / Goldbach exact complete-period cancellation through l=43 and 16 window audits / Twin exact parity spectra through l=43 plus 5 tensor obstructions / 0 conjecture resolutions", proof: "TICKET-229 proves a positive finite-band dual-dilation bound with exponential condition loss, refutes finite equal-slope Collatz cofinal covers, separates averaged from pointwise Goldbach character cancellation, and isolates the full-size modulo-5 Twin quadratic mode while leaving four prime- or Weil-weighted infinite lemmas open" },
        { marker: "163", title: "Quantitative recurrence, necklace invariance, Fourier aggregation, and local centering correct four successor targets", state: "bounded", measure: "RH 12 simultaneous-Dirichlet certificates in dimensions 2 and 3 / Collatz 15,402 height-six words reduced to 2,567 necklaces / Goldbach 7 exact aligned-mode counterexamples / Twin 10 exact local means plus twin samples through 1M / 0 conjecture resolutions", proof: "TICKET-230 proves a T^(-2/m) finite-dilation recurrence no-go, proves Collatz D-divisibility and gcd are necklace invariants, refutes modewise-to-pointwise Fourier promotion, and corrects the raw modulo-5 Twin quadratic mean from zero to one third while leaving four infinite arithmetic lemmas open" },
        { marker: "164", title: "Summable-frame no-go, Collatz critical strip, a true Gauss counterfamily, and centered CRT orthogonality correct the frontier", state: "bounded", measure: "RH 6 weighted head-tail certificates / Collatz all alphabet-5 words through height 7 with S≥2h / Goldbach 12 exact zero-convolution Gauss rows / Twin 7 local norms plus 4 exact CRT Gram audits / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-231 rules out a positive floor for fixed absolutely summable infinite dilation families, confines nontrivial Collatz cycles to log2(3)<S/h<2, replaces the TICKET-230 Goldbach overclaim with a genuine zero-convolution counterfamily, and diagonalizes centered quadratic CRT interactions while leaving four infinite arithmetic lemmas open" },
        { marker: "165", title: "Adaptive dimension, binary defects, rational shells, and CRT sparsity narrow four continuation targets", state: "bounded", measure: "RH 5 adaptive collision certificates / Collatz binary one-, two-, and three-defect layers / Goldbach 40 exact actual-prime shell rows plus a growing-modulus counterfamily / Twin 3 exact sparsity bounds and 5 coefficientwise no-go rows / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-232 proves logarithmic effective dimension is necessary for an adaptive positive frame floor, excludes binary Collatz words with at most three valuation-one entries, exactly decomposes prime-weighted rational Goldbach shells, and refutes full unweighted growing-CRT Twin energy saving while leaving all four parent conjectures open" },
        { marker: "166", title: "Sharp logarithmic frames, a twelve-one Collatz closure, squarefree shells, and entropy no-gos correct the frontier", state: "bounded", measure: "RH 5 deterministic logarithmic-frame witnesses / Collatz 28,729,599,990 normalized k=12 words represented by exact 5+6 MITM with 0 hits / Goldbach 4 squarefree shell, 4 Parseval, and 4 sparse-prime rows / Twin 4 entropy and 4 parity-retention rows / 4 exact partial, asymptotic, or no-go theorems / 0 conjecture resolutions", proof: "TICKET-233 matches the scalar frame lower bound with an O(log T) construction, corrects the Collatz lineage and excludes the first open binary fixed stratum k=12, proves the polylogarithmic squarefree prime-shell asymptotic while refuting uncoupled denominator growth, and proves product-damped CRT bounds plus critical-entropy and parity-retention no-gos while leaving all four parent conjectures open" },
        { marker: "167", title: "Operator kernels, binary affine-sieve false positives, Goldbach half-channels, and Poisson CRT degrees expose four transfer barriers", state: "bounded", measure: "RH 4 exact finite-field kernel rows plus 4 arbitrary-tail rows / Collatz 66 fixed moduli, 3 simultaneous families, and 90,272 radical-audited primitive necklaces / Goldbach 3 central half-channel rows / Twin 4 moving-half and 3 actual twin-start rows / 4 exact partial, equivalence, or no-go theorems / 0 conjecture resolutions", proof: "TICKET-234 proves that logarithmic scalar diagonal floors have a full-Gram rank obstruction, constructs infinitely many primitive binary Collatz false positives for every fixed finite affine sieve, identifies the strict Goldbach minor margin as endpoint-equivalent and proves exact same-half cancellation, and characterizes critical CRT noise by fixed-degree Cesaro correlations while leaving all four parent conjectures open" },
        { marker: "168", title: "Relative Schur control, Collatz divisor orders, Goldbach phase retrieval, and CRT overlaps sharpen four successor lemmas", state: "bounded", measure: "RH 4 exact adverse/safe Schur rows / Collatz 63,185 lineage-regression words and 56 primitive-common binary divisors / Goldbach 24 exact cyclic phase-retrieval rows / Twin 4 countermodels and one 202-start overlap audit / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-235 proves the exact kernel Schur-complement criterion and a size-only no-go, restores the general Collatz prime-power witness to TICKET-224 and proves a new binary primitive-divisor order/selection no-go, proves complete marginal Goldbach powers cannot recover target cross phase, and reduces fixed-degree CRT Cesaro energies to pair-overlap moments while leaving all four parent conjectures open" },
        { marker: "169", title: "Normalized contractions, three-prime order witnesses, reflected phase defects, and degree-two CRT reduction isolate four sharper gates", state: "bounded", measure: "RH 6 exact coherent-rank-one rows / Collatz one complete 28,826-residue order audit with 28,825 covered / Goldbach 4 exact actual-prime rows plus 3 direct DFT replays / Twin 3 finite diagnostic rows / 4 exact partial, reduction, or no-go theorems / 0 conjecture resolutions", proof: "TICKET-236 proves the normalized cross-block contraction criterion and a coordinate-minor counterfamily, gives an all-exponent three-prime Collatz witness theorem outside multiples of 28,826 and exhausts that fixed palette, proves the actual-prime reflected phase-defect identity and uncoupled inverse-log no-go, and reduces all fixed CRT degrees to degree two while leaving all four parent conjectures open" },
        { marker: "170", title: "Principal angles, finite-palette no-go, dyadic endpoints, and Welch floors expose four necessary corrections", state: "bounded", measure: "RH 5 exact principal-angle rows / Collatz 4 finite-palette lcm audits / Goldbach 8 exact endpoint rows / Twin 5 sharp Walsh and 3 actual support rows / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-237 proves that nested frame spans cannot yield a strict normalized gap, refutes every fixed finite Collatz prime palette, proves the exact truncated Goldbach identity g_X(2X)=1_P(X), and gives a sharp finite-support Welch floor for degree-two CRT energy while leaving all four parent conjectures open" },
        { marker: "171", title: "Multishell accumulation, valuation quantifiers, mesoscopic buffers, and effective rank sharpen the four current gates", state: "bounded", measure: "RH 7 exact multishell rows / Collatz 20 exact valuation witnesses plus an all-k equivalence / Goldbach 12 exact buffer rows / Twin 5 fixed-effective-rank counterrows / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-238 proves a multishell normalized cross-row-sum positivity criterion and strict-global-bound pairwise-angle no-go, exposes Collatz valuation witnesses as equivalent to affine nondivisibility while closing all run blocks, proves the X/(log X)^2 necessary Goldbach buffer scale, and identifies Twin degree-two decay with Gram effective-rank divergence while leaving all four parent conjectures open" },
        { marker: "172", title: "Cancellation, local lifting defects, reflected Fourier phase, and uniform CRT locality expose four transfer barriers", state: "bounded", measure: "RH 10 exact threshold/no-go rows / Collatz 17,982 odd-prime lifting audits plus exact local dichotomy / Goldbach 12 exact mesoscopic Fourier rows / Twin 5 exact uniform-CRT rows / 4 exact partial or no-go theorems / 0 conjecture resolutions", proof: "TICKET-239 proves a power-decay Schur threshold while refuting absolute summability as necessary, proves a Collatz local lifting-defect dichotomy, proves a mesoscopic reflected-Fourier identity and L2 no-go, and proves that uniform CRT Gram identity and maximal effective rank are compatible with infinitely many composite pairs while leaving all four parent conjectures open" },
        { marker: "173", title: "Cotlar necessity, rational Wieferich depths, Goldbach integrality, and one-sided prime CRT correct four proof routes", state: "bounded", measure: "RH 8 exact divergent-overlap Gram rows / Collatz 1,270,605 odd primes through 20M / Goldbach 15 signed-slack window rows / Twin 8 exact CRT witnesses plus 3 prime-weighted Gram rows / 4 exact route-correction theorems / 0 conjecture resolutions", proof: "TICKET-240 refutes absolute Cotlar summability as necessary or sign-sensitive, reduces the Collatz local defect to rational Wieferich depths, proves the proposed Goldbach signed-slack milestone is equivalent to representation existence, and proves every finite one-sided CRT pattern contains infinitely many prime/composite successors while leaving all four parent conjectures open" },
        { marker: "174", title: "Finite-information rank, fixed-base search, canonical errors, and periodic mimicry remove four false proof signals", state: "bounded", measure: "RH 4 finite prime-cosine rank certificates / Collatz 5,761,453 odd primes through 100M plus exact principal-unit countermodels / Goldbach 15 canonical-error rows / Twin 5 periodic-fingerprint CRT witnesses / 4 exact information-boundary theorems / 0 conjecture resolutions", proof: "TICKET-241 proves finite unsigned prime-cosine positivity is rank-limited and regularizer-dependent, refutes principal-unit algebra alone as a Collatz depth proof while extending the fixed-base scan to 100M, proves unspecified Goldbach error budgets are tautological or refinement-dependent, and proves every finite periodic Twin fingerprint has infinitely many prime/composite-successor mimics while leaving all four parent conjectures open" },
        { marker: "175", title: "Moving quantifiers, unbounded order cores, Parseval scale, and diagonal CRT isolate four sharper gates", state: "bounded", measure: "RH 6 moving-vector finite sections / Collatz 17,981-prime order-core replay plus 5 growth witnesses / Goldbach 7 Parseval-scale rows / Twin 6 growing-period CRT witnesses / 4 exact boundary theorems / 0 conjecture resolutions", proof: "TICKET-242 refutes pointwise-to-uniform finite-section positivity, reduces the Collatz bad Fermat line to unbounded rational-Wieferich order cores, refutes global L2-only binary Goldbach minor-arc certificates at the natural scale, and refutes modulus growth alone via diagonal CRT mimicry while leaving all four parent conjectures open" },
        { marker: "176", title: "Bandlimit noncompactness, principal-unit countermodels, half-frequency energy, and dyadic mimicry close four sharper shortcuts", state: "bounded", measure: "RH 5 exact cosine-Gram rows / Collatz 5,130 local models through q=50,000 / Goldbach 7 exact half-frequency rows / Twin 16 finite dyadic witnesses / 3 exact route no-gos plus 1 partial theorem / 0 conjecture resolutions", proof: "TICKET-243 refutes frequency tightness alone as Weil-test compactness, refutes universal principal-unit order-core transfer with an unbounded-order family, proves an omitted parity-frequency arc carries natural binary energy, and strengthens fixed-period Twin mimicry to every sufficiently large dyadic block while leaving all four parent conjectures open" },
        { marker: "177", title: "Joint tightness, harmonic bad lines, parity folding, and polylog mimicry sharpen four infinite gates", state: "bounded", measure: "RH 5 exact Gram plus 5 rational translation rows / Collatz 2,259-prime harmonic replay / Goldbach 8,290 exact even-target checks / Twin 4 polylog-period witnesses / 3 partial theorems plus 1 exact route no-go / 0 conjecture resolutions", proof: "TICKET-244 characterizes joint physical-frequency L2 compactness, rewrites the fixed-base Collatz bad line as exact harmonic-prefix identities, folds the odd-prime Goldbach coefficient across the half-turn, and refutes every pure periodic Twin classifier bounded by a fixed logarithmic power while leaving all four parent conjectures open" },
        { marker: "178", title: "Closure margins, second Fermat digits, Klein arc orbits, and Linnik-height mimicry sharpen four infinite gates", state: "bounded", measure: "RH 6 exact exhaustion margins / Collatz 1,270,604-prime first-layer scan plus 5,130 q-cubed replays / Goldbach 7,524 closed rational centers and 1,882 quarter-torus orbits / Twin 5 polynomial-height CRT witnesses / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-245 refutes compactness-plus-pointwise-positivity as a uniform Weil margin, derives exact second Fermat digits for the fixed Collatz bases, folds all rational Goldbach centers by Klein-four symmetry, and uses Linnik to bound every fixed-period Twin false positive polynomially in the period while leaving all four parent conjectures open" },
        { marker: "179", title: "Finite-moment annihilation, all-depth Fermat algebra, rational-center Parseval, and prime-power contamination sharpen four gates", state: "bounded", measure: "RH 9 exact annihilator rows / Collatz 17,981-prime five-digit replay / Goldbach 27 selected rows across 186 denominator scans / Twin 6 exact proxy scales / 3 partial theorems plus 1 exact no-go / 0 conjecture resolutions", proof: "TICKET-246 constructs an all-m finite-even-moment annihilator no-go, proves an exact terminating all-depth polynomial for the fixed Collatz bases, identifies rational-center Goldbach residual energy by Parseval, and bounds odd prime-power pair contamination while leaving all four parent conjectures open" },
        { marker: "180", title: "Hilbert-Schmidt compactness, Hensel countermodels, arc Lipschitz transfer, and sharp prime-power contamination close four shortcuts", state: "bounded", measure: "RH 10 exact Legendre rows / Collatz 1,226-prime eight-digit Hensel replay / Goldbach 27 selected rows plus 4 exact counterexamples / Twin 7 exact proxy scales / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-247 refutes every Hilbert-Schmidt weighted-moment coercivity bound on the full even L2 unit sphere, constructs formal Collatz Hensel countermodels at every prime and depth, transfers Goldbach center control to arcs with a necessary first-moment term, and sharpens odd prime-power contamination while leaving all four parent conjectures open" },
        { marker: "181", title: "Unweighted moment escape, generalized-Wieferich separation, centered first jets, and active contamination isolate four sharper gates", state: "bounded", measure: "RH 8 exact Legendre rows / Collatz 78,495-prime generalized-Wieferich scan / Goldbach 36 selected exact rows across 282 denominator cases / Twin 7 exact active-contamination scales / 3 partial theorems plus 1 exact no-go / 0 conjecture resolutions", proof: "TICKET-248 extends the raw-moment no-go beyond Hilbert-Schmidt weights, characterizes the actual Collatz first-level failure by a separated generalized-Wieferich prime, proves a centered Goldbach first-jet Parseval identity, and isolates exact active prime-power contamination while leaving all four parent conjectures open" },
        { marker: "182", title: "Compact perturbations, projective slopes, Parseval spikes, and active-power Diophantine classification close four sharper shortcuts", state: "bounded", measure: "RH 8 exact compact models / Collatz 664,576-prime scan plus 10,900 finite-field pairs / Goldbach 5,020 exact group-ring cases / Twin 7 active-classification scales / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-249 refutes every compact off-diagonal repair of full-sphere raw-moment coercivity, reduces the actual Collatz obstruction to projective Fermat-quotient slope [3:5], refutes Parseval-only Goldbach numerator uniformity with an exact two-spike countermodel, and classifies the away-from-3 even-exponent left-active twin contamination as the single pair (25,27) while leaving all four parent conjectures open" },
        { marker: "183", title: "Noncompact concentration escape, local lift transitivity, prime-modulus Galois support, and complete even-left classification sharpen four gates", state: "bounded", measure: "RH 9 Legendre plus 12 concentration rows / Collatz 73,901 exact lift pairs / Goldbach 35 exact norm cases plus 2 boundary countermodels / Twin 9 active scales / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-250 refutes Legendre-only noncompact RH validation using a centered concentration escape, proves every local Collatz lift fiber contains projective slope [3:5], proves nonconstant rational prime-modulus Goldbach vectors have full reduced Fourier support and nonzero integer Galois norm, and classifies the entire even-left right-active twin contamination as 25 to 27 while leaving all four parent conjectures open" },
        { marker: "184", title: "Interior concentration, finite-prime CRT, cyclotomic-unit concentration, and a right-even modulo-eight constraint sharpen four gates", state: "bounded", measure: "RH 11 exact concentration rows / Collatz 4 exact CRT certificates / Goldbach 32 exact cyclotomic-unit cases / Twin 7 scales and 124 witnesses / 1 partial theorem plus 3 exact no-gos / 0 conjecture resolutions", proof: "TICKET-251 excludes every continuous nonnegative local RH multiplier with an interior zero, proves arbitrary finite-prime Collatz lift targets are CRT-interpolable, constructs nonnegative integer full-support Goldbach vectors with two-frequency energy concentration, and proves the elementary right-even constraints k odd and p=7 modulo 8 while leaving all four parent conjectures open" },
        { marker: "185", title: "Sparse projection escape, marginal blindness, zero-residue compatibility, and finite local solubility close four shortcuts", state: "bounded", measure: "RH 12 exact rational bounds / Collatz 11 exact joint-law rows / Goldbach 68 exact coefficient rows / Twin 8 local modulus rows / 1 partial theorem plus 3 exact no-gos / 0 conjecture resolutions", proof: "TICKET-252 proves sparse nonlocal projections can still lose coercivity, uniform marginals cannot detect Collatz joint slope mass, Goldbach zero-residue compatibility excludes all low degrees but has an exact tail countermodel, and every fixed finite twin congruence system is locally soluble while leaving all four parent conjectures open" },
        { marker: "186", title: "Density packets, complete-character dichotomy, forced prime prefixes, and 84 Lebesgue-Nagell exponents isolate four sharper gates", state: "bounded", measure: "RH 11 exact density rows / Collatz 12 exact character rows / Goldbach 10 exact prime-prefix rows / Twin 84 exponent rows plus 4,999 finite factor scans / 3 partial theorems plus 1 exact no-go / 0 conjecture resolutions", proof: "TICKET-253 proves an exact Dirichlet-packet spectral-density limit, identifies the complete fixed-q Collatz character sum with the target indicator, proves a unique-prime-prefix criterion for compatible Goldbach tails, and conditionally on the cited Katz-Pratt theorem reduces right-even Twin contamination to exactly 84 Lebesgue-Nagell exponents while all four parent conjectures remain open" },
        { marker: "187", title: "Positive-diagonal and weighted-detector no-gos, even reflection, and exponent-17 Thue reduction isolate four sharper gates", state: "bounded", measure: "RH 8 exact operator blocks / Collatz 48 detector plus 12 weighted rows / Goldbach 50 reflection certificates / Twin 17 polynomial pairs and 10,608 twist-points / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-254 proves diagonal-only RH packet domination is impossible in the abstract positive-operator class, nonnegative complete Collatz detector averages equal incidence, even non-q-divisible compatible Goldbach tails are excluded past their second residue-prime threshold, and the exponent-17 Twin obstruction reduces exactly to 17 unit-twisted coefficient-one Thue equations while all four parent conjectures remain open" },
        { marker: "188", title: "Aggregate packet no-go, incomplete-recovery no-go, odd reflection, and three-prime Thue obstruction sharpen four gates", state: "bounded", measure: "RH 8 exact positive blocks / Collatz 48 missing-frequency certificates / Goldbach 4 exact odd-prefix certificates / Twin 3 split primes representing 3,343,203 residue cases and excluding 15 of 17 twists / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-255 proves strict diagonal dominance is unnecessary for positive packet energy, proper incomplete character support cannot exactly recover incidence, odd Goldbach reflection forces a 2t-1 prefix obstruction, and split primes 103, 137, and 409 reduce the exponent-17 Twin obstruction from 17 Thue twists to two while all parent conjectures remain open" },

        { marker: "189", title: "Packet-Cesaro identity, sharp incomplete kernel, q-divisible reflection, and GL2 survivor reduction sharpen four gates", state: "bounded", measure: "RH 12 exact packet rows / Collatz 22 exact prime rows / Goldbach 97 q-divisible scans and 2 prefix certificates / Twin 16,641 GL2 grid identities reducing 2 branches to 1 / 4 partial theorems / 0 conjecture resolutions", proof: "TICKET-256 proves the packet-energy Cesaro identity, the minimax-sharp 1/q incomplete-kernel error with decay-only unnormalized averaging, impossibility of odd q-divisible compatible Goldbach tails plus two bounded prefix exclusions, and a determinant-one equivalence reducing the two surviving exponent-17 Thue twists to one absolute branch while all parent conjectures remain open" },
        { marker: "190", title: "Sparse packet spikes, cyclotomic noncancellation, a q=11 character certificate, and root-neighbor reduction sharpen four gates", state: "bounded", measure: "RH 8 exact spike rows / Collatz 22 exact canonical phases / Goldbach 3 prefixes through T=7,759,741 with 1 new q=11 certificate / Twin 400,399 root-neighbor evaluations through |v|=200,000 / 2 exact no-gos plus 2 partial theorems / 0 conjecture resolutions", proof: "TICKET-257 refutes positivity-plus-convergence as an abstract RH lag-sum route, proves finite distinct-prime cyclotomic phase sums never vanish exactly, excludes the q=11,m=22 Goldbach prefix by a character mismatch, and reduces the surviving exponent-17 coefficient-one branch to one root-neighbor sequence while all parent conjectures remain open" },
        { marker: "191", title: "Bounded variation, rational independence, character completeness, and root convergents sharpen four gates", state: "bounded", measure: "RH 12 exact BV spike rows / Collatz 166 canonical phases through q=997 / Goldbach 6 modulus classifications plus one actual q=5 certificate / Twin 128 convergents excluding a 62-digit denominator bound / 2 exact no-gos plus 2 partial theorems / 0 conjecture resolutions", proof: "TICKET-258 refutes ordinary bounded variation as an RH packet repair, proves rational independence for nontrivial distinct odd-prime phases, classifies single primitive odd-character completeness, and reduces the surviving exponent-17 unit branch to continued-fraction convergents while all parent conjectures remain open" },
        { marker: "194", title: "Sharpness, Weyl harmonics, prime-prefix parity, and bidirectional congruences sharpen four gates", state: "bounded", measure: "RH 128 reciprocal-tail rows / Collatz 128 countermodel rows plus 16,384 canonical angles / Goldbach 3 actual q=3 prefixes and 16 abstract rows / Twin 1,024 convergents and both signs through a 519-digit denominator / 2 exact no-gos plus 2 partial theorems / 0 conjecture resolutions", proof: "TICKET-261 proves RH scaled-variation summability is not necessary, constructs first-harmonic cancellation with persistent angular discrepancy, derives a q=3 prime-prefix product obstruction, and proves simultaneous Twin congruences modulo v squared and u squared while all parent conjectures remain open" },
        { marker: "195", title: "Exact limsup threshold, every finite harmonic cutoff, mod-8 tie obstruction, and third-order congruences sharpen four gates", state: "bounded", measure: "RH 64 strict plus 12 critical rows / Collatz 5 cutoffs and 1,152 phase cases / Goldbach 3 actual q=3 prefixes plus 16 sharpness models / Twin 1,024 convergents and both signs through a 519-digit denominator / 1 exact no-go plus 3 partial theorems / 0 conjecture resolutions", proof: "TICKET-262 proves an exact abstract RH lag-limsup equivalence, refutes every fixed finite Weyl cutoff as a Collatz angular-discrepancy shortcut, derives a q=3 modulo-eight tie obstruction, and proves simultaneous third-order Twin congruences modulo v cubed and u cubed while all parent conjectures remain open" },
        { marker: "196", title: "Sharp reciprocal envelope, growing Weyl cutoff, mod-32 tie phase, and ninth-order tail exactness sharpen four gates", state: "bounded", measure: "RH 192 exact alternating rows / Collatz 5 complete grids and 119 harmonics / Goldbach 3 actual q=3 prefixes plus 15 nonsufficiency models / Twin 1,024 convergents with 986 tail-exact rows through a 519-digit denominator / 4 partial theorems / 0 conjecture resolutions", proof: "TICKET-263 proves the optimal factor-two reciprocal packet-envelope bound, diagonalizes all fixed Weyl limits into one growing cutoff, refines the q=3 tie obstruction to four phases modulo 32, and makes the Twin joint ninth-order congruence pair equivalent to the original unit equation beyond an explicit root-cone threshold while all parent conjectures remain open" },
        { marker: "197", title: "Asymmetric envelope, explicit threshold cutoff, fixed two-adic no-go, and finite-head closure sharpen four gates", state: "bounded", measure: "RH 192 exact asymmetric rows / Collatz 6 complete grids and 252 threshold cases / Goldbach 16 phase periods plus 242 shifted-count models / Twin 39 convergents through the first threshold crossing / 3 partial theorems plus 1 exact no-go / 0 conjecture resolutions", proof: "TICKET-264 proves the sharp asymmetric reciprocal packet-envelope bound, replaces an existential diagonal cutoff by an explicit finite-data threshold functional, eliminates every fixed two-adic Goldbach tie-signature sufficiency route, and closes all 38 Twin root convergents below the ninth-order threshold while all parent conjectures remain open" },
        { marker: "198", title: "Sparse-envelope and unbounded-cutoff no-gos, growing two-adic tie test, and mod-32 Twin filter sharpen four gates", state: "bounded", measure: "RH 16 sparse spike pairs / Collatz 9 dyadic good-bad prefixes / Goldbach 32 sharp thresholds plus 3 inherited actual rows / Twin 1,024 convergents with 35 filter survivors / 2 partial theorems plus 2 exact no-gos / 0 conjecture resolutions", proof: "TICKET-265 refutes density-one replacement of the RH all-index envelope, separates unbounded explicit cutoffs from divergence, identifies the least decisive growing two-adic Goldbach tie modulus, and proves a necessary but insufficient primitive Twin mod-32 diagonal filter while all parent conjectures remain open" },
      ],
      evidence_flow: [
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket265-sparse-cutoff-growing2adic-mod32.json", "docs/sparse-cutoff-growing2adic-mod32.md", "docs/sparse-cutoff-growing2adic-mod32.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-265 proves two partial theorems and two exact no-gos, records four acyclic proof DAGs, checks 16 RH spike pairs, 9 Collatz dyadic stages, 32 Goldbach thresholds plus 3 inherited actual rows, and 1,024 Twin convergents while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires an actual-Weil one-sided envelope-sum bound, no bounded subsequence of the canonical Fermat-quotient threshold cutoff, all-level avoidance of the decisive q=3 two-adic residue, and ninth-order exclusion of every later mod-32 Twin survivor." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-265: sparse-envelope and cutoff no-gos, a growing two-adic tie test, and a mod-32 Twin filter, while preserving TICKET-264 and the full ledger.", metric: "4 current cards / 265 tickets" },
      ...
      { label: "Pre-replay separator", impact: "TICKET-61 forbids replay-derived keys and finds low40 plus high_extension mod 16 predicts failure_offset, outcome, and boundary-match status on the selected mixed cylinders.", metric: "mod 16 / 0 collisions" },
      { label: "Mod16 lift survival", impact: "TICKET-62 lifts the selected mixed rows to 52 and 56 bits and finds no mod16 collision or full-period replay among surviving start-template lifts.", metric: "824 at 56 bits / 0 collisions" },
      { label: "Mod16 automaton table", impact: "TICKET-63 chains the 56-bit survivors to 60 bits, keeps 209 start-template target rows, and finds deterministic state tables with no audited automaton collisions.", metric: "13,184 lifts / 209 rows / 0 collisions" },
      { label: "Symbolic gate obstruction", impact: "TICKET-64 extends the 60-bit survivors to 64-bit candidate children and refutes the direct 0->0 symbolic transition shortcut.", metric: "3,344 children / 42 starts" },
      { label: "Start-template chain extinction", impact: "TICKET-65 follows the retained start-template chain through 80 bits and finds the survivor sequence 824->209->42->12->3->1->0, while compact gate separators collapse to row-unique states.", metric: "80-bit extinction / 0 full periods" },
      { label: "Complement frontier isolated", impact: "TICKET-66 tests the missing complement cover and finds 17,134 open needs_split instances across 491 template families, so the next target is a rank theorem or compatible infinite lift.", metric: "17,134 open / 491 families" },
      { label: "Rank cycle frontier", impact: "TICKET-67 splits the 491 families one more level and refutes simple rank closure by exposing a 429-node cyclic SCC and 96,433 nondecreasing debt edges.", metric: "429-node SCC / 96,433 edges" },
      { label: "Refined DAG frontier", impact: "TICKET-68 tests seven refinements of the 429-node SCC; prefix/consumed coordinates make the observed graph acyclic, while tail/residue-only refinement still leaves 26 cyclic nodes.", metric: "9,616 states / 0 cycles" },
      { label: "Rank frontier audit", impact: "TICKET-69 checks every observed internal prefix/consumed edge and finds zero rank nondecrease, but leaves 6,649 rank-0 child-only states to expand.", metric: "89,222 descent / 6,649 frontier" },
      { label: "Frontier closure refuted", impact: "TICKET-70 expands the rank-0 frontier and shows direct terminal closure fails: 155,321 branches re-enter known ranks without descent and 59,449 enter new unranked internal states.", metric: "792,064 branches / 155,321 re-entry" },
      { label: "Bounded separator tradeoff", impact: "TICKET-71 finds that a full-word residue coordinate separates the bounded branch set, while the compact coordinate keeps a smaller frontier but leaves 22,219 mixed transition keys.", metric: "0 mixed full-word / 22,219 compact" },
      { label: "Persistent lift-chain pressure", impact: "TICKET-72 corrects rank descent out of the pressure count, then shows the remaining open pressure re-enters compact mixed keys under second and third lifts.", metric: "4,142 second / 6,448 third" },
      { label: "Strict re-entry tree exhausted", impact: "TICKET-73 replaces capped persistence with an all-root exact lineage tree and closes the selected strict re-entry predicate at the fifth lift, without globalizing the result.", metric: "4,142 roots / 0 fifth" },
      { label: "Coverage leakage exposed", impact: "TICKET-74 shows that TICKET-73 strict extinction is not pressure closure: the fifth lift escapes the old cover and the escape forest retains open pressure at the sixth lift.", metric: "15,696 escape / 78,315 sixth" },
      { label: "Finite-coordinate closure blocked", impact: "TICKET-75 tests eight fixed finite pre-outcome coordinates and finds a compression-versus-state-growth trade-off instead of a closed induction invariant.", metric: "8 tested / 0 pass" },
      { label: "Boundary recurrence isolated", impact: "TICKET-76 derives the exact four-bit quotient recurrence and shows why fixed low-bit repairs lose four new bits at every unresolved lift.", metric: "297,104 rows / 0 failures" },
      { label: "Fixed-prefix ghost classified", impact: "Corrected TICKET-77 retains equality rollback, classifies the periodic quotient orbit, and rejects its -1/3 preimage as a positive-integer counterexample.", metric: "18,569 equality / max 15 strict steps" },
      { label: "Finite 2-adic separator blocked", impact: "TICKET-78 proves every finite accelerated valuation cylinder has infinitely many natural witnesses and rejects continuous finite-state natural classifiers.", metric: "65,535 words / 262,140 replays" },
    ],
    research_delta: {
      ...
      tracks: [
        ...
        { track: "Publication", before: "Informal narrative claims", current: "21 checksummed artifacts, claim-language audit, open-problem certificates, claim ledger, lineage DAG, decision protocol, falsification battery, consistency audit", state: "guarded" },
        { track: "Open proof search", before: "Scalar rank and symbolic clause candidates could still look plausible on bounded horizons.", current: "TICKET-46 refutes 5/5 tested finite template-local scalar clause-rank grammars; TICKET-47 refutes bounded suffix-memory repairs; TICKET-48 refutes fixed finite total state repairs over the abstract lasso; TICKET-49 localizes the first concrete prefix failure to next_valuation; TICKET-50 refutes that obstruction's all-phase extension; TICKET-51 closes the two known depth-15 near-lasso roots at phase 15; TICKET-52 finds a new sampled 48-bit depth-15 root and closes it; TICKET-53 explains all known terminal closures by a symbolic mismatch theorem and discards the extracted lasso family; TICKET-54 extracts Phase5ValuationGate as the strongest remaining bounded family; TICKET-55 proves the known gate crossers tunnel into the terminal no-go; TICKET-56 closes the exact 32-bit partition but refutes simple projection-closure globalization; TICKET-57 shows exact32 outcomes need affine boundary coordinates; TICKET-58 refutes unchanged exact32 affine-boundary lifting in the replayed 48-bit sample; TICKET-59 counts selected low40-to-48 cylinders and shows the next missing coordinate is inside mixed cylinders; TICKET-60 identifies replay-derived failure_offset as a separator; TICKET-61 replaces it with the pre-replay coordinate low40 + high_extension mod 16; TICKET-62 tests 52/56-bit lifts and finds no mod16 collision among surviving start-template lifts; TICKET-63 extracts deterministic automaton state tables and reduces the chained 60-bit quotient to low40 mod 2^20 + base_mod16; TICKET-64 refutes the direct 0->0 symbolic transition shortcut at 64 bits; TICKET-65 closes the tracked start-template chain by 80 bits; TICKET-66 refutes the already-covered complement shortcut; TICKET-67 refutes one-step split closure, strict template rank, and scalar debt rank; TICKET-68 breaks the observed 429-node SCC under prefix/consumed refinement; TICKET-69 validates strict rank descent on the observed internal edges and moves the proof gap to the 6,649-state unexpanded frontier; TICKET-70 expands that frontier and refutes direct rank-0 terminal closure; TICKET-71 finds a bounded full-word separator but leaves compact infinite lift closure open; TICKET-72 separates rank descent from open pressure and exposes persistent mixed-key lift-chain pressure; TICKET-73 exactly extinguishes the selected strict re-entry tree at the fifth lift, while leaving root coverage open; TICKET-74 proves that this strict extinction leaks into new unranked pressure states and cannot be promoted to a global cover.", state: "open" },
      ],
      claim_lanes: [
...
function buildResearchAtlas(evolution) {
  ...
  return {
    ...
    openProblems: [
      {
        name: "Riemann Hypothesis / 리만 가설",
        href: "open-problems/riemann.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-265 exact no-go: density-one reciprocal control cannot replace the all-index packet envelope. / 밀도 1 reciprocal 제어는 all-index packet envelope를 대체할 수 없습니다.",
        artifact: "next: ActualWeilPacketOneSidedReciprocalEnvelopeSumBelowLimit",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-265 exact no-go: an unbounded explicit threshold cutoff need not diverge. / 명시적 threshold cutoff의 비유계성은 발산을 뜻하지 않습니다.",
        artifact: "next: CanonicalFermatQuotientThresholdCutoffHasNoBoundedSubsequence",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-265 partial theorem: the least growing two-adic modulus above M decides an abstract q=3 tie sharply. / M보다 큰 최소 성장형 2-adic modulus가 추상 q=3 tie를 sharp하게 판정합니다.",
        artifact: "next: Q3ActualMinusCountAvoidsLeastDecisiveTwoAdicTieResidue",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-265 partial theorem: primitive Twin unit solutions obey a necessary mod-32 diagonal filter whose sufficiency has explicit countermodels. / 원시 Twin unit 해는 필요하지만 불충분한 mod-32 대각 필터를 만족합니다.",
        artifact: "next: EveryLaterMod32FilterPassFailsJointNinthOrderCongruences",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
