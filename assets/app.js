  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket249-compact-projective-parseval-lebesgue.json", "docs/compact-projective-parseval-lebesgue.md", "docs/compact-projective-parseval-lebesgue.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-249 proves two partial theorems and two exact route no-go results, records four acyclic proof DAGs with zero machine failures, checks eight compact models, scans 664,576 primes plus 10,900 finite-field pairs, audits 5,020 exact Goldbach group-ring cases, and checks seven twin classification scales while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires a noncompact arithmetic Weil form or Legendre exclusion, occurrence or avoidance of projective slope [3:5], prime-specific reduced-numerator jet anti-concentration, and a scale-local right-active prime-power contamination bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-249: compact perturbation no-go, projective Fermat quotients, Parseval spikes, and active-power classification, while preserving TICKET-248 and the full ledger.", metric: "4 current cards / 249 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-249 exact no-go: every compact correction vanishes along the normalized Legendre escape sequence together with Q0. / 모든 compact 보정은 Legendre 도주열에서 Q0와 함께 사라집니다.",
        artifact: "next: NoncompactArithmeticWeilFormOrLegendreExclusion",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-249 partial: actual first-level failure is exactly the nonzero Fermat-quotient projective point [3:5]. / 실제 첫 단계 실패는 0이 아닌 Fermat-quotient projective 점 [3:5]입니다.",
        artifact: "next: OccurrenceOrAvoidanceOfProjectiveFermatQuotientSlopeThreeFifths",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-249 exact no-go: a centered cosine jet concentrates exactly half the Parseval energy at each of two reduced numerators. / 중심 cosine jet은 두 reduced numerator 각각에 Parseval 에너지 절반을 집중시킵니다.",
        artifact: "next: PrimeSpecificReducedNumeratorJetAntiConcentration",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-249 partial: away from base 3, the even-exponent left-active contamination is exactly 25→27. / 밑 3 밖의 왼쪽 짝수 지수 활성 오염은 정확히 25→27입니다.",
        artifact: "next: ScaleLocalRightActivePrimePowerContaminationBound",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
