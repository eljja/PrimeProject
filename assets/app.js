...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 224,
    claim_language_scanned_lines: 77777,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket226-signal-transfer-same-order-obstructions.json", "docs/signal-transfer-same-order-obstructions.md", "docs/signal-transfer-same-order-obstructions.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-226 proves four exact transfer or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires balanced-band explicit-formula control on a dense Weil core, exact Collatz D-divisibility exclusion plus aperiodic descent, a signed Goldbach minor-arc power saving, and shifted Type-II Twin separation on unbounded blocks." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-226: balanced Chebyshev-band geometry, an infinite Collatz route counterfamily, and same-order rough-semiprime obstructions, while preserving TICKET-225 and the full ledger.", metric: "4 current cards / 226 tickets" },
