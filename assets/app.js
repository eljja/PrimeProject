...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 81,
      claim_language_scanned_lines: 25819,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 87, status: "open", artifacts: ["data/open-problem/ticket137-cancellation-entropy-and-information-budget.json", "data/open-problem/ticket136-scale-sensitive-obstructions-and-affine-bridge.json", "docs/cancellation-entropy-and-information-budget.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET137 proves four exact intermediate or no-go theorems, rejects four magnitude, measure, or finite-period shortcuts, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires signed projected Weil cancellation, arithmetic emptiness of affine-capped natural Collatz codes, a near-full-scale wheel or pointwise Goldbach K56 residual bound, and an irrational or supercritical aperiodic Type II Twin separator." },
      ],
    },
    latest_changes: [
