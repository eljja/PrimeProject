...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 71,
      claim_language_scanned_lines: 21876,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 75, status: "open", artifacts: ["data/open-problem/ticket127-exception-repair-effective-bridges.json", "data/open-problem/ticket126-route-correction-audit.json", "docs/exception-repair-and-effective-bridges.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET127 proves four exact intermediate bridges and one public correction while keeping all four conjecture-resolution counters at zero.", proof: "The workbench now excludes the Collatz n=1 basin from counterexample language, isolates RH counterexample semidecision assumptions, closes Goldbach A=1 structurally, and requires uniform raw Vaughan transport beyond finite Twin endpoints." },
      ],
    },
    latest_changes: [
