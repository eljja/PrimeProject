...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 208,
    claim_language_scanned_lines: 72526,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket217-relative-threshold-convergent-moment-tail.json", "docs/relative-threshold-convergent-moment-tail.md", "docs/relative-threshold-convergent-moment-tail.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-217 proves four exact partial, reduction, or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a cofinal actual-zeta relative-precision enclosure below one, an effective barrier for all upper Collatz convergents followed by multi-run control, a pointwise Goldbach lower-tail theorem beyond the moment barrier, and an actual Twin Abel surplus above the critical tail." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-217: the Riemann normalized multi-radius certificate, Collatz continued-fraction compression and k<71,356,888 exclusion, sharp Goldbach moment-support certificate, and critical Twin Abel-tail constant, while preserving TICKET-216 and the full ledger.", metric: "4 current cards / 217 tickets" },
