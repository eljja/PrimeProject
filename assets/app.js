...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 95,
    claim_language_scanned_lines: 33351,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket151-negative-affine-transversal-logtwo.json", "data/open-problem/ticket150-relative-delay-hole-parity.json", "docs/negative-affine-transversal-logtwo.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET151 proves four exact partial or target-correction theorems, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an actual Weil negative relative spectral-part bound, a type-two Collatz affine-threshold cylinder cover below the shadow entry, orbit-resolved von Mangoldt approximation inside the weighted K56 hole radius, and positive gap-two cubic-rough mass with shifted log-two marginal transfer." },
      ],
    },
    latest_changes: [
