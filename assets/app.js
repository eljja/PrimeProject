  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 78, status: "open", artifacts: ["data/open-problem/ticket129-enumerable-core-valuation-cap-endpoint-budget.json", "data/open-problem/ticket128-finite-core-prefix-constant-interpolation.json", "docs/enumerable-core-valuation-cap-endpoint-budget.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET129 proves four exact intermediate results while keeping all four conjecture-resolution counters at zero.", proof: "The workbench now has an enumerable dense RH autocorrelation core, a Collatz least-counterexample valuation cap through 2^29 steps, an exact rational Goldbach endpoint making K=56 sufficient, and the exact Twin signed-increment target limsup D(2^j)<0.08 with a monotone endpoint countermodel." },
      ],
    },
    latest_changes: [
