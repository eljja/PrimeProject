...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 228,
    claim_language_scanned_lines: 78906,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket227-mellin-block-buchstab-lifts.json", "docs/mellin-block-buchstab-lifts.md", "docs/mellin-block-buchstab-lifts.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-227 proves four exact structural lemmas, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a quantitative dual-dilation frame bound on a dense Weil core, universal prime-power witnesses against Collatz divisibility plus aperiodic descent, moving-residue Goldbach cell estimates, and shifted bilinear Twin estimates across all cube-root cells." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-227: dual-dilation Mellin separation, an all-r Collatz block-suffix certificate, and exact Goldbach/Twin factor cells, while preserving TICKET-226 and the full ledger.", metric: "4 current cards / 227 tickets" },
