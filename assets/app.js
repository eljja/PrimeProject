  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      release_trail: [
        ...
        { marker: "192", title: "Critical strictness, aligned phases, exact q-divisible compatibility, and fixed-local witnesses sharpen four gates", state: "bounded", measure: "RH 12 critical rows / Collatz 166 exact alignment envelopes / Goldbach 208 compatibility rows plus 135,207,787-prime q=13 certificate with 2 algorithms / Twin 30 local witnesses representing an all-modulus theorem / 3 exact no-gos plus 1 partial theorem / 0 conjecture resolutions", proof: "TICKET-259 proves critical scaled-drop equality insufficient, constructs distinct-prime phases with linear magnitude, classifies q-divisible Goldbach compatibility and excludes q=13,m=26 independently, and refutes fixed finite congruences plus a fixed root window while all parent conjectures remain open" },
      ],
      evidence_flow: [
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket259-critical-alignment-compatibility-local.json", "docs/critical-alignment-compatibility-local.md", "docs/critical-alignment-compatibility-local.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-259 proves three exact no-gos and one partial theorem, records four acyclic proof DAGs, checks 12 RH rows, 166 Collatz envelopes, 208 Goldbach compatibility rows, two exact q=13 residue algorithms, and 30 Twin witnesses while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires a strict actual-Weil margin, sublinear canonical Fermat-quotient phase sums, nonzero odd-character moments for every q-divisible compatible Goldbach prefix, and exclusion of unit coefficients on every Twin root convergent." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-259: critical strictness, aligned phases, exact Goldbach compatibility plus q=13, and the Twin fixed-local no-go, while preserving TICKET-258 and the full ledger.", metric: "4 current cards / 259 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-259 exact no-go: equality at the critical scaled-drop threshold still permits infinitely many negative lag sums. / 임계 scaled-drop 등호도 무한한 음의 lag 합을 허용합니다.",
        artifact: "next: ActualWeilPacketMarginStrictlyDominatesScaledDownwardVariation",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-259 exact no-go: distinct nontrivial prime-order phases can align with linear magnitude. / 서로 다른 비자명 소수 차수 위상도 선형 크기로 정렬될 수 있습니다.",
        artifact: "next: CanonicalFermatQuotientPhasePrefixSumsHaveSublinearMagnitude",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-259 partial theorem: q-divisible compatibility holds iff s=2 mod 4, and q=13,m=26 is exactly excluded. / q-divisible 호환성을 완전 분류하고 q=13,m=26을 배제했습니다.",
        artifact: "next: EveryTwoModuloFourQDivisiblePrimePrefixHasNonzeroOddCharacterMoment",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-259 exact no-go: fixed congruences plus a fixed root window admit infinitely many local witnesses. / 고정 합동식과 고정 root window에는 무한한 국소 증인이 있습니다.",
        artifact: "next: EveryUniqueRootConvergentMissesUnitCoefficient",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
