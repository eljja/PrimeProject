...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 124, scanned_line_count: 46598, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 124,
    claim_language_scanned_lines: 46598,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket175-relative-equivalence-signed-block.json", "data/open-problem/ticket174-tail-lift-adaptive-scalepair.json", "docs/relative-equivalence-signed-block.md", "docs/relative-equivalence-signed-block.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET175 proves four exact reduction/no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires structured relative Weil-core sign preservation below the tiny ground-state scale, corrected valuation-boundary crossing for every aperiodic natural Collatz ray plus separate cycle exclusion, fixed-Farey signed minor power saving below a proved major main term, and uniform power saving for the prime-pair Haar block-norm scale-matrix operator." },
      ],
    },
    latest_changes: [
