...
const bundledEvidencePack = {
  ...
  publication_gates: [
    ...
    { code: "reproducibility_gate", passed: true, severity: "medium" },
    {
      ...
      passed: true,
      severity: "high",
      evidence: { quality_gate_status: "pass", fail_count: 0, scanned_file_count: 90 },
    },
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 90, scanned_line_count: 30542, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 90,
      claim_language_scanned_lines: 30542,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      release_trail: [
        ...
        { marker: "106", title: "Toeplitz reflection, polynomial-rank, Fourier-phase, and Frechet audits isolate four joint-information barriers", state: "bounded", measure: "RH 6 exact reflection orders plus 12 fixed-lag no-go rows / Collatz 30 polynomial-rank rows / Goldbach 6 exact phase counterexamples / Twin 2 same-marginal countertables plus 4 finite rough rows / 0 conjecture resolutions", proof: "TICKET-146 reduces a shift-generated Weil convolution core to exact Toeplitz-Levinson reflection coefficients, excludes every lower-bounded finite-modulus piecewise-polynomial Collatz one-step rank, proves Fourier power data cannot determine a pointwise binary convolution, and derives sharp Frechet bounds showing marginal Liouville cancellation cannot replace joint parity control" },
      ],
      evidence_flow: [
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 96, status: "open", artifacts: ["data/open-problem/ticket146-toeplitz-polynomial-phase-frechet.json", "data/open-problem/ticket145-normalization-affine-endpoint-separable-no-go.json", "docs/toeplitz-polynomial-phase-frechet.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET146 proves four exact reductions or route no-go theorems, rejects fixed-lag, polynomial-rank, magnitude-only, and marginal-only proof targets, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an all-order Weil reflection-coefficient unit-disk bound, a lift-closed adaptive Collatz block descent, a phase-resolved Goldbach K56 scale envelope, and a one-sided joint cubic-rough Liouville Type II margin." },
      ],
    },
    latest_changes: [
