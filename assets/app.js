...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 202, scanned_line_count: 70741, claim_language_triggered_count: 126, claim_language_guarded_count: 126, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 280,
    claim_language_scanned_lines: 96925,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket253-density-character-prefix-lebesgue.json", "docs/density-character-prefix-lebesgue.md", "docs/density-character-prefix-lebesgue.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-253 proves one exact route no-go and three partial theorems, records four acyclic proof DAGs with zero machine failures, checks 11 RH density rows, 12 Collatz character rows, 10 Goldbach prime-prefix rows, and 84 Twin exponent rows while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires actual Weil-form domination on Dirichlet packets, cross-prime canonical slope-character cancellation, uniform prime-prefix discrepancy for every compatible tail, and exclusion of exponent 17 in the Lebesgue-Nagell equation." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-253: density packets, complete-character dichotomy, forced prime prefixes, and the 84-exponent frontier, while preserving TICKET-252 and the full ledger.", metric: "4 current cards / 253 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-253 partial theorem: Dirichlet-packet projection energy is exact symmetric frequency density. / projection energy는 정확한 대칭 주파수 밀도입니다.",
        artifact: "next: ActualWeilFormDominatesPositiveDensityProjectionOnDirichletPackets",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-253 exact no-go: the complete fixed-q character sum is the exact slope indicator. / complete character 합은 정확한 slope 지시함수입니다.",
        artifact: "next: CrossPrimeCanonicalSlopeCharacterAverageCancellation",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-253 partial theorem: each compatible tail is realizable iff one forced prime prefix matches exactly. / compatible tail은 하나의 강제 prime prefix로 판정됩니다.",
        artifact: "next: UniformPrimePrefixDiscrepancyExcludesEveryCompatibleCyclotomicTail",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-253 partial theorem: the cited Katz-Pratt result reduces right-even contamination to 84 prime exponents. / 인용 정리에 의존해 84개 지수로 축약됩니다.",
        artifact: "next: LebesgueNagellExponent17HasNoPositiveSolution",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
