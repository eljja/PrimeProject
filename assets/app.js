...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 86, scanned_line_count: 28097, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 86,
      claim_language_scanned_lines: 28097,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 92, status: "open", artifacts: ["data/open-problem/ticket142-effective-rank-cycle-direction-haar-liouville.json", "data/open-problem/ticket141-one-sided-moving-floor-robust-dual-large-sieve.json", "docs/effective-rank-cycle-direction-haar-liouville.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET142 proves four exact intermediate or proof-route no-go theorems, records four corrected proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an explicit projected-Weil finite-section and tail-convergence contract, a period-15601 affine numerator nondivisibility certificate plus global aperiodic descent, a uniform Goldbach Haar scale budget below 56, and a one-sided cubic-rough Liouville ledger gap." },
      ],
    },
    latest_changes: [
