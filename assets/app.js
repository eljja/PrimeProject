...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 128, scanned_line_count: 47824, claim_language_triggered_count: 125, claim_language_guarded_count: 125, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 142,
    claim_language_scanned_lines: 52797,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket184-information-sufficiency-route-correction.json", "data/open-problem/ticket183-abel-primitive-spectral-haar.json", "docs/information-sufficiency-route-correction.md", "docs/information-sufficiency-route-correction.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET184 proves four exact information boundaries or route corrections, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires full Weil-cone tail tightness, universal accelerated Collatz descent, growing-wheel prime-weighted Goldbach error control, and recurring parity-breaking positive Twin block totals." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-184, exact information-sufficiency boundaries, corrected targets, finite arithmetic diagnostics, proof DAGs, and remaining arithmetic premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 184 tickets" },
