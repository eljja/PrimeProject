  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket230-quantitative-recurrence-necklace-fourier-centering.json", "docs/quantitative-recurrence-necklace-fourier-centering.md", "docs/quantitative-recurrence-necklace-fourier-centering.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-230 proves four exact structural or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an adaptive or infinite Weil frame below the recurrence scale, necklace-representative Collatz nondivisibility plus aperiodic descent, a signed aggregate binary-prime minor-arc bound, and centered modulo-five Twin Type-II saving plus a positive principal lower bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-230: quantitative recurrence, necklace invariance, a Fourier aggregation no-go, and the corrected Twin local mean, while preserving TICKET-229 and the full ledger.", metric: "4 current cards / 230 tickets" },
