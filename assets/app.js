  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket247-hilbert-hensel-lipschitz-primepower.json", "docs/hilbert-hensel-lipschitz-primepower.md", "docs/hilbert-hensel-lipschitz-primepower.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-247 proves two partial theorems and two exact route no-go results, records four acyclic proof DAGs with zero machine failures, checks ten Legendre certificates, lifts 1,226 prime Hensel branches to eight digits, audits 186 Goldbach denominator cases plus four center-only counterexamples, and checks seven twin proxy scales while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires non-Hilbert-Schmidt arithmetic Weil coercivity, arithmetic exclusion of actual Fermat quotients from the bad Hensel branch, uniform signed residue and first-moment saving, and a scale-local Type-II lower bound beyond sharp prime-power contamination." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-247: Hilbert-Schmidt compactness, Hensel countermodels, center-to-arc transfer, and sharp prime-power contamination, while preserving TICKET-246 and the full ledger.", metric: "4 current cards / 247 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-247 exact no-go: every Hilbert-Schmidt weighted even-moment map has zero coercivity on the full normalized even L2 sphere. / 모든 Hilbert-Schmidt 가중 짝수 모멘트 사상의 전체 정규화 even L2 coercivity 하한은 0입니다.",
        artifact: "next: NonHilbertSchmidtArithmeticWeilCoercivityOnAdmissibleClosure",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-247 exact no-go: unrestricted q-adic polynomial domination has a bad Hensel branch at every prime and depth. / 무제약 q진 다항식 지배에는 모든 소수·깊이의 Hensel 반모형이 있습니다.",
        artifact: "next: ArithmeticFermatQuotientExclusionOfPqHenselBranch",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-247 partial: center Parseval control extends to arcs with 2π|β|M, and center-only uniformity is exactly refuted. / 중심 제어는 2π|β|M 항과 함께 호로 전달되며 중심-only 균일성은 반증됩니다.",
        artifact: "next: UniformSignedResidueVarianceAndFirstMomentSavingOnQuarterTorus",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-247 partial: odd composite prime powers have an exact exponent count and a sharper square/cube contamination correction. / 홀수 합성 소수거듭제곱은 정확한 지수별 계수와 더 작은 square/cube 오염 보정을 가집니다.",
        artifact: "next: ScaleLocalTypeIILowerBoundBeyondSharpPrimePowerContamination",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
