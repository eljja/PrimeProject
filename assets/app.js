  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 47, status: "open", artifacts: ["data/open-problem/ticket46-stable-clause-grammar-lab.json", "data/open-problem/ticket47-periodic-state-lasso-lab.json", "data/open-problem/ticket48-automaton-reachability-lab.json", "docs/proof-or-counterexample-program.md"], gate: "5 scalar clause-rank grammars, 5 bounded suffix-memory repairs, and fixed finite total state repairs over the abstract lasso refuted; no full proof claim", proof: "The proof workbench now discards tested finite quotient repairs and requires symbolic reachability exclusion, a concrete periodic lift witness, or an ordinal infinite bridge." },
      ],
    },
    latest_changes: [
