...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 85,
      claim_language_scanned_lines: 27581,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 91, status: "open", artifacts: ["data/open-problem/ticket141-one-sided-moving-floor-robust-dual-large-sieve.json", "data/open-problem/ticket140-spectral-moments-fixed-floor-duality-rotation.json", "docs/one-sided-moving-floor-robust-dual-and-large-sieve.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET141 proves four exact intermediate, corollary, or proof-route no-go theorems, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires a projected-Weil shifted logarithmic-order moment bound, a Collatz cycle minimum above the exact power-of-two window threshold plus aperiodic well-foundedness, a localized orthogonal K56 Goldbach dual, and uniform-minor-arc Vaughan bilinear cancellation with positive gap-two mass." },
      ],
    },
    latest_changes: [
