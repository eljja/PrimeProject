...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 94,
    claim_language_scanned_lines: 32797,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket150-relative-delay-hole-parity.json", "data/open-problem/ticket149-smooth-escape-wheel-cover.json", "docs/relative-delay-hole-parity.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET150 proves four exact partial theorems and four sharp no-go results, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an actual Weil prime-archimedean relative-form bound at most one, adaptive Collatz type-two valuation-surplus descent below the shadow entry, von Mangoldt endpoint reflection-mass retention at K56, and positive cubic-rough mass together with a one-sided Liouville marginal gap." },
      ],
    },
    latest_changes: [
