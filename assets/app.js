...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 132,
    claim_language_scanned_lines: 49219,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket179-symbol-adaptive-discrete-centering.json", "data/open-problem/ticket178-toeplitz-lowbit-split-zeromode.json", "docs/symbol-adaptive-discrete-centering.md", "docs/symbol-adaptive-discrete-centering.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET179 proves four exact representation/no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a bounded signed RH tail symbol, an every-orbit adaptive Collatz valuation surplus plus cycle exclusion, a uniform discrete Goldbach target deficit, and centered-energy saturation for actual prime-pair Haar blocks." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-179, exact representation boundaries, discarded routes, proof DAGs, and remaining proof gaps while preserving the full ledger in semantic archives.", metric: "4 current cards / 179 tickets" },
