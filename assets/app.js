...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 210,
    claim_language_scanned_lines: 73339,
    claim_language_triggered_mentions: 128,
    claim_language_guarded_mentions: 128,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket221-sharp-obstruction-certificates.json", "docs/sharp-obstruction-certificates.md", "docs/sharp-obstruction-certificates.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-221 proves four exact obstruction or sharpness theorems, records four proof DAGs with zero machine failures, corrects four insufficient next-lemma formulations, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an arithmetic-coupled RH dyadic tail budget below one, order-sensitive Collatz divisibility or descent plus divergence control, a prime-distribution theorem for a uniform cofinal Goldbach Lp margin, and a parity-breaking Type II Twin von Mangoldt pair lower bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-221: the Riemann scale-uniform envelope no-go, Collatz order-sensitive intercept witness, sharp Goldbach positivity radius, and Boolean Twin parity orthogonality, while preserving TICKET-220 and the full ledger.", metric: "4 current cards / 221 tickets" },
