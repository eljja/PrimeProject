  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket218-adaptive-radius-spike-residual-surplus.json", "docs/adaptive-radius-spike-residual-surplus.md", "docs/adaptive-radius-spike-residual-surplus.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-218 proves four exact partial, reduction, or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an actual-zeta adaptive envelope below exp(-tau), an effective exclusion of future exponential Collatz partial-quotient spikes followed by multi-run control, a cofinal Goldbach eighth-residual estimate, and an actual Twin Abel liminf above one half." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-218: the Riemann adaptive signal boundary, Collatz exponential denominator barrier and 49-convergent exclusion, exact Goldbach p=8 residual certificates, and sharp Twin Abel-surplus transfer, while preserving TICKET-217 and the full ledger.", metric: "4 current cards / 218 tickets" },
