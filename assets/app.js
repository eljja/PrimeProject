  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 86, status: "open", artifacts: ["data/open-problem/ticket135-conditional-bridges-and-exceptional-set.json", "data/open-problem/ticket134-uniformity-thresholds-and-scale-no-go.json", "docs/conditional-bridges-and-exceptional-set.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET135 proves four exact conditional bridge or no-go theorems, rejects four invalid promotions, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires actual projected Weil Schur constants, pointwise natural-code Collatz affine descent, an actual hard-stratum Goldbach K56 moment bound, and a non-congruence Type II Twin separator." },
      ],
    },
    latest_changes: [
