...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 134,
    claim_language_scanned_lines: 49818,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket180-finite-information-localization.json", "data/open-problem/ticket179-symbol-adaptive-discrete-centering.json", "docs/finite-information-localization.md", "docs/finite-information-localization.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET180 proves four exact localization no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an arithmetic RH high-frequency envelope, ordered Collatz cylinder transfer, every-target Goldbach L-infinity exception removal, and uniform dyadic centered-energy saturation for actual prime-pair blocks." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-180, exact localization boundaries, discarded routes, proof DAGs, and remaining proof gaps while preserving the full ledger in semantic archives.", metric: "4 current cards / 180 tickets" },
