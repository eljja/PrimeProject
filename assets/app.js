  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket170-interval-tail-besov-multiscale.json", "data/open-problem/ticket169-kkt-childlift-autocorrelation-primepower.json", "docs/interval-tail-besov-multiscale.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET170 proves four exact scale or resolution theorems, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires dimension-scaled interval-KKT error below a certified fixed-core gap, well-foundedness of the residual Collatz child tree after analytic tail closure, a uniform Goldbach autocorrelation Besov-one budget below the anchor margin, and multiscale Type-II decay with prime-producing constants." },
      ],
    },
    latest_changes: [
