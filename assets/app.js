  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket250-multiplier-lift-galois-evenright.json", "docs/multiplier-lift-galois-evenright.md", "docs/multiplier-lift-galois-evenright.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-250 proves two partial theorems and two exact route no-go results, records four acyclic proof DAGs with zero machine failures, checks 21 exact RH rows, 73,901 Collatz lift pairs, 35 Goldbach norm cases plus two boundary countermodels, and nine twin scales while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires an arithmetic Weil form controlling oscillation and concentration, canonical Fermat-quotient distribution beyond lift transitivity, quantitative prime-count Fourier anti-concentration, and a scale-local odd-left contamination bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-250: concentration escape, lift transitivity, Galois full support, and complete even-left classification, while preserving TICKET-249 and the full ledger.", metric: "4 current cards / 250 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-250 exact no-go: M_(x²) blocks Legendre escape but admits centered concentration escape. / M_(x²)는 Legendre 도주를 막지만 중심 집중 도주를 허용합니다.",
        artifact: "next: ArithmeticWeilFormCoercivityAgainstOscillationAndConcentrationEscapes",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-250 exact no-go: every local lift fiber contains q−1 representatives of projective slope [3:5]. / 모든 local lift fiber는 [3:5] 대표를 q−1개 포함합니다.",
        artifact: "next: CanonicalRepresentativeFermatQuotientDistributionBeyondLiftTransitivity",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-250 partial: nonconstant rational vectors at prime q≥5 have full reduced Fourier support and nonzero integer norm. / 소수 q≥5의 비상수 유리 vector는 full support와 nonzero integer norm을 갖습니다.",
        artifact: "next: QuantitativePrimeCountFourierEnergyAntiConcentrationAtPrimeModuli",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-250 partial: the complete even-left right-active contamination is exactly 25→27. / 전체 even-left right-active 오염은 정확히 25→27입니다.",
        artifact: "next: ScaleLocalOddLeftRightActiveContaminationBound",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
