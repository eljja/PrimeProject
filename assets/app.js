...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 290,
    claim_language_scanned_lines: 100126,
    claim_language_triggered_mentions: 133,
    claim_language_guarded_mentions: 133,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket263-sharp-envelope-diagonal-mod32-ninthorder.json", "docs/sharp-envelope-diagonal-mod32-ninthorder.md", "docs/sharp-envelope-diagonal-mod32-ninthorder.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-263 proves four partial theorems, records four acyclic proof DAGs, checks 192 RH boundary rows, 119 Collatz grid harmonics, three actual Goldbach prefixes plus 15 mod-32 nonsufficiency models, and 1,024 Twin convergents with 986 rows in the ninth-order exact tail domain while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires an actual-Weil reciprocal envelope below half the limit, a canonical growing-cutoff Weyl cancellation theorem, all-level avoidance of the phased mod-32 Goldbach tie residue, and exclusion of joint ninth-order congruences on every unique-root convergent." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-263: sharp reciprocal envelope, growing-cutoff Weyl equivalence, q=3 mod-32 phase obstruction, and ninth-order Twin tail exactness, while preserving TICKET-262 and the full ledger.", metric: "4 current cards / 263 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-263 partial theorem: limsup n|E_n-L|=A gives liminf packet lag at least L-2A, and factor two is sharp. / reciprocal envelope A는 lag 하한 L-2A를 주며 상수 2는 최적입니다.",
        artifact: "next: ActualWeilPacketReciprocalEnvelopeBelowHalfLimit",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-263 partial theorem: all fixed-h Weyl limits are equivalent to uniform cancellation on some data-dependent growing cutoff. / 모든 고정 조화파 극한은 어떤 데이터 의존 증가 cutoff의 균일 상쇄와 동치입니다.",
        artifact: "next: CanonicalFermatQuotientGrowingCutoffUniformWeylCancellation",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-263 partial theorem: a special q=3 tie forces N_2 mod 32 to cycle through 28,4,12,20; the first three actual residues are 31,25,15. / 특수 동률은 mod 32 네 위상을 강제하고 실제 첫 세 잔여는 31,25,15입니다.",
        artifact: "next: Q3SpecialMinusOneResidueCountAvoidsLevelPhasedModuloThirtyTwo",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-263 partial theorem: beyond an explicit root-cone threshold, joint congruences modulo v⁹ and u⁹ are equivalent to the unit equation; 986 certified convergents lie in that tail domain. / 명시적 root-cone 문턱 뒤에서는 mod v⁹,u⁹ 조건이 unit 방정식과 동치입니다.",
        artifact: "next: NoUniqueRootConvergentSatisfiesJointNinthOrderCongruences",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
