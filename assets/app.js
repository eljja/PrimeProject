...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 240,
    claim_language_scanned_lines: 82529,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket233-logarithmic-frame-density-shell-entropy.json", "docs/logarithmic-frame-density-shell-entropy.md", "docs/logarithmic-frame-density-shell-entropy.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-233 proves four exact partial, asymptotic, or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a signed Weil-kernel transfer with explicit tail dominance, uniform binary Collatz density-band nondivisibility beyond k=12, target-aligned Goldbach minor-arc control below the polylog major-arc margin, and actual-prime critical-noise CRT decay plus a positive Twin principal lower bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-233: sharp logarithmic scalar frames, the exact binary Collatz k=12 closure, polylogarithmic squarefree Goldbach shells, and CRT entropy/parity no-gos, while preserving TICKET-232 and the full ledger.", metric: "4 current cards / 233 tickets" },
