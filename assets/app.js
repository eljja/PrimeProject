...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 128,
    claim_language_scanned_lines: 47824,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket178-toeplitz-lowbit-split-zeromode.json", "data/open-problem/ticket177-comparison-wheel-sobolev-crossgram.json", "docs/toeplitz-lowbit-frequency-split-zeromode.md", "docs/toeplitz-lowbit-frequency-split-zeromode.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET178 proves four exact threshold/no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an RH summable whitened-tail profile, adaptive every-orbit Collatz low-bit occupancy plus cycle exclusion, uniform dyadic Goldbach sup-energy-derivative budgets, and signed prime-pair cross-Gram zero-mode power savings." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-178, exact thresholds, discarded routes, proof DAGs, and remaining proof gaps while preserving the full ledger in semantic archives.", metric: "4 current cards / 178 tickets" },
