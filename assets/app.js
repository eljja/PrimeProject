  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket185-spectral-cycle-factor-granularity.json", "data/open-problem/ticket184-information-sufficiency-route-correction.json", "docs/spectral-cycle-factor-granularity.md", "docs/spectral-cycle-factor-granularity.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET185 proves four exact boundaries or route corrections, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires actual Weil-form coercivity modulo spectral translations, broader Collatz affine-divisibility exclusions plus the divergent-orbit branch, sub-horizon signed Goldbach cancellation, and a parity-breaking one-sided Twin block margin on unbounded scales." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-185, exact spectral, cycle, factor-horizon, and integer-granularity boundaries, corrected targets, finite replay diagnostics, proof DAGs, and remaining arithmetic premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 185 tickets" },
