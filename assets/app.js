  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket208-vertical-threeone-unitlog-cyclotomic.json", "docs/vertical-threeone-unitlog-cyclotomic.md", "docs/vertical-threeone-unitlog-cyclotomic.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET208 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires certified completed-xi top-edge clearance on cofinal admissible heights, uniform exclusion of Collatz necklaces with exactly four valuation-one entries, a Goldbach tail exceptional count below one beyond the asymptotically unit-log floor, and a cofinal Twin nonzero-mode remainder strictly above minus interval length." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-208: explicit completed-xi vertical clearance, complete three-one Collatz exclusion, every-c-below-one Goldbach witness lower bounds, the growing cyclotomic Twin reconstruction and cancellation no-go, proof DAGs, and remaining infinite premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 208 tickets" },
