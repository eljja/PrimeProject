  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket214-cofinal-sevenone-exponential-cardinal.json", "docs/cofinal-sevenone-exponential-cardinal.md", "docs/cofinal-sevenone-exponential-cardinal.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-214 proves four exact intermediate or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires certified cofinal multiplicity equality for actual zeta, a uniform Collatz odd-divisor witness beyond seven ones, a uniform Goldbach exponential-selector subunit bound, and an unbounded arithmetic minorant for the cardinal-sine gap-two functional." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-214: the cofinal Riemann equality criterion, complete seven-one Collatz exclusion, exact exponential Goldbach selector, and exact cardinal-sine gap-two selector, while preserving TICKET-213 and the full ledger.", metric: "4 current cards / 214 tickets" },
