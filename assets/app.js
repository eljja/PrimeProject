...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 232,
    claim_language_scanned_lines: 80070,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket231-summable-frame-critical-strip-gauss-crt.json", "docs/summable-frame-critical-strip-gauss-crt.md", "docs/summable-frame-critical-strip-gauss-crt.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-231 proves four exact structural or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a height-adaptive renormalized Weil frame with explicit tail dominance, Collatz critical-strip necklace nondivisibility plus aperiodic descent, a negative aggregate binary-prime minor-arc bound, and prime-weighted growing-CRT Twin energy saving plus a positive principal lower bound." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-231: summable-frame no-go, the Collatz critical strip, a true Gauss zero-convolution counterfamily, and centered CRT orthogonality, while preserving TICKET-230 and the full ledger.", metric: "4 current cards / 231 tickets" },
