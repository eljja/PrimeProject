...
const bundledCollectionFixtureAudit = {
  ...
  summary: {
    ...
    actual_blocked_count: 4,
    public_safe_fixture_count: 7,
  },
  quality_gate: {
    status: "pass",
  ...
  rows: [
    ...
    { fixture_id: "blocked_reused_checksum_a", library: "BoringSSL", object_type: "rsa-prime", bit_length: 4096, expected_status: "blocked", actual_status: "blocked", expected_reasons: ["aggregate_artifact_sha256_reused"], actual_reasons: ["aggregate_artifact_sha256_reused"], expectation_met: true, public_safe: true },
    { fixture_id: "blocked_reused_checksum_b", library: "Go crypto/rsa", object_type: "rsa-prime", bit_length: 2048, expected_status: "blocked", actual_status: "blocked", expected_reasons: ["aggregate_artifact_sha256_reused"], actual_reasons: ["aggregate_artifact_sha256_reused"], expectation_met: true, public_safe: true },
  ],
};
...
const bundledEvidencePack = {
  ...
  publication_gates: [
    ...
    { code: "collection_submission_lint_gate", passed: true, severity: "medium" },
    {
      ...
      passed: true,
      severity: "medium",
      evidence: { quality_gate_status: "pass", fixture_count: 7, failed_expectation_count: 0, public_safe_fixture_count: 7 },
    },
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 14, scanned_line_count: 6646, claim_language_triggered_count: 88, claim_language_guarded_count: 88, claim_language_fail_count: 0 },
    ...
    { role: "collection_fixture_audit", schema: "primeproject.collection-fixture-audit.v1", sha256: "39cd0c8ce57e5047326ef825c99848de31f0a12f34dfae5c8af9aef6fc9cb33e", quality_gate_status: "pass", fixture_count: 7, failed_expectation_count: 0, public_safe_fixture_count: 7 },
...
const bundledArtifactLineage = {
  ...
  nodes: [
    ...
    { role: "collection_fixture_audit", schema: "primeproject.collection-fixture-audit.v1", exists: true, sha256: "39cd0c8ce57e5047326ef825c99848de31f0a12f34dfae5c8af9aef6fc9cb33e" },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    submission_fixture_cases: 7,
    submission_fixture_expectation_failures: 0,
    submission_fixture_public_safe: 7,
    intake_tasks: 10,
    intake_submitted: 0,
    intake_accepted: 0,
    intake_blocked: 10,
    ...
    claim_language_scanned_lines: 6646,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_flow: [
        ...
        { stage: "Intake contract", score: 0, status: "blocked", evidence: "10 task templates; 7 lint fixtures pass expectations; 0 submitted artifacts" },
      ...
      evidence_spine: [
        ...
        { layer: "Sim-to-Real", score: 35, status: "blocked", artifacts: ["data/collection_handoff.json", "data/collection_submission_contract.json", "data/collection_fixture_audit.json", "data/collection_intake.json"], gate: "10 targets, 7 public-safe fixtures, 0 accepted real submissions", proof: "OpenSSL/BoringSSL/Go/Bitcoin collection is specified and lint-tested, but real aggregate baselines are not accepted yet." },
    ...
    latest_changes: [
      ...
      { label: "Submission discipline", impact: "Collection contract, lint fixtures, and intake validation define exactly what public-safe evidence must contain.", metric: "10 templates / 7 fixtures" },
    ...
    research_delta: {
      ...
      tracks: [
        ...
        { track: "Reality", before: "No real-world generator baseline gate", current: "5 registered baseline families, 10 collection targets, 10 handoff tasks, 10 submission templates, pre-intake lint, 7 fixture cases, 10 intake blockers, 0 accepted baselines", state: "blocked" },
