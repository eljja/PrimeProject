...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 92, scanned_line_count: 31732, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 122,
    claim_language_scanned_lines: 45981,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket174-tail-lift-adaptive-scalepair.json", "data/open-problem/ticket173-finite-section-cylinder-phase-tensor.json", "docs/tail-lift-adaptive-scalepair.md", "docs/tail-lift-adaptive-scalepair.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET174 proves four exact quantitative bridge/no-go results, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires a vanishing arithmetic Weil-core defect on a quadratic cutoff, exclusion of an eventually unique-zero-lift non-descending Collatz ray, a fixed Farey-major positive lower bound above the signed complement, and uniform power saving for every tensor-Haar scale pair." },
      ],
    },
    latest_changes: [
