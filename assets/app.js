  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket245-closure-second-order-klein-linnik.json", "docs/closure-second-order-klein-linnik.md", "docs/closure-second-order-klein-linnik.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-245 proves two partial theorems and two exact route no-gos, records four acyclic proof DAGs with zero machine failures, scans 1,270,604 Collatz first-layer primes, replays 5,130 second-order rows, closes 7,524 rational Goldbach centers into 1,882 orbits, and keeps all resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires zero-free separation of the genuine Weil closure, all-prime rational Wieferich-depth domination, one representative Goldbach arc asymptotic plus signed residual saving, and scale-local nonperiodic Type-II cancellation beyond periodic-height barriers." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-245: closure margins, second Fermat digits, Klein arc orbits, and Linnik-height mimicry, while preserving TICKET-244 and the full ledger.", metric: "4 current cards / 245 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-245 exact no-go: joint tightness and pointwise positivity do not yield a uniform margin unless the compact closure avoids the zero set. / joint tightness와 점별 양성만으로는 부족하며 compact closure의 zero-set 분리가 필요합니다.",
        artifact: "next: ZeroFreeClosureSeparationForNormalizedAdmissibleWeilFunctional",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-245 partial: exact second Fermat digits decide the q-cubed depths of the fixed rational bases; all-prime and all-depth domination remains open. / 고정 유리 밑의 q³ 깊이를 2차 Fermat digit으로 판정했지만 전소수·전깊이 지배는 열려 있습니다.",
        artifact: "next: FixedBaseAllPrimeRationalWieferichDepthDomination",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-245 partial: half-turn and reflection organize every rational Goldbach center into one quarter-torus representative orbit. / half-turn과 reflection으로 모든 유리 Goldbach 중심을 quarter-torus 대표 orbit 하나로 줄였습니다.",
        artifact: "next: UniformRepresentativeArcAsymptoticAndSignedResidualSavingOnQuarterTorus",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-245 exact no-go: every globally reused M-periodic fingerprint has a prime/composite-successor mimic below C M^(3L). / 전역에서 재사용하는 모든 M-주기 fingerprint는 C M^(3L) 이하에 prime/composite-successor 모방자를 갖습니다.",
        artifact: "next: ScaleLocalNonperiodicTypeIICancellationBeyondPeriodicHeightBarriers",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
