  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 49, status: "open", artifacts: ["data/open-problem/ticket46-stable-clause-grammar-lab.json", "data/open-problem/ticket47-periodic-state-lasso-lab.json", "data/open-problem/ticket48-automaton-reachability-lab.json", "data/open-problem/ticket49-symbolic-preimage-obstruction-lab.json", "docs/proof-or-counterexample-program.md"], gate: "Finite quotient repairs are blocked and the first concrete lasso-prefix failure is localized to next_valuation; no full proof claim", proof: "The proof workbench now requires an all-phase next-valuation preimage theorem, a higher-bit exception, or an ordinal infinite bridge." },
      ],
    },
    latest_changes: [
