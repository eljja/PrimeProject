...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 15, scanned_line_count: 6803, claim_language_triggered_count: 88, claim_language_guarded_count: 88, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_lines: 6803,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      release_trail: [
        ...
        { marker: "05", title: "Publication guardrails", state: "guarded", measure: "22 checked artifacts / 15 gates / 11 guard checks", proof: "claim-language audit, claim ledger, lineage, decision protocol, falsification battery, and consistency audit prevent overclaiming" },
      ],
      evidence_flow: [
    ...
    latest_changes: [
      ...
      { label: "Publication guardrail", impact: "Claim-language audit, claim ledger, lineage, decision rules, falsification checks, and consistency checks keep the public page at demo/scaffold claim strength.", metric: "22 artifacts / 11 guard checks" },
    ],
    research_delta: {
