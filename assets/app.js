...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 88, scanned_line_count: 29219, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 88,
      claim_language_scanned_lines: 29219,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 94, status: "open", artifacts: ["data/open-problem/ticket144-schur-rank-equivalence-variation-adverse-walsh.json", "data/open-problem/ticket143-form-core-period-floor-martingale-walsh.json", "docs/schur-rank-equivalence-variation-adverse-walsh.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET144 proves four exact reduction or no-go theorems, records four updated proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an explicit Weil form-core Schur-pivot lower bound, an independently defined lift-closed finite Collatz rank, arithmetic signed Goldbach martingale cancellation below K56, and uniform cubic-rough adverse-Walsh-part contraction." },
      ],
    },
    latest_changes: [
