  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket172-structure-equivalence-l1-variation.json", "data/open-problem/ticket171-relative-ghost-phase-haar.json", "docs/structure-equivalence-l1-variation.md", "docs/structure-equivalence-l1-variation.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET172 proves four exact structural results, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires cofinal Weil primal positivity and constraint-rank margins, a least-counterexample cross-scale cylinder height bound, prime-specific signed Goldbach Fourier cancellation below the main term, and a prime-pair weighted dyadic mixed-variation power saving." },
      ],
    },
    latest_changes: [
