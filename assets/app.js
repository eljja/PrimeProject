  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket262-limsup-finiteharmonic-mod8-thirdorder.json", "docs/limsup-finiteharmonic-mod8-thirdorder.md", "docs/limsup-finiteharmonic-mod8-thirdorder.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-262 proves one exact no-go and three partial theorems, records four acyclic proof DAGs, checks 76 RH boundary rows, 1,152 Collatz phase cases, three actual Goldbach prefixes plus 16 sharpness models, and 1,024 Twin convergents under dual third-order congruences while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires an actual-Weil strict scaled-jump limsup bound, every nonzero canonical Fermat-quotient Weyl sum to vanish, special mod-3 minus-one counts never four modulo eight, and exclusion of both third-order Twin congruences on every root convergent." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-262: exact limsup threshold, every finite harmonic cutoff, q=3 mod-8 tie obstruction, and third-order Twin congruences, while preserving TICKET-261 and the full ledger.", metric: "4 current cards / 262 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-262 partial theorem: a positive lag margin is equivalent to the scaled signed-jump limsup being strictly below L; the actual Weil bound remains open. / 양의 lag margin은 scaled signed-jump limsup의 strict 문턱과 동치이며 실제 Weil 경계는 열려 있습니다.",
        artifact: "next: ActualWeilPacketScaledDownwardJumpLimsupBelowLimit",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-262 exact no-go: every fixed finite harmonic cutoff can vanish while angular discrepancy stays positive; all nonzero canonical Weyl harmonics remain open. / 모든 고정 유한 조화파 상쇄와 양의 discrepancy가 공존할 수 있으며 canonical 모든 비영 조화파가 남습니다.",
        artifact: "next: CanonicalFermatQuotientWeylSumsVanishForEveryNonzeroH",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-262 partial theorem: a special q=3 race tie forces N_2=4 mod 8, while three actual prefixes have residues 7, 1, and 7. / 특수 q=3 tie는 N_2=4 mod 8을 강제하고 실제 세 prefix는 7,1,7입니다.",
        artifact: "next: Q3SpecialMinusOneResidueCountNeverFourModuloEight",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-262 partial theorem: unit coefficients force congruences modulo v³ and u³, and the first 1,024 convergents fail them jointly. / unit coefficient는 mod v³와 mod u³ 조건을 강제하며 처음 1,024개 수렴분수는 둘을 함께 통과하지 못합니다.",
        artifact: "next: NoUniqueRootConvergentSatisfiesBothThirdOrderCongruences",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
