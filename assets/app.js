  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket171-relative-ghost-phase-haar.json", "data/open-problem/ticket170-interval-tail-besov-multiscale.json", "docs/relative-ghost-phase-haar.md", "docs/relative-ghost-phase-haar.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET171 proves four exact target corrections, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires a cofinal relative interval-KKT radius below one on a fixed dense Weil core, exclusion of infinite non-descending residual rays compatible with one positive natural Collatz start, a signed arithmetic Goldbach autocorrelation certificate below the anchor margin, and growing-resolution Haar Type-II decay with prime-producing constants." },
      ],
    },
    latest_changes: [
