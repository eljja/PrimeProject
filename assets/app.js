...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 248,
    claim_language_scanned_lines: 85058,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket237-angle-palette-endpoint-welch.json", "docs/angle-palette-endpoint-welch.md", "docs/angle-palette-endpoint-welch.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-237 proves four exact partial or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an arithmetic Weil innovation-angle gap, word-dependent Collatz valuation-gap primes, buffered dyadic Goldbach cross-phase gain, and prime-weighted degree-two CRT decay with growing support and uniform diagonal control before the separate parity and principal-mass gaps." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-237: principal angles, finite-palette no-go, dyadic endpoints, and Welch floors, while preserving TICKET-236 and the full ledger.", metric: "4 current cards / 237 tickets" },
