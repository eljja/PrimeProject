...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 200,
    claim_language_scanned_lines: 70116,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket213-multiplicity-sixone-polynomial-selector.json", "docs/multiplicity-sixone-polynomial-selector.md", "docs/multiplicity-sixone-polynomial-selector.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET213 proves four exact intermediate or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an all-height multiplicity-aware critical-line count, a uniform Collatz odd-divisor witness beyond six ones, a scale-growing Goldbach witness resummation below one, and a signed gap-two arithmetic selector with a uniform remainder." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-213: the multiplicity-aware Riemann target correction, complete six-one Collatz exclusion, fixed-polynomial Goldbach no-go, and exact characterization of nonnegative gap-two selectors, while preserving TICKET-212 and the full ledger.", metric: "4 current cards / 213 tickets" },
