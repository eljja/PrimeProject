...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 70,
      claim_language_scanned_lines: 21552,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      release_trail: [
        ...
        { marker: "86", title: "Route correction closes one premise and sharpens three proof frontiers", state: "bounded", measure: "3 exact intermediate theorems / Collatz 28-bit unresolved mass 3.0004% / Goldbach B=2.094918 / Twin 32M residual 0.145873 / 0 conjecture resolutions", proof: "TICKET-126 discards the RH full-space density shortcut, characterizes natural Collatz counterexample paths exactly, proves the Goldbach proper-prime-power bound, and records one preregistered Twin finite holdout without promoting it to a tail theorem" },
      ],
      evidence_flow: [
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 75, status: "open", artifacts: ["data/open-problem/ticket126-route-correction-audit.json", "data/open-problem/ticket126-twin-32m-first-valid-result.json", "docs/route-correction-and-premise-closure.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET126 proves three intermediate results and one preregistered finite holdout while keeping all four conjecture-resolution counters at zero.", proof: "The workbench now discards an invalid RH density route, separates natural Collatz paths from generic 2-adic paths, closes Goldbach constant B, and requires a uniform Twin tail theorem beyond the 32M holdout." },
      ],
    },
    latest_changes: [
