  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket234-operator-kernel-density-minor-cesaro.json", "docs/operator-kernel-density-minor-cesaro.md", "docs/operator-kernel-density-minor-cesaro.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-234 proves four exact partial, equivalence, or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires arithmetic Weil-tail compatibility on a logarithmic-frame kernel, a word-adaptive Collatz radical deficit, inverse-log reflected Goldbach minor coherence, and actual-prime fixed-degree Cesaro CRT decay before the separate parity and principal-mass gaps." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-234: scalar Gram kernels, infinite binary affine-sieve false positives, Goldbach half-channel cancellation, and Poisson fixed-degree CRT criteria, while preserving TICKET-233 and the full ledger.", metric: "4 current cards / 234 tickets" },
