...
const bundledCollectionFixtureAudit = {
  ...
  rows: [
    ...
    { fixture_id: "blocked_reused_checksum_a", library: "BoringSSL", object_type: "rsa-prime", bit_length: 3072, expected_status: "blocked", actual_status: "blocked", expected_reasons: ["aggregate_artifact_sha256_reused"], actual_reasons: ["aggregate_artifact_sha256_reused"], expectation_met: true, public_safe: true },
    { fixture_id: "blocked_reused_checksum_b", library: "BoringSSL", object_type: "rsa-prime", bit_length: 4096, expected_status: "blocked", actual_status: "blocked", expected_reasons: ["aggregate_artifact_sha256_reused"], actual_reasons: ["aggregate_artifact_sha256_reused"], expectation_met: true, public_safe: true },
  ],
};
...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "project_evolution", schema: "primeproject.project-evolution.v1", sha256: "0bb6ab3cb2dbd1a65f6157d0b0bf52e7e34bd9cd29121b3a7d034425eb293459" },
...
const bundledArtifactLineage = {
  ...
  nodes: [
    ...
    { role: "evidence_pack", schema: "primeproject.evidence-pack.v1", exists: true, sha256: "913ad62ba3967f4c2d5c24466168425f773f4290f5f7c94a6b4287a6e3a99d9c" },
    ...
    { role: "project_evolution", schema: "primeproject.project-evolution.v1", exists: true, sha256: "0bb6ab3cb2dbd1a65f6157d0b0bf52e7e34bd9cd29121b3a7d034425eb293459" },
  ],
  edges: [
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    submission_fixture_cases: 6,
    submission_fixture_expectation_failures: 0,
    submission_fixture_public_safe: 6,
    intake_tasks: 10,
    intake_submitted: 0,
    intake_accepted: 0,
    intake_blocked: 10,
  ...
  change_dashboard: {
    ...
    maturity_ladder: [
      ...
      { stage: "Publish", phase_ids: ["readiness-gates", "evidence-pack", "claim-ledger", "artifact-lineage", "decision-protocol", "falsification-battery", "publication-consistency"], status: "active", signal: "5 falsification checks, 6 consistency checks, and controlled-synthetic-only claim floor" },
    ],
    visual_rollup: {
      ...
      release_trail: [
        ...
        { marker: "05", title: "Publication guardrails", state: "guarded", measure: "20 checked artifacts / 14 gates / 11 guard checks", proof: "claim ledger, lineage, decision protocol, falsification battery, and consistency audit prevent overclaiming" },
      ],
      evidence_flow: [
      ...
      evidence_spine: [
        ...
        { layer: "Publication", score: 80, status: "guarded", artifacts: ["data/evidence_pack.json", "data/claim_ledger.json", "data/artifact_lineage.json", "data/decision_protocol.json", "data/falsification_battery.json", "data/publication_consistency.json"], gate: "20 checked artifacts, 14 gates, 22 lineage nodes, 11 guard checks", proof: "Public statements are constrained by checksums, lineage, decision rules, falsification guards, and consistency checks." },
      ],
    },
    latest_changes: [
      ...
      { label: "Publication guardrail", impact: "Claim ledger, lineage, decision rules, falsification checks, and consistency checks keep the public page at demo/scaffold claim strength.", metric: "20 artifacts / 11 guard checks" },
    ],
    research_delta: {
