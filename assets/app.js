...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 262,
    claim_language_scanned_lines: 89924,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket252-sparse-marginal-zeroresidue-local.json", "docs/sparse-marginal-zeroresidue-local.md", "docs/sparse-marginal-zeroresidue-local.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-252 proves three exact route no-go results and one partial theorem, records four acyclic proof DAGs with zero machine failures, checks 12 RH bounds, 11 Collatz joint-law rows, 68 Goldbach coefficient rows, and eight twin moduli while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires an actual Weil wave-packet density bound, joint Fermat-quotient character cancellation, actual-prime exclusion of the compatible cyclotomic tail, and a quadratic-unit coefficient-one exclusion of odd prime exponents." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-252: sparse projection escape, marginal blindness, zero-residue compatibility, and finite-congruence local solubility, while preserving TICKET-251 and the full ledger.", metric: "4 current cards / 252 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-252 exact no-go: a positive self-adjoint noncompact sparse projection still admits concentration escape. / sparse projection도 내부 집중 도주를 허용합니다.",
        artifact: "next: ActualWeilKernelHasPositiveDensityAgainstEveryInteriorWavePacket",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-252 exact no-go: exact uniform marginals do not determine joint [3:5] slope mass. / uniform marginal만으로 joint slope를 결정할 수 없습니다.",
        artifact: "next: JointFermatQuotientCharacterCancellationAtSlopeThreeFifths",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-252 partial theorem: zero-residue compatibility is c0-min(c)<=1; all low degrees fail but a tail countermodel survives. / 저차는 배제되지만 tail 반례가 남습니다.",
        artifact: "next: ActualPrimeOrderingExcludesZeroResidueCompatibleCyclotomicTail",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-252 exact no-go: every fixed finite congruence system has prime residue solutions. / 모든 고정 유한 합동계는 prime residue 국소해를 가집니다.",
        artifact: "next: QuadraticUnitCoefficientOneExcludesOddPrimeExponents",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
