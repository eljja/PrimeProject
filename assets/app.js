  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket176-relative-cone-harmonic-alias-schur.json", "data/open-problem/ticket175-relative-equivalence-signed-block.json", "docs/relative-cone-harmonic-alias-schur.md", "docs/relative-cone-harmonic-alias-schur.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET176 proves four exact reduction/no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a full pole-neutral Weil relative tail theorem, aperiodic Collatz valuation-envelope crossing plus cycle exclusion, parity-aliased Goldbach minor deficit saving, and explicit arithmetic Twin Schur weights with directional Type-II power savings." },
      ],
    },
    latest_changes: [
