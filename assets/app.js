...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_lines: 12475,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 67, status: "open", artifacts: ["data/open-problem/ticket46-stable-clause-grammar-lab.json", "data/open-problem/ticket47-periodic-state-lasso-lab.json", "data/open-problem/ticket48-automaton-reachability-lab.json", "data/open-problem/ticket49-symbolic-preimage-obstruction-lab.json", "data/open-problem/ticket50-phase-lift-exception-lab.json", "data/open-problem/ticket51-phase15-terminal-lift-lab.json", "data/open-problem/ticket52-frontier-budget-lab.json", "data/open-problem/ticket53-symbolic-terminal-theorem-lab.json", "data/open-problem/ticket54-new-template-family-lab.json", "data/open-problem/ticket55-phase5-valuation-gate-lab.json", "data/open-problem/ticket56-pre-gate-projection-escape-lab.json", "data/open-problem/ticket57-parametric-template-automaton-lab.json", "data/open-problem/ticket58-affine-boundary-lift-lab.json", "data/open-problem/ticket59-symbolic-lift-mismatch-lab.json", "data/open-problem/ticket60-mixed-cylinder-separator-lab.json", "data/open-problem/ticket61-symbolic-failure-offset-lab.json", "data/open-problem/ticket62-mod16-transition-cover-lab.json", "data/open-problem/ticket63-mod16-automaton-cover-lab.json", "data/open-problem/ticket64-symbolic-mod16-transition-lab.json", "data/open-problem/ticket65-start-template-chain-extinction-lab.json", "data/open-problem/ticket66-complement-cover-lab.json", "docs/proof-or-counterexample-program.md"], gate: "TICKET66 refutes the already-covered complement shortcut: 17,134 open needs_split instances remain across 491 template families.", proof: "The proof workbench now targets OpenTemplateFamilyRankOrComplementCounterexample." },
      ],
    },
    latest_changes: [
