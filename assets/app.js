  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket206-adaptive-singleone-crt-projector.json", "docs/adaptive-singleone-crt-projector.md", "docs/adaptive-singleone-crt-projector.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET206 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires effective completed-zeta cofinal bounds, uniform nondivisibility for Collatz necklaces with at least two valuation-one entries, a growing-cutoff Goldbach tail exceptional count below one, and uniform tail cancellation for the Omega-binomial Twin correlation." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-206: adaptive RH certificate termination, complete single-one Collatz exclusion, unbounded Goldbach witnesses by CRT, the exact Omega-binomial projector and every finite-truncation no-go, proof DAGs, and remaining infinite premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 206 tickets" },
