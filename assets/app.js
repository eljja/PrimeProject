...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 288,
    claim_language_scanned_lines: 99767,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket257-spike-cyclotomic-character-root.json", "docs/spike-cyclotomic-character-root.md", "docs/spike-cyclotomic-character-root.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-257 proves two exact no-gos and two partial theorems, records four acyclic proof DAGs with zero machine failures, checks 8 RH spike rows, 22 Collatz phase rows, 3 Goldbach prefixes through T=7,759,741, and 400,399 Twin root-neighbor candidates while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires actual-Weil packet margin versus scaled variation, sublinear canonical Fermat-quotient phase sums, nonzero odd character moments for every compatible Goldbach prefix, and all-denominator exclusion on the Twin root-neighbor sequence." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-257: sparse packet spikes, cyclotomic noncancellation, the q=11 character certificate, and the exponent-17 root-neighbor reduction, while preserving TICKET-256 and the full ledger.", metric: "4 current cards / 257 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-257 exact no-go: positive convergent packet energy need not bound lag partial sums below. / 양이고 수렴하는 packet energy만으로 lag 부분합 하한을 얻을 수 없습니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-257 exact no-go: finite distinct-prime cyclotomic phase sums never vanish exactly. / 서로 다른 소수 원분 위상의 유한합은 정확히 0이 아닙니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-257 partial theorem: odd characters characterize reflection and the q=11,m=22 prefix is excluded. / 홀수 지표가 반사를 특징짓고 q=11,m=22 prefix가 배제됩니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-257 partial theorem: every exponent-17 coefficient-one solution lies on one root-neighbor sequence. / 모든 지수 17 coefficient-one 해는 하나의 근 이웃 열에 놓입니다.",
        artifact: "next: EveryNonzeroDenominatorUniqueRootNeighborMissesCoefficientOne",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
