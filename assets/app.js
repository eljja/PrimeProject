  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket261-sharpness-weyl-ties-dualcongruence.json", "docs/sharpness-weyl-ties-dualcongruence.md", "docs/sharpness-weyl-ties-dualcongruence.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-261 proves two exact no-gos and two partial theorems, records four acyclic proof DAGs, checks 128 RH rows, 128 Collatz countermodel rows plus 16,384 canonical angles, three Goldbach prefixes, and 1,024 Twin convergents under dual second-order congruences while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires an actual-Weil scaled-jump limsup bound, every nonzero canonical Fermat-quotient Weyl sum to vanish, special mod-3 prime-prefix product minus one at every level, and exclusion of both second-order Twin congruences on every root convergent." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-261: sharpness, Weyl harmonics, q=3 prefix-product parity, and bidirectional Twin congruences, while preserving TICKET-260 and the full ledger.", metric: "4 current cards / 261 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-261 exact no-go: scaled downward variation summability is sufficient but not necessary for positive lag; the actual Weil scaled-jump bound remains open. / 가중 하강변동 합 가능성은 충분하지만 필요하지 않으며 실제 Weil scaled-jump 경계는 열려 있습니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-261 exact no-go: first-harmonic cancellation can coexist with angular discrepancy liminf at least 1/6; every nonzero canonical Weyl harmonic remains open. / 첫 조화파 상쇄와 양의 discrepancy liminf가 공존할 수 있으며 canonical 모든 비영 조화파가 남습니다.",
      ...
      },
      {
        ...
        status: "open_not_proven / 미해결",
        route: "TICKET-261 partial theorem: a special q=3 race tie forces prime-prefix product +1, while three actual prefixes have product -1. / 특수 q=3 tie는 prefix product +1을 강제하고 실제 세 prefix는 -1입니다.",
        artifact: "next: Q3SpecialPrimePrefixProductIsMinusOneModuloThree",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-261 partial theorem: unit coefficients force congruences modulo v² and u², and the first 1,024 convergents fail them jointly. / unit coefficient는 mod v²와 mod u² 조건을 강제하며 처음 1,024개 수렴분수는 둘을 함께 통과하지 못합니다.",
        artifact: "next: NoUniqueRootConvergentSatisfiesBothSecondOrderCongruences",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
