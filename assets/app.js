  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket244-joint-tightness-harmonic-parity-fold-polylog-mimicry.json", "docs/joint-tightness-harmonic-parity-fold-polylog-mimicry.md", "docs/joint-tightness-harmonic-parity-fold-polylog-mimicry.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-244 proves three partial theorems and one exact route no-go, records four acyclic proof DAGs with zero machine failures, replays 2,259 harmonic prime rows and 8,290 even Goldbach targets, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a uniform signed Weil tail on exhaustive jointly tight admissible classes, all-prime fixed-base harmonic bad-line nonvanishing, denominator-at-least-three major arcs plus signed residual saving, and superpolylogarithmic scale-local parity-sensitive Type II cancellation for shift two." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-244: joint tightness, harmonic bad lines, parity folding, and polylog-period mimicry, while preserving TICKET-243 and the full ledger.", metric: "4 current cards / 244 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-244 partial: joint physical-frequency tails exactly characterize relative compactness in bounded L2 families; either one alone fails. / bounded L2 family에서는 물리·주파수 tail의 결합이 정확한 compactness gate이며 한쪽만으로는 실패합니다.",
        artifact: "next: UniformSignedGuinandWeilTailWithPositiveMarginOnExhaustiveJointlyTightAdmissibleClasses",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-244 partial: the fixed-base first Wieferich bad line is exactly 4H_floor(q/3)=5H_half mod q, with higher depth explicitly open. / 고정기저 첫 Wieferich bad line을 harmonic prefix 합동으로 정확히 옮겼고 고차 depth는 열어 두었습니다.",
        artifact: "next: FixedBaseHarmonicBadLineNonvanishingForEveryPrime",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-244 partial: the odd-prime even-target integrand is exactly half-periodic, folding the zero and half-frequency arcs. / odd-prime even-target integrand는 정확히 반주기이므로 0과 1/2 arc가 folding됩니다.",
        artifact: "next: CompleteDenominatorAtLeastThreeMajorArcExtractionAndSignedResidualSavingAfterParityFolding",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-244 exact no-go: every pure periodic fingerprint with M(X)≤(log X)^A has prime/composite-successor mimics in all sufficiently large dyadic blocks. / 고정 log 거듭제곱 이하의 모든 pure periodic fingerprint는 충분히 큰 모든 dyadic block에서 모방됩니다.",
        artifact: "next: SuperPolylogarithmicScaleLocalTypeIICancellationForShiftTwoLambdaWithPositivePrimeMass",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
