  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 85, status: "open", artifacts: ["data/open-problem/ticket134-uniformity-thresholds-and-scale-no-go.json", "data/open-problem/ticket133-quantifier-promotion-exact-reductions.json", "docs/uniformity-thresholds-and-scale-no-go.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET134 proves four exact interval or scale-threshold theorems, excludes four insufficient proof classes, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires a uniform projected Weil Gram tail, an unbounded well-founded Collatz cover, logarithmic-order or maximal Goldbach residual control, and near-full-scale parity-sensitive Twin information." },
      ],
    },
    latest_changes: [
