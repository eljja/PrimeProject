...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 230,
    claim_language_scanned_lines: 79451,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket228-near-alias-affine-language-residue-spectrum.json", "docs/near-alias-affine-language-residue-spectrum.md", "docs/near-alias-affine-language-residue-spectrum.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-228 proves four exact partial or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a bandlimited Weil-core frame bound with explicit Diophantine loss, a cofinal Collatz affine-cone cover plus aperiodic descent, moving-target Goldbach character cancellation, and shift-two Twin character cancellation across all cube-root cells." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-228: finite-dilation stability no-go, a branching Collatz language, and exact Goldbach/Twin residue spectra, while preserving TICKET-227 and the full ledger.", metric: "4 current cards / 228 tickets" },
