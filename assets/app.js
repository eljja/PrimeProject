...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 258,
    claim_language_scanned_lines: 88250,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket242-quantifier-order-parseval-diagonal-crt.json", "docs/quantifier-order-parseval-diagonal-crt.md", "docs/quantifier-order-parseval-diagonal-crt.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-242 proves four exact boundary theorems, records four proof DAGs with zero machine failures, replays one bounded order-core scan through 200,000, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a uniform signed Guinand-Weil tail, an all-order square-divisor transfer, targetwise signed binary minor-arc cancellation, and scale-local parity-sensitive Type II cancellation for shift two." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-242: moving-test quantifiers, unbounded order cores, Parseval scale loss, and growing-period diagonal CRT mimicry, while preserving TICKET-241 and the full ledger.", metric: "4 current cards / 242 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-242 exact: pointwise finite-section convergence misses moving negative tests; compact uniform convergence with a positive margin transfers positivity. / 점별 유한절단 수렴은 움직이는 음의 test를 놓치며 compact 균일 수렴이 필요합니다.",
        artifact: "next: UniformSignedGuinandWeilTailBoundOnFrequencyTightNormalizedAdmissibleTestClasses",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-242 exact: the bad Fermat line reduces to a rational-Wieferich order core, and the relevant multiplicative orders are unbounded. / 나쁜 Fermat 직선은 rational-Wieferich order core로 환원되며 관련 order는 무계입니다.",
        artifact: "next: UniformOrderCoreSquareDivisorTransferFrom32Over27To2Over3",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-242 exact: global Parseval L2 energy is too large for a natural-scale binary minor-arc certificate without targetwise signed cancellation. / 전역 Parseval L2 에너지만으로는 자연 척도의 이항 minor-arc 인증을 닫지 못합니다.",
        artifact: "next: FixedBinaryPrimeMinorArcCoefficientIsLittleOOfTargetMainUniformlyOnBufferedEvenTargets",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-242 exact: arbitrary growing periodic features admit stagewise prime/composite-successor diagonal CRT mimics; growth alone is insufficient. / 임의의 증가 주기 특징에도 단계별 소수·합성 후속항 diagonal CRT 모방자가 존재합니다.",
