...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 72,
      claim_language_scanned_lines: 22236,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 75, status: "open", artifacts: ["data/open-problem/ticket128-finite-core-prefix-constant-interpolation.json", "data/open-problem/ticket127-exception-repair-effective-bridges.json", "docs/finite-core-prefix-constant-interpolation.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET128 proves four exact intermediate results while keeping all four conjecture-resolution counters at zero.", proof: "The workbench now has a finite RH prime side for compact support, direct Collatz prefix closure below 2^28, a stronger Goldbach endpoint coefficient making K=55 sufficient, and an exact Twin endpoint-only countermodel plus interpolation contract." },
      ],
    },
    latest_changes: [
