  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket177-comparison-wheel-sobolev-crossgram.json", "data/open-problem/ticket176-relative-cone-harmonic-alias-schur.json", "docs/comparison-wheel-sobolev-crossgram.md", "docs/comparison-wheel-sobolev-crossgram.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET177 proves four exact refinement/no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an RH whitened-tail comparison majorant, Collatz six-wheel valuation crossing plus cycle exclusion, multiscale aliased Goldbach energy and derivative savings, and signed cross-Gram power savings for prime-pair Haar blocks." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-177, exact partial results, discarded routes, proof DAGs, and remaining proof gaps while preserving the full ledger in semantic archives.", metric: "4 current cards / 177 tickets" },
