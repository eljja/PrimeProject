  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 80, status: "open", artifacts: ["data/open-problem/ticket131-proof-viability-target-correction.json", "data/open-problem/ticket130-computability-cap-language-optimality.json", "docs/proof-viability-and-target-correction.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET131 proves five exact intermediate or route-correction results, corrects two overextended targets, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now blocks finite-dimensional positivity as an RH proof proxy, gives Collatz an exact natural-residue stabilization criterion while restoring the all-time adaptive envelope, stratifies Goldbach residual budgets by arithmetic type, and identifies the Twin relative threshold as a reparameterization requiring actual Vaughan transport and parity." },
      ],
    },
    latest_changes: [
