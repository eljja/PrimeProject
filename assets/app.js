...
const bundledEvidencePack = {
  ...
  publication_gates: [
    ...
    { code: "reproducibility_gate", passed: true, severity: "medium" },
    {
      ...
      passed: true,
      severity: "high",
      evidence: { quality_gate_status: "pass", fail_count: 0, scanned_file_count: 87 },
    },
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 87, scanned_line_count: 28674, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 87,
      claim_language_scanned_lines: 28674,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 93, status: "open", artifacts: ["data/open-problem/ticket143-form-core-period-floor-martingale-walsh.json", "data/open-problem/ticket142-effective-rank-cycle-direction-haar-liouville.json", "docs/form-core-period-floor-martingale-walsh.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET143 proves four exact route-correction theorems, records four corrected proof DAGs with zero machine failures, labels one imported Collatz premise, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an explicit Weil form-core compression family, published-floor-aware natural-code well-foundedness, a uniform Goldbach root-mean plus dyadic path-variation bound below 56, and a uniform cubic-rough Walsh L1 contraction below one." },
      ],
    },
    latest_changes: [
