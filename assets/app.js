  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket210-cofinal-fiveone-primegap-scaledtwin.json", "docs/cofinal-fiveone-primegap-scaledtwin.md", "docs/cofinal-fiveone-primegap-scaledtwin.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET210 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires effective cofinal Riemann edge clearance and winding, a Collatz obstruction uniform in valuation-one multiplicity, a Goldbach exceptional-tail bound below one beyond the covering floor, and a dyadic bilinear Omega-phase lower bound that permits log-over-loglog local deserts." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-210: existential Riemann zero avoidance plus its symmetric no-go, complete five-one Collatz exclusion, exact prime-gap-to-Goldbach-witness transfer and dominance diagnosis, scaled factorial Twin deserts, proof DAGs, and remaining infinite premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 210 tickets" },
