...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 218,
    claim_language_scanned_lines: 75723,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket224-sharp-completeness-thresholds.json", "docs/sharp-completeness-thresholds.md", "docs/sharp-completeness-thresholds.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-224 proves four exact threshold or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires actual-zeta prime-side margins above the optimal quarter tail, a uniform Collatz prime-power deficit or aperiodic descent, a sub-square-root Goldbach remainder below the local margin, and sub-square-root Type-II separation for gap two." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-224: the optimal RH quarter-tail envelope, Collatz prime-power multiplicity, and square-root completeness boundaries with explicit Goldbach and Twin false positives, while preserving TICKET-223 and the full ledger.", metric: "4 current cards / 224 tickets" },
