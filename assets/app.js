  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket223-exponential-tail-local-duality-no-go.json", "docs/exponential-tail-local-duality-no-go.md", "docs/exponential-tail-local-duality-no-go.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-223 proves four exact partial or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires an RH-equivalent exponentially weighted defect with prime-side dyadic bands, a code-adaptive Collatz obstruction or universal descent, a prime-weighted Goldbach remainder below the uniform local margin, and a scale-growing Twin wheel signal with uniform Type-II remainder dominance." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-223: exponential-tail Riemann injectivity, fixed-sieve Collatz no-go, the Goldbach local margin, and fixed-wheel Twin composite countermodels, while preserving TICKET-222 and the full ledger.", metric: "4 current cards / 223 tickets" },
