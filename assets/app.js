...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 202,
    claim_language_scanned_lines: 70741,
    claim_language_triggered_mentions: 126,
    claim_language_guarded_mentions: 126,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket216-laplace-gcd-radix-tauberian.json", "docs/laplace-gcd-radix-tauberian.md", "docs/laplace-gcd-radix-tauberian.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-216 proves four exact partial, reduction, or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a cofinal actual-zeta first-atom transform bound, an all-k strict Collatz cross-power gcd gap, an independent Goldbach radix interval separating the zero digit, and a parity-breaking Twin Abel lower bound above the adaptive geometric tail." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-216: the Riemann first-atom transform certificate, Collatz cross-power gcd necessity, complete Goldbach radix histogram, and quantitative Twin Abel-count bracket, while preserving TICKET-215 and the full ledger.", metric: "4 current cards / 216 tickets" },
