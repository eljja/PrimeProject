...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_lines: 11106,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 55, status: "open", artifacts: ["data/open-problem/ticket46-stable-clause-grammar-lab.json", "data/open-problem/ticket47-periodic-state-lasso-lab.json", "data/open-problem/ticket48-automaton-reachability-lab.json", "data/open-problem/ticket49-symbolic-preimage-obstruction-lab.json", "data/open-problem/ticket50-phase-lift-exception-lab.json", "data/open-problem/ticket51-phase15-terminal-lift-lab.json", "data/open-problem/ticket52-frontier-budget-lab.json", "data/open-problem/ticket53-symbolic-terminal-theorem-lab.json", "data/open-problem/ticket54-new-template-family-lab.json", "data/open-problem/ticket55-phase5-valuation-gate-lab.json", "docs/proof-or-counterexample-program.md"], gate: "Known phase-5 gate crossers tunnel into the terminal no-go; no full proof claim", proof: "The proof workbench now targets the pre-gate failure population or an escape from the current low-lift template model." },
      ],
    },
    latest_changes: [
