  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket205-winding-extremal-finite-omega.json", "docs/winding-extremal-finite-omega.md", "docs/winding-extremal-finite-omega.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET205 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a completed-zeta cofinal zero-free-contour winding certificate, uniform nondivisibility for primitive mixed Collatz valuation necklaces, an explicit binary-Goldbach tail exceptional count below one, and uniform composite-composite cancellation for the Omega-switching Twin correlation." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-205: certified RH polygonal winding, Collatz extremal-valuation separation, exact Goldbach witnesses through ten million, the Omega-switching Twin weight and its infinite false-positive family, proof DAGs, and remaining infinite premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 205 tickets" },
