  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 84, status: "open", artifacts: ["data/open-problem/ticket133-quantifier-promotion-exact-reductions.json", "data/open-problem/ticket132-admissibility-nullset-hard-stratum-local-parity.json", "docs/quantifier-promotion-exact-reductions.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET133 proves four exact quantifier-reduction or countermodel theorems, corrects four promotion shortcuts, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires the complete projected Weil Gram family, an adaptive contracting Collatz cover, a maximal hard-stratum Goldbach bound, and unbounded parity-sensitive Twin information." },
      ],
    },
    latest_changes: [
