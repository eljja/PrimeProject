...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 138,
    claim_language_scanned_lines: 51298,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket183-abel-primitive-spectral-haar.json", "data/open-problem/ticket182-sobolev-divisibility-translation-sibling.json", "docs/abel-primitive-spectral-haar.md", "docs/abel-primitive-spectral-haar.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET183 proves four exact transfer reductions or no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires uniform Abel desmoothing on the pole-neutral Weil cone, exclusion of every primitive contracting Collatz word containing one, a phase-sensitive Goldbach error below the singular-series margin, and a negative Haar path-square bound plus parity-breaking root positivity for prime pairs." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-183, exact uniform-transfer refinements, finite arithmetic diagnostics, discarded routes, proof DAGs, and remaining arithmetic premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 183 tickets" },
