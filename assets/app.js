  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket215-lattice-nearcollision-exception-abel.json", "docs/lattice-nearcollision-exception-abel.md", "docs/lattice-nearcollision-exception-abel.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-215 proves four exact partial, reduction, or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a cofinal actual-zeta defect upper bound below two, an all-k exclusion of Collatz single-mountain power near-collisions, an all-block arithmetic Goldbach selector bound, and a parity-breaking lower bound for the cardinal-selected Twin Abel transform." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-215: the Riemann even-lattice certificate, Collatz single-mountain near-collision reduction, exact Goldbach exception counter, and Twin Abel-boundary equivalence, while preserving TICKET-214 and the full ledger.", metric: "4 current cards / 215 tickets" },
