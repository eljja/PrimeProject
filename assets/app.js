...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_lines: 11586,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 59, status: "open", artifacts: ["data/open-problem/ticket46-stable-clause-grammar-lab.json", "data/open-problem/ticket47-periodic-state-lasso-lab.json", "data/open-problem/ticket48-automaton-reachability-lab.json", "data/open-problem/ticket49-symbolic-preimage-obstruction-lab.json", "data/open-problem/ticket50-phase-lift-exception-lab.json", "data/open-problem/ticket51-phase15-terminal-lift-lab.json", "data/open-problem/ticket52-frontier-budget-lab.json", "data/open-problem/ticket53-symbolic-terminal-theorem-lab.json", "data/open-problem/ticket54-new-template-family-lab.json", "data/open-problem/ticket55-phase5-valuation-gate-lab.json", "data/open-problem/ticket56-pre-gate-projection-escape-lab.json", "data/open-problem/ticket57-parametric-template-automaton-lab.json", "data/open-problem/ticket58-affine-boundary-lift-lab.json", "data/open-problem/ticket59-symbolic-lift-mismatch-lab.json", "docs/proof-or-counterexample-program.md"], gate: "Selected low40-to-48 cylinders are counted exactly, but 58 mixed cylinders show the coordinate is still incomplete; no full proof claim", proof: "The proof workbench now targets a mixed-cylinder separator or an automaton-counted cover." },
      ],
    },
    latest_changes: [
