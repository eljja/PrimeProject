  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 82, status: "open", artifacts: ["data/open-problem/ticket132-admissibility-nullset-hard-stratum-local-parity.json", "data/open-problem/ticket131-proof-viability-target-correction.json", "docs/admissibility-nullset-hard-stratum-local-parity.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET132 proves four exact admissibility or pointwise-boundary theorems, corrects four route assumptions, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now uses a two-moment constrained RH core, proves natural Collatz codes are countable-dense-null, isolates powers of two as Goldbach's unbounded minimal-main stratum, and constructs infinite CRT composite-pair progressions that defeat every fixed local Twin sieve level." },
      ],
    },
    latest_changes: [
