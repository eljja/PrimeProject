...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 93,
      claim_language_scanned_lines: 32197,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket149-smooth-escape-wheel-cover.json", "data/open-problem/ticket148-multiscale-renewal-sharpness-matching.json", "docs/smooth-escape-wheel-cover.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET149 proves four exact intermediate theorems or reductions, rejects absolute compact-tail positivity, shadow-escape descent, wheel-only transfer, and the necessity of a full joint Twin route, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires an actual coercive Weil reference with relative tail norm below one, post-shadow descent for three Collatz exit types, a pointwise von Mangoldt wheel-residual saving, and positive cubic-rough edge mass together with a uniform semiprime endpoint-cover deficit." },
      ],
    },
    latest_changes: [
