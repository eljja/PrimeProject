...
const bundledEvidencePack = {
  ...
  artifacts: [
    ...
    { role: "claim_language_audit", schema: "primeproject.claim-language-audit.v1", sha256: "bundled-fallback", quality_gate_status: "pass", scanned_file_count: 91, scanned_line_count: 31186, claim_language_triggered_count: 121, claim_language_guarded_count: 121, claim_language_fail_count: 0 },
...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 91,
      claim_language_scanned_lines: 31186,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 97, status: "open", artifacts: ["data/open-problem/ticket147-fiber-compensation-phase-graph.json", "data/open-problem/ticket146-toeplitz-polynomial-phase-frechet.json", "docs/fiber-compensation-phase-graph.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET147 proves four exact intermediate theorems, rejects finite-lattice completeness, first-compensation all-code coverage, fixed-resolution Parseval K56, and support-topology joint-parity targets, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires infinite multiscale Weil completeness with matrix Schur bounds, residual-third Collatz renewal descent, arithmetic growing-sector Goldbach imbalance control, and an actual cubic-rough Liouville path-switch Type II deficit." },
      ],
    },
    latest_changes: [
