...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 84,
      claim_language_scanned_lines: 27195,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 90, status: "open", artifacts: ["data/open-problem/ticket140-spectral-moments-fixed-floor-duality-rotation.json", "data/open-problem/ticket139-uniformity-diophantine-complexity.json", "docs/spectral-moments-fixed-floor-duality-and-rotation.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET140 proves four exact intermediate or proof-route no-go theorems, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires a projected-Weil logarithmic-order trace-moment bound below the tail gap, period-dependent Collatz cycle-minimum Diophantine separation plus aperiodic well-foundedness, an arithmetic K56 Goldbach dual certificate, and Diophantine-Sobolev Type II Twin cancellation with positive gap-two mass." },
      ],
    },
    latest_changes: [
