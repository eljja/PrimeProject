  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket254-diagonal-weighted-reflection-thue.json", "docs/diagonal-weighted-reflection-thue.md", "docs/diagonal-weighted-reflection-thue.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-254 proves two exact route no-gos and two partial theorems, records four acyclic proof DAGs with zero machine failures, checks 8 RH operator blocks, 60 Collatz detector/weight rows, 50 Goldbach reflection certificates, 17 Twin polynomial pairs, and 10,608 twist-points while keeping every resolution counter at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The current workbench requires strict diagonal dominance for actual Weil blocks, signed incomplete Collatz recovery with cross-prime cancellation, exclusion of odd or q-divisible Goldbach tails, and exclusion of admissible integral points on all 17 unit-twisted Thue equations." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-254: positive diagonal, weighted complete detectors, even reflection, and the exponent-17 Thue frontier, while preserving TICKET-253 and the full ledger.", metric: "4 current cards / 254 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-254 exact no-go: positive diagonal alone cannot force Dirichlet-packet domination. / 양의 대각만으로 packet 지배를 얻을 수 없습니다.",
        artifact: "next: ActualWeilDirichletBlocksHaveUniformStrictDiagonalDominance",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-254 exact no-go: every nonnegative complete-detector average equals incidence. / 비음 complete-detector 평균은 incidence와 같습니다.",
        artifact: "next: IncompleteSlopeCharacterKernelHasSignedRecoveryAndCrossPrimeCancellation",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-254 partial theorem: even non-q-divisible compatible tails are excluded past the second residue-prime threshold. / 짝수 비가분 tail의 임계값 배제입니다.",
        artifact: "next: OddOrQDivisibleCompatibleTailPrimePrefixExclusion",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-254 partial theorem: exponent 17 reduces exactly to 17 unit-twisted Thue equations. / 지수 17은 17개 unit-twisted Thue 방정식으로 축약됩니다.",
        artifact: "next: AllSeventeenUnitTwistedCoefficientOneThueEquationsHaveNoAdmissibleIntegralPoint",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
