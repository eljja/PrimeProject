  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket211-winding-density-fullrange-unitscale.json", "docs/winding-density-fullrange-unitscale.md", "docs/winding-density-fullrange-unitscale.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET211 proves four exact intermediate or no-go results, records four proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires critical-line rectangle zero-count equality, a uniform 2-adic Collatz integrality obstruction, a full-range Goldbach exceptional count below one, and sparse dyadic Twin positivity that permits asymptotically unit-scale local deserts." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-211: total-winding localization no-go, Collatz density-versus-integrality split, full-range Goldbach predicate correction, asymptotically unit-scale factorial Twin deserts, proof DAGs, and remaining infinite premises while preserving TICKET-210 and the full ledger.", metric: "4 current cards / 211 tickets" },
