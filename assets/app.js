...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 75,
      claim_language_scanned_lines: 22675,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 86, status: "open", artifacts: ["data/open-problem/ticket136-scale-sensitive-obstructions-and-affine-bridge.json", "data/open-problem/ticket135-conditional-bridges-and-exceptional-set.json", "docs/scale-sensitive-obstructions-and-affine-bridge.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET136 proves four exact intermediate theorems, rejects four scale or information shortcuts, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now requires actual projected Weil row/column tail bounds, a uniform least-counterexample Collatz surplus, a growing-wheel Goldbach K56 residual bound, and an aperiodic scale-growing Type II Twin separator." },
      ],
    },
    latest_changes: [
