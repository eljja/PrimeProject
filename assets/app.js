...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 242,
    claim_language_scanned_lines: 83253,
    claim_language_triggered_mentions: 129,
    claim_language_guarded_mentions: 129,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket235-schur-primepower-phase-overlap.json", "docs/schur-primepower-phase-overlap.md", "docs/schur-primepower-phase-overlap.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-235 proves four exact partial or no-go theorems, records four proof DAGs with zero machine failures, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires relative arithmetic Weil-tail Schur dominance, an order-separated adaptive binary Collatz prime, actual-prime reflected Goldbach phase locking, and prime-weighted CRT pair-overlap moment concentration before the separate parity and principal-mass gaps." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-235: relative Schur control, Collatz divisor orders, Goldbach phase retrieval, and CRT overlap moments, while preserving TICKET-234 and the full ledger.", metric: "4 current cards / 235 tickets" },
