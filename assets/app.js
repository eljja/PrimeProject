...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 73,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 80, status: "open", artifacts: ["data/open-problem/ticket130-computability-cap-language-optimality.json", "data/open-problem/ticket129-enumerable-core-valuation-cap-endpoint-budget.json", "docs/computability-cap-language-optimality.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET130 proves five exact intermediate results, retires one impossible Collatz target, and keeps all four conjecture-resolution counters at zero.", proof: "The workbench now makes strict-negative Weil-core search a semidecision, proves the Collatz cap language survives every finite depth while its mass decays exponentially, proves K=56 is route-optimal for the fixed Goldbach endpoint architecture, and reduces the Twin within-block defect to the relative-increment threshold 2/23." },
      ],
    },
    latest_changes: [
