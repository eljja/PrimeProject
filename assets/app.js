  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket219-bandpass-matveev-crossfit-qualitative-abel.json", "docs/bandpass-matveev-crossfit-qualitative-abel.md", "docs/bandpass-matveev-crossfit-qualitative-abel.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-219 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, closes one infinite Collatz word family, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a prime-side RH band-pass enclosure, Baker separation for all Collatz valuation words plus divergence control, a cofinal cross-fitted Goldbach eighth-moment bound, and an unbounded parity-corrected actual Twin Abel transform." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-219: the Riemann positive band-pass boundary, complete positive single-mountain Collatz exclusion, leakage-free Goldbach p=8 holdouts, and qualitative Twin Abel criterion, while preserving TICKET-218 and the full ledger.", metric: "4 current cards / 219 tickets" },
