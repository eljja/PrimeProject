...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    checksummed_artifacts: 21,
      claim_language_scanned_files: 113,
      claim_language_scanned_lines: 43086,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket173-finite-section-cylinder-phase-tensor.json", "data/open-problem/ticket172-structure-equivalence-l1-variation.json", "docs/finite-section-cylinder-phase-tensor.md", "docs/finite-section-cylinder-phase-tensor.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET173 proves four exact structural results, records three-state proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability.", proof: "The workbench now requires vanishing pole-neutral Weil lower defect, unbounded Collatz cylinder representatives on every non-descending ray, Goldbach major-arc positive mass dominating signed minor-arc deficit, and prime-pair power saving over all tensor-Haar scale pairs." },
      ],
    },
    latest_changes: [
