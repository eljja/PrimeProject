...
const bundledProjectEvolution = {
  ...
  metrics: {
    ...
    claim_language_scanned_files: 282,
    claim_language_scanned_lines: 97733,
  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket256-cesaro-kernel-qdiv-gl2.json", "docs/cesaro-kernel-qdiv-gl2.md", "docs/cesaro-kernel-qdiv-gl2.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-256 proves four partial theorems, records four acyclic proof DAGs with zero machine failures, checks 12 RH packet rows, 22 Collatz prime rows, 2 Goldbach prefix certificates, and 16,641 Twin GL2 grid identities while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires an actual Weil lag-partial-sum bound, renormalized canonical Collatz phase cancellation, every-prefix q-divisible Goldbach asymmetry, and negative-norm integral-point exclusion on one exponent-17 branch." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-256: packet Cesaro, a sharp incomplete kernel, q-divisible reflection, and the GL2 exponent-17 survivor reduction, while preserving TICKET-255 and the full ledger.", metric: "4 current cards / 256 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-256 partial theorem: packet energy is the Cesaro mean of symmetric lag partial sums. / packet 에너지는 symmetric lag 부분합의 Cesaro 평균입니다.",
        artifact: "next: ActualWeilSymmetricLagPartialSumsHaveUniformLowerBound",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-256 partial theorem: one omitted frequency has minimax-sharp uniform error 1/q. / 한 주파수 omission의 최적 균일 error는 1/q입니다.",
        artifact: "next: RenormalizedCanonicalSlopePhasesHaveNontrivialCrossPrimeCancellation",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-256 partial theorem: odd q-divisible compatibility is impossible and two bounded even prefixes are excluded. / 홀수 q-배수 호환은 불가능하며 두 짝수 prefix가 배제됩니다.",
        artifact: "next: EveryQDivisibleCompatibleEvenTailHasPrimePrefixReflectionAsymmetry",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-256 partial theorem: the two exponent-17 survivors are GL2-equivalent and reduce to one branch. / 두 생존 twist는 GL2 동치이며 단일 branch로 환원됩니다.",
        artifact: "next: SingleCoefficientOneBranchHasNoNegativeNormIntegralPoint",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
