  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket182-sobolev-divisibility-translation-sibling.json", "data/open-problem/ticket181-regularized-localization-quantized-slack.json", "docs/sobolev-divisibility-translation-sibling.md", "docs/sobolev-divisibility-translation-sibling.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET182 proves four exact refinements or no-go results, records proof DAGs with zero machine failures, and keeps all four conjecture-resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a smoothed pole-neutral Weil H1 bound, exclusion of every nonconstant positive Collatz cycle-divisibility word, an every-block Goldbach uniform translation modulus, and a uniform Carleson path budget for actual prime-pair sibling contrasts." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-182, exact representation-aligned refinements, finite arithmetic diagnostics, discarded routes, proof DAGs, and remaining arithmetic premises while preserving the full ledger in semantic archives.", metric: "4 current cards / 182 tickets" },
