  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket220-dyadic-partition-primitive-refinement-crt.json", "docs/dyadic-partition-primitive-refinement-crt.md", "docs/dyadic-partition-primitive-refinement-crt.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-220 proves four exact partial or no-go results, records four proof DAGs with zero machine failures, closes one broader infinite Collatz word family, and keeps all four parent-conjecture resolution counters at zero; score 99 measures workflow coverage, not proof probability or conjecture completion.", proof: "The workbench now requires a summable prime-side RH band envelope below one, Baker separation for primitive multi-run Collatz words plus divergence control, a representation-free cofinal Goldbach refinement margin, and a parity-sensitive Twin lower bound beyond every fixed wheel." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-220: the complete Riemann dyadic partition and finite-window no-go, Collatz primitive-root closure, Goldbach refinement bridge, and fixed-wheel Twin CRT no-go, while preserving TICKET-219 and the full ledger.", metric: "4 current cards / 220 tickets" },
