  ...
  change_dashboard: {
    ...
    visual_rollup: {
      ...
      evidence_spine: [
        ...
        { layer: "Open-Proof", score: 99, status: "open", artifacts: ["data/open-problem/ticket255-aggregate-incomplete-odd-local.json", "docs/aggregate-incomplete-odd-local.md", "docs/aggregate-incomplete-odd-local.ko.md", "docs/proof-or-counterexample-program.md"], gate: "TICKET-255 proves two exact route no-gos and two partial theorems, records four acyclic proof DAGs with zero machine failures, checks 8 RH blocks, 48 Collatz missing-frequency certificates, 4 Goldbach odd-prefix certificates, and 3 split-prime Twin certificates eliminating 15 of 17 twists while every resolution counter stays zero; score 99 measures workflow coverage, not proof probability.", proof: "The current workbench requires an actual Weil aggregate packet bound, controlled-error signed Collatz cancellation, q-divisible Goldbach-tail exclusion, and admissible-point exclusion for the two surviving exponent-17 twists." },
      ],
    },
    latest_changes: [
      { label: "Evidence-first Pages", impact: "Public entry points now lead with TICKET-255: aggregate packets, incomplete recovery, odd reflection, and the three-prime exponent-17 obstruction, while preserving TICKET-254 and the full ledger.", metric: "4 current cards / 255 tickets" },
    ...
    openProblems: [
      {
        ...
        route: "TICKET-255 exact no-go: strict diagonal dominance is unnecessary for positive packet energy. / 엄격 대각우세는 양의 packet 에너지의 필요조건이 아닙니다.",
        artifact: "next: ActualWeilDirichletPacketAggregateRowSumHasRequiredLowerBound",
      },
      {
        name: "Collatz Conjecture / 콜라츠 추측",
        href: "open-problems/collatz.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-255 exact no-go: proper incomplete character support cannot recover incidence exactly. / 진부분집합 문자 support는 incidence를 exact 복원할 수 없습니다.",
        artifact: "next: SignedIncompleteSlopeKernelHasControlledCanonicalErrorAndCrossPrimeCancellation",
      },
      {
        name: "Strong Goldbach / 강한 골드바흐 추측",
        href: "open-problems/goldbach.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-255 partial theorem: odd reflection excludes four exact compatible prime prefixes. / 홀수 반사가 compatible prime prefix 네 개를 배제합니다.",
        artifact: "next: QDivisibleCompatibleTailPrimePrefixExclusion",
      },
      {
        name: "Twin Prime Conjecture / 쌍둥이 소수 추측",
        href: "open-problems/twin-prime.html",
        status: "open_not_proven / 미해결",
        route: "TICKET-255 partial theorem: three split primes reduce 17 exponent-17 Thue twists to two. / 세 split 소수가 지수 17 Thue twist 17개를 2개로 줄입니다.",
        artifact: "next: TwoSurvivingUnitTwistsHaveNoAdmissibleIntegralPoint",
      },
    ],    nextSteps: [
      ...openGaps.map((gap) => ({
