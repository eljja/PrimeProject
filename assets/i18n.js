(function () {
  ...
  const dictionary = {
    ...
    "brief.title": {
      en: "Four open problems, a third adjacent Collatz stratum closed",
      ko: "네 개의 미해결 문제, 연속해서 닫힌 세 콜라츠 부분족",
    },
    "brief.subtitle": {
      en: "PrimeProject has not solved any conjecture. TICKET-188 closes the four-one Collatz cycle stratum and proves three exact promotion boundaries.",
      ko: "PrimeProject는 아직 어떤 추측도 해결하지 못했습니다. TICKET-188은 네-1 콜라츠 순환 부분족을 닫고 정확한 전역 승격 경계 세 개를 증명합니다.",
    },
