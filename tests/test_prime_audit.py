...
class PrimeAuditTests(unittest.TestCase):
    ...
    def test_collection_power_labels_custom_target_tv(self) -> None:
        ...
        power = build_collection_power(matrix, target_tv=0.05)
        rsa = next(row for row in power["rows"] if row["object_type"] == "rsa-prime")

        self.assertEqual(power["method"]["target_tv_label"], "5pct")
    ...
    def test_collection_power_rejects_invalid_alpha(self) -> None:
        ...
        with self.assertRaises(ValueError):
            build_collection_power(matrix, target_tv=0.0)
        ...
        blocked = build_collection_submission_lint(
            ...
            records=[
                ...
                },
                {
                    ...
                    "aggregate_artifact_sha256": "a" * 64,
                    "provenance_record": {"baseline_id": "boringssl-rsa-prime-owned", "library": "BoringSSL"},
    ...
    def test_collection_submission_lint_binds_provenance_to_task_identity(self) -> None:
        handoff = {
            "schema": "primeproject.collection-handoff.v1",
            "rows": [
                {
            ...
            records=[
                {
                    ...
                    "provenance_record": {"baseline_id": "boringssl-rsa-prime-owned", "library": "BoringSSL"},
                    "feature_vector_path": "data/openssl_feature.json",
                    "feature_vector_summary": intake_feature_vector("OpenSSL", record_count=4514, bit_length=2048),
                },
            ],
        )
        row = lint["rows"][0]
    ...
    def test_collection_submission_lint_binds_optional_record_identity_to_task(self) -> None:
        handoff = {
            "schema": "primeproject.collection-handoff.v1",
            "rows": [
                {
        ...
        self.assertEqual(row["status"], "blocked")
        self.assertIn("record_baseline_id_mismatch", row["blocking_reasons"])

    def test_collection_submission_lint_blocks_non_public_feature_vector_path(self) -> None:
        handoff = {
            "schema": "primeproject.collection-handoff.v1",
            "rows": [
                {
            ...
            records=[
                {
                    ...
                    "aggregate_artifact_sha256": "a" * 64,
                    "provenance_record": {"baseline_id": "openssl-rsa-prime-owned", "library": "OpenSSL"},
                    "feature_vector_path": "C:\\private\\openssl_feature.json",
                    "feature_vector_summary": intake_feature_vector("OpenSSL", record_count=4514, bit_length=2048),
                },
            ],
        )
        ...
        self.assertEqual(row["status"], "blocked")
        self.assertIn("feature_vector_path_public_relative", row["blocking_reasons"])
    ...
    def test_collection_fixture_audit_proves_lint_outcomes(self) -> None:
        ...
        self.assertIn("record_baseline_id_mismatch", reasons)
        self.assertIn("feature_vector_path_public_relative", reasons)
    ...
    def test_collection_intake_binds_provenance_to_task_identity(self) -> None:
        handoff = {
            "schema": "primeproject.collection-handoff.v1",
            "rows": [
                {
    ...
    def test_collection_intake_binds_optional_record_identity_to_task(self) -> None:
        handoff = {
            "schema": "primeproject.collection-handoff.v1",
            "rows": [
                {
    ...
    def test_collection_intake_blocks_non_public_feature_vector_path(self) -> None:
        handoff = {
            "schema": "primeproject.collection-handoff.v1",
            "rows": [
                {
            ...
            records=[
                {
                    ...
                    "aggregate_artifact_sha256": "b" * 64,
                    "provenance_record": {"baseline_id": "openssl-rsa-prime-owned", "library": "OpenSSL"},
                    "feature_vector_path": "../private/openssl_feature.json",
                    "feature_vector_summary": intake_feature_vector("OpenSSL", record_count=4514, bit_length=2048),
                },
            ],
        )
