...
The Project Evolution panel reads `data/project_evolution.json` and now presents a condensed research narrative: six decisive metrics, a five-step visual change trail, one Evidence Spine for artifact-backed readiness, and a claim-boundary view that separates supported controlled-synthetic results from blocked real-world and Bitcoin attribution claims.
