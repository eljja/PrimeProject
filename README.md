...
- Benchmarks generator attribution against synthetic ground-truth samples with accuracy, confusion matrices, feature ablation, and bit-length confound control.
