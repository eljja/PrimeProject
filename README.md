...
- Publishes a machine-readable collection submission contract with task templates, required record fields, checksum rules, optional record identity binding, provenance identity binding, feature-vector schema rules, and forbidden public fields.
...
- Audits public-safe submission fixtures that prove the linter's pass, warning, missing-feature, forbidden-field, provenance-identity, feature-label, record-identity, and reused-checksum behavior before real collection records are accepted.
