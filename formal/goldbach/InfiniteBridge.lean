...
def rankedCegisTarget : String :=
  "GB-TICKET-113 preserves joint balanced signed cancellation; the Twin Farey denominator audit does not transfer across problems"

def topAttackTheoremTicket : String :=
  "GB-TICKET-114 JointBalancedVaughanGoldbachResidualEnvelope."
