...
def rankedCegisTarget : String :=
  "GB-TICKET-120 preserves joint balanced signed cancellation; the Twin low-divisor Gram result does not transfer across problems"

def topAttackTheoremTicket : String :=
  "GB-TICKET-121 JointBalancedVaughanGoldbachResidualEnvelope."
