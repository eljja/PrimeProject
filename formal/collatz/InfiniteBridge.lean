...
def rankedCegisTarget : String :=
  "CO-TICKET-114 preserves the exact golden-mean escape target; no Twin numerator-dispersion shortcut is imported"

def topAttackTheoremTicket : String :=
  "CO-TICKET-115 GoldenMeanInvariantSetEscape."
