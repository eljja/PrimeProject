...
def rankedCegisTarget : String :=
  "RH-TICKET-111 preserves non-circular explicit-formula kernel positivity; no Twin Type II phase shortcut is transferred"

def topAttackTheoremTicket : String :=
  "RH-TICKET-112 NonCircularExplicitFormulaKernelPositivity."
