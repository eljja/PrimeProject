...
def rankedCegisTarget : String :=
  "RH-TICKET-120 preserves non-circular explicit-formula kernel positivity; no Twin low-divisor Gram identity is transferred"

def topAttackTheoremTicket : String :=
  "RH-TICKET-121 NonCircularExplicitFormulaKernelPositivity."
