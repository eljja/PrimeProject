...
def rankedCegisTarget : String :=
  "RH-TICKET-116 preserves non-circular explicit-formula kernel positivity; no Twin Mobius-sign shortcut is transferred"

def topAttackTheoremTicket : String :=
  "RH-TICKET-117 NonCircularExplicitFormulaKernelPositivity."
