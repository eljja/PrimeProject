...
def rankedCegisTarget : String :=
  "RH-TICKET-115 preserves non-circular explicit-formula kernel positivity; no Twin cyclotomic-mean shortcut is transferred"

def topAttackTheoremTicket : String :=
  "RH-TICKET-116 NonCircularExplicitFormulaKernelPositivity."
