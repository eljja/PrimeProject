...
| `docs/local-certificate-realizer-trace-carleson.md` | 최신 네 난제 국소화 및 no-go 보고서 | 재현 가능한 finite-trace/residue-coupling/shell-budget/local-Carleson 결과 4건 | 어떤 대상 추측의 증명 또는 반례 |
