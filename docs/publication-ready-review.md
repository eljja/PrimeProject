...
| `docs/cutoff-potential-signed-information.md` | latest four-conjecture bridge and no-go report | four reproducible cutoff/potential/signed-mass/information results | proof or counterexample for any target conjecture |
...
| `docs/cutoff-potential-signed-information.md` | 최신 네 난제 연결 정리 및 no-go 보고서 | 재현 감사가 있는 cutoff/potential/signed-mass/information 결과 4건 | 어떤 대상 추측의 증명 또는 반례 |
