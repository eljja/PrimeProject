...
- Evidence Spine: Scale, Signal, Sim-to-Real, Governance, Publication 축으로 기존 산출물을 재배치한다. 각 축은 점수, 상태, 연결 artifact, gate 문장, 현재 proof를 함께 표시하므로 GitHub Pages에서 “어떤 결과는 완료됐고 어떤 결과는 아직 claim을 막는가”를 바로 볼 수 있다.
