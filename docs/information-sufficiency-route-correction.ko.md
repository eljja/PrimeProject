...
> 역사적 경계 고지 (2026-08-02): 현재 연구 전선은 TICKET-185로 갱신되었다.
> 특히 TICKET-172는 보편 가속 최초 하강이 콜라츠 추측과 동치임을 이미
> 보였으므로, 아래 TICKET-184의 콜라츠 “다음 의무”는 더 작은 보조정리가
> 아니라 당시의 전체 강도 목표로만 보존한다. 최신 결과는
> [TICKET-185](spectral-cycle-factor-granularity.ko.md)를 참조한다.
